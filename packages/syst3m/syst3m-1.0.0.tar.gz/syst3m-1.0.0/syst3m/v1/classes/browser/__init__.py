...
class Browser(object):
	def __init__(self,
		...
		if driver in ["chrome", "google chrome", "chromedriver"]:
			#self.driver = webdriver.Chrome(f'{SOURCE_PATH}/{VERSION}/classes/browser/drivers/{OS}/chromedriver')
			self.driver = webdriver.Chrome()
		elif driver in ["firefox", "geckodriver"]:
			#self.driver = webdriver.Firefox(executable_path=f'{SOURCE_PATH}/{VERSION}/classes/browser/drivers/{OS}/geckodriver')
