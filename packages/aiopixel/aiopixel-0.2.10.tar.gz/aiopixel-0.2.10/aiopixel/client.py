...
class PixelClient:
    ...
    async def player_from_uuid(self, uuid: str) -> Player:
        ...
        return Player(
            player_data.get("_id", None), player_data.get("displayname", None), player_data.get("firstLogin", None),
            player_data.get("lastLogin", None), player_data.get("karma", None), player_data.get("networkExp", -1),
            player_rank, player_data.get("lastLogout", None), player_achievements,
