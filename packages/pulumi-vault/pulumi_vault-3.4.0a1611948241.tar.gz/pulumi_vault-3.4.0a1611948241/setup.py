...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '3.4.0-alpha.1611948241+04dde28b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 3.4.0-alpha.1611948241+04dde28b`
                """)
            else:
                raise
