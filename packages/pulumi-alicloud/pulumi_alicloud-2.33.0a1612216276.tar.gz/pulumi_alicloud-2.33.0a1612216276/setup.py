...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.33.0-alpha.1612216276+8e7a2010'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.33.0-alpha.1612216276+8e7a2010`
                """)
            else:
                raise
