...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.34.0-alpha.1612370501+d8dfe0cc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.34.0-alpha.1612370501+d8dfe0cc`
                """)
            else:
                raise
