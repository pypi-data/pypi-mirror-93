...
var GaLogin = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return [
            ...
            (function () {
                if (_this.errorOnLogin) {
                    return (h("span", { class: "auth-error" }, "Could not login. Please check your credentials"));
                }
                return (h("limel-button", { class: "auth-button", label: "Login", primary: true, loading: _this.loading, disabled: _this.isDisabled(), onClick: _this.onLogin }));
            })(),
        ];
    };
