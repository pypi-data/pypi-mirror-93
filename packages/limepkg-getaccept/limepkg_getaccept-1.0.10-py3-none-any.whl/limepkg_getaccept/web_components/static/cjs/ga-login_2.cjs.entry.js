        ...
        return [
            ...
            (() => {
                if (this.errorOnLogin) {
                    return (index.h("span", { class: "auth-error" }, "Could not login. Please check your credentials"));
                }
                return (index.h("limel-button", { class: "auth-button", label: "Login", primary: true, loading: this.loading, disabled: this.isDisabled(), onClick: this.onLogin }));
            })(),
        ];
    }
    isDisabled() {
