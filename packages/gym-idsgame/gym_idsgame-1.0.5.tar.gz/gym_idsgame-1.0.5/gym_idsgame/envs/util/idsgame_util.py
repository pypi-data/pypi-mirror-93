...
def is_node_defense_legal(target_node : int, network_config, state : GameState, max_value:int) -> bool:
...
def defense_score(game_sate : GameState, network_config, game_config : GameConfig):
    total_min_def = 0
