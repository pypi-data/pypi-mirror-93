...
setup(
    ...
    packages=[
        "sebschmi_snakemake",
        "sebschmi_snakemake.remote",
        "sebschmi_snakemake.report",
        "sebschmi_snakemake.caching",
        "sebschmi_snakemake.deployment",
        "sebschmi_snakemake.linting",
        "sebschmi_snakemake.executors",
        "sebschmi_snakemake.unit_tests",
        "sebschmi_snakemake.unit_tests.templates"
    ],
    entry_points={
        "console_scripts": [
            "snakemake = sebschmi_snakemake:main",
            "snakemake-bash-completion = sebschmi_snakemake:bash_completion",
        ]
    },
