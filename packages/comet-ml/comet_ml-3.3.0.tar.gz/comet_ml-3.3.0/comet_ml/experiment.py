...
class BaseExperiment(CommonExperiment):
        ...
        if self._log_code:
            ...
            try:
                ...
                if script_name != experiment_creation_file and os.path.isfile(
                    ...
                    self._log_code_asset("python_script_name", file_name=script_name)
            except Exception:
    ...
    def _log_code_asset(
        ...
        # type: (str, Any, Any, Any, Optional[int]) -> Optional[List[Tuple[str, Dict[str, str]]]]
        """
        Log additional source code files.
        Args:
            file_name: optional, string: the file path of the file to log
