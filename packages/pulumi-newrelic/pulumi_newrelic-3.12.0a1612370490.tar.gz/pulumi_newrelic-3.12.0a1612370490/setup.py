...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '3.12.0-alpha.1612370490+7ef33e86'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 3.12.0-alpha.1612370490+7ef33e86`
                """)
            else:
                raise
