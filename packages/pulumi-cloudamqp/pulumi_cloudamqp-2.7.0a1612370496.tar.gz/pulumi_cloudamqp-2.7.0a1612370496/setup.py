...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', '2.7.0-alpha.1612370496+4c6a2e0d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp 2.7.0-alpha.1612370496+4c6a2e0d`
                """)
            else:
                raise
