...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', '2.6.0-alpha.1611855191+b31d1cb9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp 2.6.0-alpha.1611855191+b31d1cb9`
                """)
            else:
                raise
