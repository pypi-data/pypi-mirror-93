    ...
    for i in range(n_programs):
        ...
        if parents is None:
            ...
            for contender in contenders:
                ...
                parent = Program(init_depth=init_depth, method=init_method, random_state=random_state,
    ...
    def train(self, total_data):
        ...
        for gen in range(prior_generations, self._generations):
            ...
            population = Parallel(n_jobs=n_jobs,
                ...
                delayed(parallel_evolve)(n_programs[i], parents, total_data, seeds, 
            ...
            print('d_value:%f,convergence:%f,con_time:%d' % (d_value, self._convergence, self._con_time))
