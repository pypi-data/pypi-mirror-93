...
from typing import cast, Optional, Iterable, List, Union
...
class _CirqSimBackend(_CirqBaseBackend):
    ...
    @abstractmethod
    def package_result(
        self, circuit: CirqCircuit, q_bits: Iterable[Qubit]
    ) -> BackendResult:
        """
    ...
    def process_circuit_moments(
        ...
        **kwargs: KwargTypes,
        ...
        """
        Submit a single circuit to the backend for running. See :py:meth:`_CirqSimBackend.process_circuits_moments`.
        """
    ...
    def process_circuits_moments(
        ...
        **kwargs: KwargTypes,
        ...
        get_<data> method. The get_<data> method will return List[BackendResult] corresponding to each moment.
