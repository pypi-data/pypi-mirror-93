...
"""Methods to allow conversion between Cirq and tket data types, including Circuits and Devices
"""
...
def process_characterisation(xmon: XmonDevice) -> dict:
    """Generates a tket dictionary containing device characteristics for a Cirq :py:class:`XmonDevice` .
