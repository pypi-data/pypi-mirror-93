    ...
    """
{
    ...
    "package_data": {
        "cdk_gitlab_runner._jsii": [
            "cdk-gitlab-runner@1.77.12.jsii.tgz"
        ],
        "cdk_gitlab_runner": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-autoscaling-hooktargets>=1.87.1, <2.0.0",
        "aws-cdk.aws-autoscaling>=1.87.1, <2.0.0",
        "aws-cdk.aws-ec2>=1.87.1, <2.0.0",
        "aws-cdk.aws-iam>=1.87.1, <2.0.0",
        "aws-cdk.aws-lambda>=1.87.1, <2.0.0",
        "aws-cdk.aws-logs>=1.87.1, <2.0.0",
        "aws-cdk.aws-s3-assets>=1.87.1, <2.0.0",
        "aws-cdk.aws-s3>=1.87.1, <2.0.0",
        "aws-cdk.aws-sns-subscriptions>=1.87.1, <2.0.0",
        "aws-cdk.aws-sns>=1.87.1, <2.0.0",
        "aws-cdk.core>=1.87.1, <2.0.0",
        "aws-cdk.custom-resources>=1.87.1, <2.0.0",
