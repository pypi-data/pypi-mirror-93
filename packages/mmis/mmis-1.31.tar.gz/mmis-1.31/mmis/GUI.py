...
class DataAnalysis(wx.Panel):
    def __init__(self, parent):
        ...
        self.lblname4 = wx.StaticText(self, label = "Choose 1 point every?", id=-1)
        self.Samples = wx.SpinCtrlDouble(self, size=(155,-1), min = 1, max = 1000, inc = 1, value='100.00')
        self.Samples.SetBackgroundColour('white')
        self.lblname5 = wx.StaticText(self, label = "Samples and ", id=-1)

        self.button4 = wx.Button(self, label = 'Generate New File', size = (150,35), id=-1)
        self.button4.Bind(wx.EVT_BUTTON, self.filereduction)
        ...
        self.hbox4.Add(self.Samples, border=5, flag=wx.ALL | wx.ALIGN_CENTER_VERTICAL)
