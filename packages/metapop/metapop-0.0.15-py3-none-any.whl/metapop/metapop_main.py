...
def main():
	...
	params = open(output_directory_base+"/MetaPop/00.Log_and_Parameters/parameters.txt", "w")
	#Params should be filled at start
	params.close()
	...
	#metapop_filter.filt(original_bams, filter_command_base, bdb, threads, mag_contig_dict, mag_length_dict, joined_fastas)
