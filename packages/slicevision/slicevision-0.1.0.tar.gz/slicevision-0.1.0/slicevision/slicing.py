...
import numpy as np
import skimage.io
from slicevision.utils.coco import (Coco, CocoAnnotation, CocoImage,
                                    create_coco_dict)
from slicevision.utils.cv import read_large_image
from slicevision.utils.file import create_dir, load_json, save_json
from slicevision.utils.shapely import (ShapelyAnnotation,
                                       get_bbox_from_shapely, get_shapely_box,
