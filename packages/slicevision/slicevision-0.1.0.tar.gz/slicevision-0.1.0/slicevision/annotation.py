...
import imantics
import numpy as np
from slicevision.utils.coco import CocoAnnotation, CocoPrediction
from slicevision.utils.cv import (
    get_bbox_from_bool_mask,
    get_bool_mask_from_coco_segmentation,
    get_coco_segmentation_from_bool_mask,
)
from slicevision.utils.shapely import ShapelyAnnotation
...
class ObjectAnnotation:
    ...
    def to_coco_annotation(self):
        """
        Returns slicevision.utils.coco.CocoAnnotation representation of ObjectAnnotation.
        """
        if self.mask:
    ...
    def to_coco_prediction(self):
        """
        Returns slicevision.utils.coco.CocoPrediction representation of ObjectAnnotation.
        """
        if self.mask:
    ...
    def to_shapely_annotation(self):
        """
        Returns slicevision.utils.shapely.ShapelyAnnotation representation of ObjectAnnotation.
        """
        if self.mask:
