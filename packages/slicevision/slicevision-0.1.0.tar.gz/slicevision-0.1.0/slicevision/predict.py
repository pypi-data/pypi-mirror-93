...
from slicevision.postprocess.match import PredictionMatcher
from slicevision.postprocess.merge import PredictionMerger, ScoreMergingPolicy
from slicevision.postprocess.ops import box_intersection, box_ios, box_union
from slicevision.prediction import ObjectPrediction, PredictionInput
from slicevision.slicing import slice_image
from slicevision.utils.cv import (crop_object_predictions, read_image,
                                  visualize_object_predictions)
from slicevision.utils.file import (get_base_filename, import_class,
                                    list_files, save_pickle)
from slicevision.utils.torch import to_float_tensor
...
def get_sliced_prediction(
    ...
    Returns:
        A Dict with fields:
            object_prediction_list: a list of slicevision.prediction.ObjectPrediction
            durations_in_seconds: a dict containing elapsed times for profiling
    """
    # for profiling
    durations_in_seconds = dict()
