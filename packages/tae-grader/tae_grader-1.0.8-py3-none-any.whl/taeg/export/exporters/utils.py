"""
Utils for Taeg Export exporterss
"""
...
NEW_PAGE_CLASS_NAME = "taeg-page-break-after"
...
def sub_end_for_new_page(line):
    ...
    The end question HTML comment (cf. ``taeg.export.filter.has_end``) is replaced with the following
