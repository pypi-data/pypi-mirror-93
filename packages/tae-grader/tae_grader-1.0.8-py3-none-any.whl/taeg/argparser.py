...
def get_parser():
    ...
    assign_parser.add_argument("--no-submit-cell", help="Don't inject an submit cell into the notebook", default=False, action="store_true")
    assign_parser.add_argument("--no-run-tests", help="Don't run tests.", default=False, action="store_true")
    assign_parser.add_argument("--no-load-cell", help="Don't automatically generate an Taeg load cell", default=False, action="store_true")
