"""
Gradescope autograder configuration generator for Taeg Generate
"""
...
TAEG_ENV_NAME = "taeg-gradescope-env"
TEMPLATE_FILE_PATHS = {
    ...
    "run_taeg.py": os.path.join(TEMPLATES_DIR, "run_taeg.py"),
    "environment.yml":  os.path.join(TEMPLATES_DIR, "environment.yml"),
}

def main(args):
    """
    Runs ``taeg generate autograder``
    """
    ...
    run_taeg_py = templates["run_taeg.py"].render(
    ...
    try:
        ...
        with open(os.path.join(os.getcwd(), "tmp", "run_taeg.py"), "w+") as f:
            f.write(run_taeg_py)
        ...
        zip_cmd = ["zip", "-r", zip_path, "run_autograder", "run_taeg.py", "requirements.r",
