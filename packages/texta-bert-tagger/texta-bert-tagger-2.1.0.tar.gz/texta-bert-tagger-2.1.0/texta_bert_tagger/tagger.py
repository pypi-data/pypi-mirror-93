...
class BertTagger:
    ...
    def load_pretrained(self, state_dict=None):
        ...
        if self.save_pretrained and not model_downloaded:
            ...
            if not BertTagger.is_roberta_model(model_to_load):
                model_to_save = BertForSequenceClassification.from_pretrained(model_to_load, state_dict = state_dict)
            else:
                model_to_save = RobertaForSequenceClassification.from_pretrained(model_to_load, state_dict = state_dict)
