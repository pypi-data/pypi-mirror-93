...
class shoppingcart_CartModel:
    _hx_class_name = "shoppingcart.CartModel"
    __slots__ = ("id", "storeId")
    _hx_fields = ["id", "storeId"]
...
class shoppingcart_CartRepository:
    _hx_class_name = "shoppingcart.CartRepository"
    __slots__ = ("bus", "carts", "counter")
    _hx_fields = ["bus", "carts", "counter"]
    _hx_methods = ["Add", "Remove"]
    ...
    def Add(self,cart,callback):
        cartId = Std.string(self.counter)
        _hx_local_0 = self
    ...
    def Remove(self,cartId,callback):
        _g = 0
        _g1 = self.carts
        while (_g < len(_g1)):
            cart = (_g1[_g] if _g >= 0 and _g < len(_g1) else None)
            _g = (_g + 1)
            if (cart.id == cartId):
                python_internal_ArrayImpl.remove(self.carts,cart)
                callback()
                return
        callback()
...
class shoppingcart_ItemModel:
    _hx_class_name = "shoppingcart.ItemModel"
    __slots__ = ("cartId", "idx", "itemId", "qty", "price")
    _hx_fields = ["cartId", "idx", "itemId", "qty", "price"]
...
class shoppingcart_ItemRepository:
    _hx_class_name = "shoppingcart.ItemRepository"
    __slots__ = ("bus", "items")
    _hx_fields = ["bus", "items"]
    _hx_methods = ["Add", "Edit", "Remove", "FindByCartId", "FindByCartIdAndIdx"]
    ...
    def Add(self,item,callback):
        if (not (item.cartId in self.items.h)):
            this1 = self.items
            k = item.cartId
            v = list()
            this1.h[k] = v
        idx = len(self.items.h.get(item.cartId,None))
        item.idx = idx
        _this = self.items.h.get(item.cartId,None)
        _this.append(item)
        callback(idx)

    def Edit(self,item,callback):
        python_internal_ArrayImpl._set(self.items.h.get(item.cartId,None), item.idx, item)
        callback()

    def Remove(self,cartId,idx,callback):
        python_internal_ArrayImpl._set(self.items.h.get(cartId,None), idx, None)
        callback()

    def FindByCartId(self,cartId,callback):
        if (cartId in self.items.h):
            callback(self.items.h.get(cartId,None))
        else:
            callback(list())

    def FindByCartIdAndIdx(self,cartId,idx,callback):
        if (cartId in self.items.h):
            if (len(self.items.h.get(cartId,None)) > idx):
                callback(python_internal_ArrayImpl._get(self.items.h.get(cartId,None), idx))
                return
        callback(None)
...
class shoppingcart_ShoppingCart:
    _hx_class_name = "shoppingcart.ShoppingCart"
    __slots__ = ("maglev", "logic")
    _hx_fields = ["maglev", "logic"]
    _hx_methods = ["registerMyMethods"]
    _hx_statics = ["__meta__"]

    def __init__(self,maglev):
        self.maglev = maglev
        self.logic = shoppingcart_ShoppingCartLogic(shoppingcart_CartRepository(maglev),shoppingcart_ItemRepository(maglev))
    ...
    def registerMyMethods(self):
        ...
        def _hx_local_3(args):
            def _hx_local_1():
                ...
                return _hx_local_0
            storeId = (_hx_local_1()).getString()
            result = maglev_MagLevResult.createAsync()
            def _hx_local_2(cartId):
                result.setResult(maglev_MagLevString.fromString(cartId))
            _gthis.logic.Create(storeId,_hx_local_2)
            return result
        self.maglev.register("ShoppingCart.Create",maglev_MagLevFunction.fromFunction(_hx_local_3))
        def _hx_local_13(args):
            def _hx_local_5():
                _hx_local_4 = args.get(0)
                if (Std.isOfType(_hx_local_4,maglev_MagLevString) or ((_hx_local_4 is None))):
                    _hx_local_4
                else:
                    raise "Class cast error"
                return _hx_local_4
            cartId = (_hx_local_5()).getString()
            def _hx_local_7():
                _hx_local_6 = args.get(1)
                if (Std.isOfType(_hx_local_6,maglev_MagLevString) or ((_hx_local_6 is None))):
                    _hx_local_6
                else:
                    raise "Class cast error"
                return _hx_local_6
            itemId = (_hx_local_7()).getString()
            def _hx_local_9():
                _hx_local_8 = args.get(2)
                if (Std.isOfType(_hx_local_8,maglev_MagLevNumber) or ((_hx_local_8 is None))):
                    _hx_local_8
                else:
                    raise "Class cast error"
                return _hx_local_8
            qty = (_hx_local_9()).getInt()
            def _hx_local_11():
                _hx_local_10 = args.get(3)
                if (Std.isOfType(_hx_local_10,maglev_MagLevNumber) or ((_hx_local_10 is None))):
                    _hx_local_10
                else:
                    raise "Class cast error"
                return _hx_local_10
            price = (_hx_local_11()).getFloat()
            result = maglev_MagLevResult.createAsync()
            def _hx_local_12(idx):
                result.setResult(maglev_MagLevNumber.fromInt(idx))
            _gthis.logic.AddItem(cartId,itemId,qty,price,_hx_local_12)
            return result
        self.maglev.register("ShoppingCart.AddItem",maglev_MagLevFunction.fromFunction(_hx_local_13))
        def _hx_local_18(args):
            def _hx_local_15():
                _hx_local_14 = args.get(0)
                if (Std.isOfType(_hx_local_14,maglev_MagLevString) or ((_hx_local_14 is None))):
                    _hx_local_14
                else:
                    raise "Class cast error"
                return _hx_local_14
            cartId = (_hx_local_15()).getString()
            result = maglev_MagLevResult.createAsync()
            def _hx_local_17(items):
                ...
                while (_g < len(items)):
                    ...
                    obj.set("idx",maglev_MagLevNumber.fromInt(item.idx))
                    obj.set("itemId",maglev_MagLevString.fromString(item.itemId))
                    obj.set("qty",maglev_MagLevNumber.fromFloat(item.qty))
                    obj.set("price",maglev_MagLevNumber.fromFloat(item.price))
                    arr.push(obj)
                result.setResult(arr)
            _gthis.logic.ListItems(cartId,_hx_local_17)
            return result
        self.maglev.register("ShoppingCart.ListItems",maglev_MagLevFunction.fromFunction(_hx_local_18))
        def _hx_local_24(args):
            def _hx_local_20():
                ...
                if (Std.isOfType(_hx_local_19,maglev_MagLevString) or ((_hx_local_19 is None))):
                    ...
                    raise "Class cast error"
                return _hx_local_19
            cartId = (_hx_local_20()).getString()
            def _hx_local_22():
                _hx_local_21 = args.get(1)
                if (Std.isOfType(_hx_local_21,maglev_MagLevNumber) or ((_hx_local_21 is None))):
                    _hx_local_21
                else:
                    raise "Class cast error"
                return _hx_local_21
            idx = (_hx_local_22()).getInt()
            result = maglev_MagLevResult.createAsync()
            def _hx_local_23():
                result.setResult(maglev_MagLevNull.create())
            _gthis.logic.RemoveItem(cartId,idx,_hx_local_23)
            return result
        self.maglev.register("ShoppingCart.RemoveItem",maglev_MagLevFunction.fromFunction(_hx_local_24))
        def _hx_local_32(args):
            def _hx_local_26():
                _hx_local_25 = args.get(0)
                if (Std.isOfType(_hx_local_25,maglev_MagLevString) or ((_hx_local_25 is None))):
                    _hx_local_25
                else:
                    raise "Class cast error"
                return _hx_local_25
            cartId = (_hx_local_26()).getString()
            def _hx_local_28():
                _hx_local_27 = args.get(1)
                if (Std.isOfType(_hx_local_27,maglev_MagLevNumber) or ((_hx_local_27 is None))):
                    _hx_local_27
                else:
                    raise "Class cast error"
                return _hx_local_27
            idx = (_hx_local_28()).getInt()
            def _hx_local_30():
                _hx_local_29 = args.get(2)
                if (Std.isOfType(_hx_local_29,maglev_MagLevNumber) or ((_hx_local_29 is None))):
                    _hx_local_29
                else:
                    raise "Class cast error"
                return _hx_local_29
            qty = (_hx_local_30()).getInt()
            result = maglev_MagLevResult.createAsync()
            def _hx_local_31():
                result.setResult(maglev_MagLevNull.create())
            _gthis.logic.UpdateQty(cartId,idx,qty,_hx_local_31)
            return result
        self.maglev.register("ShoppingCart.UpdateQty",maglev_MagLevFunction.fromFunction(_hx_local_32))
        def _hx_local_36(args):
            def _hx_local_34():
                ...
                if (Std.isOfType(_hx_local_33,maglev_MagLevString) or ((_hx_local_33 is None))):
                    ...
                    raise "Class cast error"
                return _hx_local_33
            cartId = (_hx_local_34()).getString()
            result = maglev_MagLevResult.createAsync()
            def _hx_local_35(count):
                result.setResult(maglev_MagLevNull.create())
            _gthis.logic.CountItems(cartId,_hx_local_35)
            return result
        self.maglev.register("ShoppingCart.CountItems",maglev_MagLevFunction.fromFunction(_hx_local_36))
        def _hx_local_40(args):
            def _hx_local_38():
                _hx_local_37 = args.get(0)
                if (Std.isOfType(_hx_local_37,maglev_MagLevString) or ((_hx_local_37 is None))):
                    _hx_local_37
                else:
                    raise "Class cast error"
                return _hx_local_37
            cartId = (_hx_local_38()).getString()
            result = maglev_MagLevResult.createAsync()
            def _hx_local_39(summary):
                obj = maglev_MagLevObject.create()
                obj.set("items",maglev_MagLevNumber.fromInt(summary.items))
                obj.set("total",maglev_MagLevNumber.fromFloat(summary.total))
                result.setResult(obj)
            _gthis.logic.GetCartSummary(cartId,_hx_local_39)
            return result
        self.maglev.register("ShoppingCart.GetCartSummary",maglev_MagLevFunction.fromFunction(_hx_local_40))
        def _hx_local_44(args):
            result = maglev_MagLevResult.createAsync()
            def _hx_local_42():
                ...
                if (Std.isOfType(_hx_local_41,maglev_MagLevString) or ((_hx_local_41 is None))):
                    ...
                    raise "Class cast error"
                return _hx_local_41
            cartId = (_hx_local_42()).getString()
            def _hx_local_43():
                result.setResult(maglev_MagLevNull.create())
            _gthis.logic.Clear(cartId,_hx_local_43)
            return result
        self.maglev.register("ShoppingCart.Clear",maglev_MagLevFunction.fromFunction(_hx_local_44))
...
class shoppingcart_ShoppingCartLogic:
    _hx_class_name = "shoppingcart.ShoppingCartLogic"
    __slots__ = ("cartRepo", "itemRepo")
    _hx_fields = ["cartRepo", "itemRepo"]
    _hx_methods = ["Create", "AddItem", "ListItems", "RemoveItem", "UpdateQty", "CountItems", "GetCartSummary", "Clear"]

    def __init__(self,cartRepo,itemRepo):
        self.cartRepo = cartRepo
        self.itemRepo = itemRepo

    def Create(self,storeId,callback):
        cart = shoppingcart_CartModel()
        cart.storeId = storeId
        def _hx_local_0(cartId):
            callback(cartId)
        self.cartRepo.Add(cart,_hx_local_0)

    def AddItem(self,cartId,itemId,qty,price,callback):
        item = shoppingcart_ItemModel()
        item.cartId = cartId
        item.itemId = itemId
        item.qty = qty
        item.price = price
        def _hx_local_0(idx):
            callback(idx)
        self.itemRepo.Add(item,_hx_local_0)

    def ListItems(self,cartId,callback):
        def _hx_local_1(items):
            _hx_list = list()
            _g = 0
            while (_g < len(items)):
                item = (items[_g] if _g >= 0 and _g < len(items) else None)
                _g = (_g + 1)
                cartItem = _hx_AnonObject({'idx': item.idx, 'itemId': item.itemId, 'qty': item.qty, 'price': item.price})
                _hx_list.append(cartItem)
            callback(_hx_list)
        self.itemRepo.FindByCartId(cartId,_hx_local_1)

    def RemoveItem(self,cartId,idx,callback):
        def _hx_local_0():
            callback()
        self.itemRepo.Remove(cartId,idx,_hx_local_0)

    def UpdateQty(self,cartId,idx,qty,callback):
        _gthis = self
        def _hx_local_1(item):
            item.qty = qty
            def _hx_local_0():
                callback()
            _gthis.itemRepo.Edit(item,_hx_local_0)
        self.itemRepo.FindByCartIdAndIdx(cartId,idx,_hx_local_1)

    def CountItems(self,cartId,callback):
        def _hx_local_0(items):
            count = len(items)
            callback(count)
        self.itemRepo.FindByCartId(cartId,_hx_local_0)

    def GetCartSummary(self,cartId,callback):
        def _hx_local_3(items):
            total = 0
            count = 0
            _g = 0
            while (_g < len(items)):
            ...
            summary = _hx_AnonObject({'total': total, 'items': count})
            callback(summary)
        self.itemRepo.FindByCartId(cartId,_hx_local_3)

    def Clear(self,cartId,callback):
        def _hx_local_0():
            callback()
        self.cartRepo.Remove(cartId,_hx_local_0)
...
shoppingcart_ShoppingCart.__meta__ = _hx_AnonObject({'obj': _hx_AnonObject({'SuppressWarnings': [["checkstyle:FieldDocComment", "checkstyle:LocalVariableName", "checkstyle:MultipleStringLiterals", "checkstyle:MagicNumber"]]})})