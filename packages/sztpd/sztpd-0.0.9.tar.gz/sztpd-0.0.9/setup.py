...
setuptools.setup(
    ...
    install_requires=['six', 'sqlalchemy_utils', 'sqlalchemy', 'pysqlite3', 'cryptography', 'yangson', 'requests', 'aiohttp<4.0.0', 'basicauth', 'pyasn1', 'pyasn1-modules>=0.2.6', 'pyasn1', 'pem', 'passlib', 'certvalidator', 'fifolock'], # order matters!  processed in reverse order...
    # 'aiohttp==3.6.2'
