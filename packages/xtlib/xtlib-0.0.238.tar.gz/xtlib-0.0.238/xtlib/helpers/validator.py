    ...
    def validate_references(self, config, config_fn):
        ...
        for rd in self.references:
            ...
            if not section in config:
                errors.syntax_error("reference section '{}' not defined in CONFIG FILE '{}'".format(section, config_fn))

            section_props = config[section]
            if not isinstance(section_props, dict):
                errors.syntax_error("reference section must be defined as a dictionary: {}".format(section))
            ...
            if section == "providers":
                ...
                if not found:
                    errors.syntax_error("target for reference '{}' cannot be found in section '{}' (from: {})".\
