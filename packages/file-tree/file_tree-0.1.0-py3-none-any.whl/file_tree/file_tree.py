...
class FileTree:
    ...
    def update_glob(self, template_name: str, inplace=False) -> "FileTree":
        ...
        updated_placeholders = template.get_all_placeholders(self.placeholders)
        return self.update(inplace, **updated_placeholders)
    ...
    def get_mult(self, key: str, make_dir=False) -> xarray.DataArray:
        ...
        Returns:
            xarray.DataArray: all possible paths in a DataArray
        """
