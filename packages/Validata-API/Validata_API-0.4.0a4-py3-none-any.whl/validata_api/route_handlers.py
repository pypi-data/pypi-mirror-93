    ...
    return make_json_response(
        {
            ...
            "message": "This is the home page of Validata Web API. Its documentation is here: {}".format(
                apidocs_url
            ),
        },
        args=None,
...
def validate():
    ...
    if config.BADGE_CONFIG is not None:
        body["badge"] = validata_core.compute_badge_metrics(
            validation_report, config.BADGE_CONFIG
        )
