...
def reconstitute_signal_perf(data=None, initial_price = 1. , average_execution_cost = 15e-4 , transaction_cost = True, print_turnover = False, normalization = False, recompute_return=True):
    if normalization:
