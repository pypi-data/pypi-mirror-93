...
class LeikeEnsslinQuery(DustMap):
    """
    A class for querying the Leike & Ensslin (2019,2020) dust maps.
    """

    def __init__(self, map_fname=None, version='2019'):
        """
        Args:
