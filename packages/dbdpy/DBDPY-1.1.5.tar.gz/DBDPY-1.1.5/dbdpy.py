	...
	async def replaces(line, message, guild, content, msg, vars, timerep, author):
		...
		while "$replaceText"+bot._style[0] in line:
			if nowloop==line:
				...
				nowloop=line
				try:
					r=line.split("$replaceText"+bot._style[0])[-1].split(bot._style[1])[0].split(bot._separator)[0].replace(line.split("$replaceText"+bot._style[0])[-1].split(bot._style[1])[0].split(bot._separator)[1],line[len(line.split("$replaceText"+bot._style[0])[-1].split(bot._style[1])[0].split(bot._separator)[0]+bot._separator+line.split("$replaceText"+bot._style[0])[-1].split(bot._style[1])[0].split(bot._separator)[1]+bot._separator):])
