...
class HPOTerm():
    ...
    def __init__(self):
        ...
        # External annotations
        # only direct ones
        self._direct_annotations = {
            'genes': set(),
            'omim_diseases': set(),
            'orpha_diseases': set(),
            'decipher_diseases': set(),
            'omim_excluded_diseases': set(),
            'orpha_excluded_diseases': set(),
            'decipher_excluded_diseases': set()
        }
    ...
    def _update_annotations(self, kind, annotations):
        ...
        self._direct_annotations[kind].update(annotations)
