...
from ctlml_commons.util.constants import MAIN_EMAIL
...
if __name__ == "__main__":
    ...
    from ctlml_commons.util.random_utils import random_float

    auth_file_path: str = f"/tmp/data.{random_float(0, 100)}"

    # Write auth data
    import json
    from ctlml_commons.util.auth_utils import auth_dict
