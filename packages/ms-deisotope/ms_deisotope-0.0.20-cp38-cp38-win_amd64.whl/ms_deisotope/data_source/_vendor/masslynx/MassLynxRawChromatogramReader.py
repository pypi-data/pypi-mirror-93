...
class MassLynxRawChromatogramReader(MassLynxRawReader):
    ...
    def __init__(self, source ):
        super(MassLynxRawChromatogramReader, self).__init__(source, MassLynxBaseType.CHROM)
    ...
    def ReadTIC( self, whichFunction ):
        ...
        super(MassLynxRawChromatogramReader, self).CheckReturnCode( readTIC(self._getReader(),whichFunction, pTimes, pIntensities, size) )
    ...
    def ReadBPI( self, whichFunction ):
        ...
        super(MassLynxRawChromatogramReader, self).CheckReturnCode( readBPI(self._getReader(),whichFunction, pTimes, pIntensities, size) )
    ...
    def ReadMassChromatograms( self, whichFunction, whichMasses, massTollerance, daughters ):
        ...
        super(MassLynxRawChromatogramReader, self).CheckReturnCode( readMassChroms( self._getReader(), whichFunction, masses, numMasses, pTimes, pIntensities, massTollerance, daughters, size))
