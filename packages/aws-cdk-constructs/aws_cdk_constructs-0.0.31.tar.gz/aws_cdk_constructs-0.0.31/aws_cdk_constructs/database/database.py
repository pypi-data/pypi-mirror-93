        ...
        **kwargs,
        ...
        if is_not_production:
            if tag_scheduler_uptime_skip:
                Tags.of(self).add("SchedulerSkip", tag_scheduler_uptime_skip, apply_to_launched_instances=True,)

            if tag_scheduler_uptime:
                Tags.of(self).add("SchedulerUptime", tag_scheduler_uptime, apply_to_launched_instances=True,)

            if tag_scheduler_uptime_days:
                Tags.of(self).add("SchedulerUptimeDays", tag_scheduler_uptime_days, apply_to_launched_instances=True,)    
