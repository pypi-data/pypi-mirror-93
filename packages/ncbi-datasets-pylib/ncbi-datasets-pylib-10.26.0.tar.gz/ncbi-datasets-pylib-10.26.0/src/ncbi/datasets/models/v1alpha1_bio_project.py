...
class V1alpha1BioProject(object):
    ...
    def __init__(self, accession=None, parent_accession=None, parent_accessions=None, title=None, local_vars_configuration=None):  # noqa: E501
        ...
        if parent_accessions is not None:
    ...
    @property
    def parent_accessions(self):
        """Gets the parent_accessions of this V1alpha1BioProject.  # noqa: E501


        :return: The parent_accessions of this V1alpha1BioProject.  # noqa: E501
        :rtype: list[str]
        """
        return self._parent_accessions

    @parent_accessions.setter
    def parent_accessions(self, parent_accessions):
        """Sets the parent_accessions of this V1alpha1BioProject.


        :param parent_accessions: The parent_accessions of this V1alpha1BioProject.  # noqa: E501
        :type: list[str]
        """

        self._parent_accessions = parent_accessions
