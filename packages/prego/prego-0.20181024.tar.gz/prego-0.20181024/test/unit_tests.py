...
class FileMatchers(TestCase, AssertionTest):
    ...
    def test_file_permissions(self):
        prego.init()
        t = prego.Task()
        t.assert_that(prego.File('/etc/motd'), prego.has_permissions(0644))
        t.assert_that(prego.File('/etc/motd'), prego.has_permissions(0200))
        t.assert_that(prego.File('/etc/motd'), prego.has_permissions(0400))
        t.assert_that(prego.File('/etc/motd'), prego.has_permissions(0440))
        t.assert_that(prego.File('/etc/motd'), prego.has_permissions(0004))
        prego.commit()
