...
def process_configuration_context(
    ...
    ret_code, context_data = jarvis_misc.retrieve_context(
                                jarvis_configuration=jarvis_configuration,
                                firebase_user=firebase_user,
                                context_id=context_choice)

    if ret_code is False:
        return False, None

    # Transform configurationto string
    #
    ...
    try:
        ...
        read_configuration["configuration_id"] = read_configuration["account"].strip() + "-" + context_data["configuration_id"].strip() + "-" + read_configuration["configuration_id"].strip()
