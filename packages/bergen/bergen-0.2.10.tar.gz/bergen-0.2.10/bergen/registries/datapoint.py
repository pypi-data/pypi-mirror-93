...
class DataPointRegistry(object):
    ...
    def __init__(self) -> None:
        ...
        self.builders =  {
                ...
                DataPointType.GRAPHQL: lambda datapoint, bergen: GraphQlWard(host=datapoint.host, port=datapoint.port, token=bergen.auth.getToken(), protocol=bergen.auth.getProtocol())
        }
