...
class EmachineryWidget(QMainWindow):
    def __init__(self, default_path2acmsimc):
        QMainWindow.__init__(self)
        self.default_path2acmsimc = default_path2acmsimc
        ...
        if 'DrH' in __file__:
            ...
            print('CJH: will use plan B to load .ui.\n')
...
def main():
    app = QApplication([])
    window = EmachineryWidget(default_path2acmsimc=__file__[:-11]+'acmsimcv5')
    window.show()
    app.exec_()
