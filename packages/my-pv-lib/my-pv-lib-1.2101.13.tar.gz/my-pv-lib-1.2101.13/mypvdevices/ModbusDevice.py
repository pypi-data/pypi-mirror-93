    ...
    def __run__(self):
        while self.__running__:
            ...
            try:
                ...
                logging.warning("[ModbusDevice] ID " + str(self.__serial__) + " supervision failed failed. " + str(e))
    ...
    def getregistervalue(self, registerId):
        with self.__lock__:
            try:
                ...
                logging.warning("[ModbusDevice] ID " + str(self.__serial__) + " register not found. Register Id: " + str(registerId))
                value = None
        return value
