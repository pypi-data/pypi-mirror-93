...
__all__ = ['CorrCramerVLanding', 'CorrCramerVEstimates', 'CorrCramerV', 'CorrTetraLanding', 'CorrTetra', 'CorrLanding',
           'CorrSpearmansRhoLanding', 'CorrPBiLanding', 'CorrPearsonLanding', 'CorrView', 'Corr', 'CorrSpearmansRho',
           'CorrPBi', 'CorrPearson']
...
from ..models.corr import CorrCramerVModel, CorrTetraModel, CorrSpearmansRhoModel, CorrPBiModel, CorrPearsonModel
from .ratio import RatioLanding, RatioEstimates
from ..mvc import Controller
import superpower_gui.superpower as sp

# Cell
class CorrCramerVLanding(RatioLanding):
    pass

# Cell
class CorrCramerVEstimates(HBox):
...
# Cell
class CorrCramerV(CorrCramerVEstimates, Controller):
...
# Cell
class CorrTetraLanding(RatioLanding):
    pass

class CorrTetra(CorrCramerV):
    pass
...
class CorrSpearmansRhoLanding(CorrLanding):
    pass

class CorrPBiLanding(CorrLanding):
    pass

class CorrPearsonLanding(CorrLanding):
    pass
...
class CorrView(VBox):
    ...
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.function = CorrSpearmansRhoModel()
