...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('planing', '0276_auto_20201203_1740'),
    ]

    operations = [
        migrations.CreateModel(
            name='Production_order_made_history_operations',
            fields=[
                ...
                ('production_order_made_history', isc_common.fields.related.ForeignKeyProtect(on_delete=django.db.models.deletion.PROTECT, to='planing.production_order_made_history')),
            ],
            options={
