# Generated by Django 2.2.1 on 2019-05-29 13:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('production', '0037_auto_20190529_1326'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', isc_common.fields.related.ForeignKeyProtect(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='production.Resource_categories')),
            ],
            options={
                'verbose_name': 'Категории ресурсов',
            },
        ),
    ]
