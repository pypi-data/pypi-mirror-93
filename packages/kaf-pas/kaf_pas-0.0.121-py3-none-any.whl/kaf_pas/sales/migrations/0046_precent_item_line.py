...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ckk', '0063_delete_item_line_view'),
        ('sales', '0045_delete_precent_locations'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_line', isc_common.fields.related.ForeignKeyProtect(on_delete=django.db.models.deletion.PROTECT, to='ckk.Item_line')),
            ...
            options={
                'verbose_name': 'Комплектация распоряжения по строкам спецификации',
            },
        ),
    ]
