...
def Document_attributes_SPC_CLM_KOD_Fetch(request):
    return JsonResponse(
        DSResponse(
            request=request,
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_KOD_Add(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_KOD_Update(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_KOD_Remove(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_KOD_Lookup(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_KOD_Info(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_KOD_Copy(request):
