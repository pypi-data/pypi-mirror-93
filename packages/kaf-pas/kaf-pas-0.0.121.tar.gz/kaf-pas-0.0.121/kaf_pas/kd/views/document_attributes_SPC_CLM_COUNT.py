...
def Document_attributes_SPC_CLM_COUNT_Fetch(request):
    return JsonResponse(
        DSResponse(
            request=request,
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_COUNT_Add(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_COUNT_Update(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_COUNT_Remove(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_COUNT_Lookup(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_COUNT_Info(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_COUNT_Copy(request):
