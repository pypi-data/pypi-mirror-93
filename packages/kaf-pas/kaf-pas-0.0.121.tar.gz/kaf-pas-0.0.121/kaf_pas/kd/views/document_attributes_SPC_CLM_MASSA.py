...
def Document_attributes_SPC_CLM_MASSA_Fetch(request):
    return JsonResponse(
        DSResponse(
            request=request,
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_MASSA_Add(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_MASSA_Update(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_MASSA_Remove(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_MASSA_Lookup(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_MASSA_Info(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_MASSA_Copy(request):
