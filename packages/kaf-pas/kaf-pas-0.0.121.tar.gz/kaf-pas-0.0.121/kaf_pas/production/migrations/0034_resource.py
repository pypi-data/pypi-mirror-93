...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('production', '0033_auto_20190529_1148'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', isc_common.fields.related.ForeignKeyProtect(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='production.Resource')),
            ],
            options={
