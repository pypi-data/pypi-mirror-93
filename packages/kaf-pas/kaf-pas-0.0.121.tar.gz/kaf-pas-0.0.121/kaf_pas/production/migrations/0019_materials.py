...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('production', '0018_operations_refs'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', isc_common.fields.related.ForeignKeyProtect(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='production.Materials')),
            ],
            options={
