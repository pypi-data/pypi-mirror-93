...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('planing', '0019_location_loading_resource_loading'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('props', bitfield.models.BitField((('plus', 'Приходная операция'),), db_index=True, default=1)),
                ('parent', isc_common.fields.related.ForeignKeyProtect(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='planing.Operation_types')),
            ],
            options={
