...
class TestContainer(unittest.TestCase):
    ...
    def test_Container_foreachs(self):
        ...
        self.assertEquals(
            container_box.children[2].widget.events_list["say_hello1"][0], say_hello1
        )
        self.assertEquals(
            container_box.children[2].widget.events_list["say_hello2"][0], say_hello2
        )
        self.assertEquals(
            container_box.children[2].widget.events_list["say_hello3"][0], say_hello3
        )

        self.assertEquals(
            container_box.children[1].widget.events_list["say_hello1"][0], say_hello1
        )
        self.assertEquals(
            container_box.children[1].widget.events_list["say_hello2"][0], say_hello2
        )
        self.assertEquals(
            container_box.children[1].widget.events_list["say_hello3"][0], say_hello3
        )

        self.assertEquals(
            container_box.children[0].widget.events_list["say_hello1"][0], say_hello1
        )
        self.assertEquals(
            container_box.children[0].widget.events_list["say_hello2"][0], say_hello2
        )
        self.assertEquals(
            container_box.children[0].widget.events_list["say_hello3"][0], say_hello3
        )
