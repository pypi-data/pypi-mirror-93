...
Revision ID: 0f8cf37f3af3
Revises: 3e75fb851c5a
Create Date: 2017-10-30 23:35:02.241615

"""

# revision identifiers, used by Alembic.
revision = '0f8cf37f3af3'
down_revision = '3e75fb851c5a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('routePath', sa.String(), nullable=True),
    sa.Column('routeParamJson', sa.String(), nullable=True),
    ...
    sa.Column('autoDeleteDateTime', sa.DateTime(), nullable=True),
    ...
    sa.Column('displayPriority', sa.Integer(), server_default='0', nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('uniqueId'),
    schema='pl_inbox'
    )
    ...
    sa.Column('confirmMessage', sa.String(), nullable=True),
