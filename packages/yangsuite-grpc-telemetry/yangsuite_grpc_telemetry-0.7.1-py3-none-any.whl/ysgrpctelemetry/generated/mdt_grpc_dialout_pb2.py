...
MdtDialoutArgs = _reflection.GeneratedProtocolMessageType('MdtDialoutArgs', (_message.Message,), dict(
  ...
  __module__ = 'mdt_grpc_dialout.mdt_grpc_dialout_pb2'
