...
def pyminer_cell_signals_main(gene_lists,
    ...
    if not os.path.isfile(putative_human_file):
        ...
        script_dir = os.path.dirname(pyminer.__file__)
        putative_relative_human_file = os.path.join(script_dir,organism_action_files['hsapiens'])
        print(putative_relative_human_file)
        if os.path.isfile(putative_relative_human_file):
            print("\n\nFound it!\n", "using this as the stringdb_dir:",script_dir)
