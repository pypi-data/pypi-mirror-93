...
def test_read_input_dataset(science_task):
    """
    Given: an input dataset document
    When: reading the input dataset
    Then: the sections of the input dataset are correctly populated
    """
    ids = science_task._read_input_dataset()
    assert ids["bucket"] == "bucket-name"
    assert len(ids["frames"]) == 3


def test_write_intermediate_fits(science_task, intermediate_fits):
    """
    Given: a fits file
...
def test_write_output_fits(science_task, output_fits):
    """
    Given: a fits file
    When: writing the file
    Then: the file exists
...
def test_read_intermediate_fits(science_task, intermediate_fits):
    """
...
def test_intermediate_dark(science_task):
    """
    Given: a specific type of input
    When: reading frames that match the input
    Then: the correct number of frames are read and the contents can be examined
...
def test_intermediate_gain(science_task):
    """
    Given: a specific type of input
    When: reading frames that match the input
    Then: the correct number of frames are read and the contents can be examined
...
def test_intermediate_target(science_task):
    """
    Given: a specific type of input
    When: reading frames that match the input
    Then: the correct number of frames are read and the contents can be examined
...
def test_intermediate_instpolcal(science_task):
    """
    Given: a specific type of input
    When: reading frames that match the input
    Then: the correct number of frames are read and the contents can be examined
...
def test_intermediate_telpolcal(science_task):
    """
    Given: a specific type of input
    When: reading frames that match the input
    Then: the correct number of frames are read and the contents can be examined
...
def test_intermediate_geometric(science_task):
    """
    Given: a specific type of input
    When: reading frames that match the input
    Then: the correct number of frames are read and the contents can be examined
