...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'splunk', '0.1.2-alpha.1611855921+1b111dc0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource splunk 0.1.2-alpha.1611855921+1b111dc0`
                """)
            else:
                raise
