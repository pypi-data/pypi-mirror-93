...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'venafi', '0.1.2-alpha.1611857314+14cb3e1f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource venafi 0.1.2-alpha.1611857314+14cb3e1f`
                """)
            else:
                raise
