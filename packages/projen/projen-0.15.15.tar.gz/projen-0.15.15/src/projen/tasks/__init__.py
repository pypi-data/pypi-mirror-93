...
class Task(metaclass=jsii.JSIIMeta, jsii_type="projen.tasks.Task"):
    ...
    def env(self, name: builtins.str, value: builtins.str) -> None:
        ...
        :stability: experimental
        """
        return jsii.invoke(self, "env", [name, value])
    ...
    def exec(
        ...
        *,
        ...
        return jsii.invoke(self, "exec", [command, options])
    ...
    def prepend(
        ...
        *,
        ...
        return jsii.invoke(self, "prepend", [shell, options])
    ...
    def prepend_exec(
        ...
        *,
        ...
        return jsii.invoke(self, "prependExec", [shell, options])
    ...
    def prepend_say(
        ...
        *,
        ...
        return jsii.invoke(self, "prependSay", [message, options])
    ...
    def prepend_spawn(
        ...
        *,
        ...
        return jsii.invoke(self, "prependSpawn", [subtask, options])
    ...
    def reset(self, command: typing.Optional[builtins.str] = None) -> None:
        ...
        :stability: experimental
        """
        return jsii.invoke(self, "reset", [command])
    ...
    def say(
        ...
        *,
        ...
        return jsii.invoke(self, "say", [message, options])
    ...
    def spawn(
        ...
        *,
        ...
        return jsii.invoke(self, "spawn", [subtask, options])
    ...
    def to_shell_command(self) -> builtins.str:
        ...
        :stability: experimental
        """
        return jsii.invoke(self, "toShellCommand", [])
...
class TaskRuntime(metaclass=jsii.JSIIMeta, jsii_type="projen.tasks.TaskRuntime"):
    ...
    def run_task(
        ...
        :stability: experimental
        """
        return jsii.invoke(self, "runTask", [name, parents])
    ...
    def try_find_task(self, name: builtins.str) -> typing.Optional["TaskSpec"]:
        ...
        :stability: experimental
        """
        return jsii.invoke(self, "tryFindTask", [name])
...
class Tasks(
    ...
    def add_task(
        ...
        *,
        ...
        return jsii.invoke(self, "addTask", [name, options])
    ...
    def try_find(self, name: builtins.str) -> typing.Optional[Task]:
        ...
        :stability: experimental
        """
        return jsii.invoke(self, "tryFind", [name])
