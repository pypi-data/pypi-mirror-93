...
from sermos_tools.catalog_staging.ner_tool import engine
...
def run_training():
    ...
    train_dataset = dataset.EntityDataset(texts=train_sentences,
                                          pos=train_pos,
                                          tags=train_tag)
    ...
    valid_dataset = dataset.EntityDataset(texts=test_sentences,
                                          pos=test_pos,
                                          tags=test_tag)
    ...
    if torch.cuda.is_available():
        ...
        logger.info(msg)
        msg = "We will use the GPU: " + str(torch.cuda.get_device_name(0))
        logger.info(msg)
