...
#NOTE: from https://github.com/switchablenorms/AdaX

class AdaX(torch.optim.Optimizer):
    r"""Implements AdaX algorithm.

    - **Paper**: [AdaX: Adaptive Gradient Descent with Exponential Long Term Memory](https://arxiv.org/pdf/2004.09740.pdf)
    - **Implementation**: [GitHub @ switchablenorms](https://github.com/switchablenorms/AdaX)
    ...
    def __init__(self, 
        ...
        lr: float=1.5e-3,
        betas: typing.Tuple[float, float]=(0.9, 1e-4),
        eps: float=1e-12,
...
class AdaXW(torch.optim.Optimizer):
