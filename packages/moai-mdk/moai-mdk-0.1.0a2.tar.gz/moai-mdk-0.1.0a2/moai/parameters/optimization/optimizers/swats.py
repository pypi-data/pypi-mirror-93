...
#NOTE: modified from https://github.com/Mrpatekful/swats

class SWATS(torch.optim.Optimizer):
    r"""Implements Switching from Adam to SGD technique. 
    
    - **Paper**: [Improving Generalization Performance by Switching from Adam to SGD](https://arxiv.org/pdf/1712.07628.pdf)
    - **Implementation**: [GitHub @ Mrpatekful](https://github.com/Mrpatekful/swats)
