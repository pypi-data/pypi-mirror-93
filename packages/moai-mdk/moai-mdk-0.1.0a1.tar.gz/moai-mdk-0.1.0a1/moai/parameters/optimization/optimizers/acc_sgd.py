...
class AccSGD(torch.optim.Optimizer):
    ...
    - **Paper**: [On the insufficiency of existing momentum schemes for Stochastic Optimization](https://arxiv.org/pdf/1803.05591.pdf)
    - **Paper**: [Accelerating Stochastic Gradient Descent For Least Squares Regression](https://arxiv.org/pdf/1704.08227.pdf)
