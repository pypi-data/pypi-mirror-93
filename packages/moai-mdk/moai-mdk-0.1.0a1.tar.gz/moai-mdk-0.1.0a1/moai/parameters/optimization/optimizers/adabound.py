...
#NOTE: modified from https://github.com/Luolc/AdaBound

class AdaBound(torch.optim.Optimizer):
    """Implements AdaBound algorithm.

    - **Paper**: [Adaptive Gradient Methods with Dynamic Bound of Learning Rate](https://arxiv.org/pdf/1902.09843.pdf).
    - **Implementation**: [GitHub Repo @ Luolc](https://github.com/Luolc/AdaBound)
