...
#NOTE: from https://github.com/NVIDIA/apex/blob/master/apex/parallel/LARC.py
...
class LARCAdam(LARC):
    """ Implements the LARC algorithm with Adam as the inner optimizer.
