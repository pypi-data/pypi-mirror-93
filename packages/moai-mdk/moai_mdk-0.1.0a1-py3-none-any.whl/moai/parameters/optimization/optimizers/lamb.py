...
class Lamb(torch.optim.Optimizer):
    ...
    - **Implementation**: [GitHub @ cybertronai](https://github.com/cybertronai/pytorch-lamb/)

    !!! note "See this [blog](https://towardsdatascience.com/an-intuitive-understanding-of-the-lamb-optimizer-46f8c0ae4866) for additional information."
