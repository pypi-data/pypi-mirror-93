...
# TO DO: create a random shuffle of a list of data arrays to do testing?
# Or do that in the testing folder?
# --> would maybe add here, can then be called from examples/ folder? in a script there
# could also create random 2 flow fields and write as hdf5 for sake of testing comparison
