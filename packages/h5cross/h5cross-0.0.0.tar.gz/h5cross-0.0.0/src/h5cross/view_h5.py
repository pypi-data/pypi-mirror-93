...
def seaborn_simple_scatter(array1, array2, axes_labels,
    ...
    plot = sns.jointplot(array1,array2, kind = "reg")
...
def matplotlib_simple_distribution(array1, array2, axes_labels,
    ...
    """
    import matplotlib.pyplot as plt
    # TODO: if length dataset < nbins :  change the bin number
    bin_vals, bins, patches = plt.hist(array1, 50,
                                 density=False, facecolor='g', alpha=0.75, label="field 1")
    bin_vals, bins, patches = plt.hist(array2, 50,
                                 density=False, facecolor='b', alpha=0.75, label="field 2")
