...
class CacheEngine(KqlEngine):
    ...
    # Object constructor
    def __init__(self, conn_str_or_engine:Union[str,KqlEngine], user_ns:Dict[str,Any], current:KqlEngine=None, cache_name:str=None, **options)->None:
    ...
    def validate(self, **options)->None:
        ...
        kql_response = self.execute(database, filename, accept_partial_results=False, **options)
