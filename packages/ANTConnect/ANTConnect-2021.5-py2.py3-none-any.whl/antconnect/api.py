...
class API:
    ...
    # tasks
    def tasks_read(self, project_id: str = "") -> [dict]:
        """ Get tasks """
        path = 'tasks'
        return self._make_api_request(path, 'GET', {
    ...
    def task_create(self, project_id: str, name: str, description: str, status: str, due_date: str, assigned_user: str, start_date: str) -> dict:
        """ Create a table in a project """
        path = 'task'
        return self._make_api_request(path, 'POST', {
            "project": {"id": project_id},
    ...
    def task_respond(self, task_id: str, response: str, assigned_user: str, status: str, description: str = "", due_date: str = "") -> dict:
        """ Update a table in a project """
