...
from facetoolsz.core.cv2ex import *
from facetoolsz.core.imagelib import SegIEPolys
from facetoolsz.core.interact import interact as io
from facetoolsz.core.structex import *
...
class ZJPG(object):
    ...
    def load(filename, loader_func=None):
        try:
            inst = ZJPG.load_raw (filename, loader_func=loader_func)
            inst.dfl_dict = {}
            ...
            io.log_err (f'Exception occured while ZJPG.load : {traceback.format_exc()}')
            return None
    ...
    def get_face_id(self):
        return self.dfl_dict.get('face_id', -1)
        
    def set_face_id(self, face_id):
        self.dfl_dict['face_id'] = face_id
