...
SLEPC_EXTERN void  veccheckorthonormality_(Vec V[],PetscInt *nv,Vec W[],PetscInt *nw,Mat B,PetscViewer viewer,PetscReal *lev, int *__ierr)
{
*__ierr = VecCheckOrthonormality(V,*nv,W,*nw,
	(Mat)PetscToPointer((B) ),
	(PetscViewer)PetscToPointer((viewer) ),lev);
}
