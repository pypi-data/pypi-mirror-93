...
if __name__ == '__main__':
    field1 = Field(column='{{measure.A}}', aggregation="MAX", dataset='{{dataset.A}}', entityType="measure", alias="max_measure")
    ...
    dump = jsons.dump(smartquery)
    print(dump)
    smartquery = jsons.load(dump, SmartQuery)
    print(smartquery)
