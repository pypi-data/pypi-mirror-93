...
class SQLAlchemy:
    ...
    def __int__(self, logger: logging.Logger = None):
        self._engine = None
    ...
    def _create_engine(self, options: Dict) -> Tuple[str, object]:
        raise NotImplementedError("Engine must be created by the sub class")

    def _setup_engine_logging(self, options: Dict = None):
    ...
    def migrate(self, options: Dict = {}):
        """
        :options:
        - key: migrations_dirs:List[PurePath], list of absolute path to sql migration scripts
        """
