...
class ServiceSubscriptionApiViewSet(mixins.CreateModelMixin,
    ...
    def subscribe(self, request, pk, *args, **kwargs):
        ...
        subscription_created = adapter.subscribe_profile_to_service(profile, service, update_rev=True)
    ...
    def unsubscribe(self, request, pk, *args, **kwargs):
        ...
        if subscriptions.count() == 0:
            ...
            subscription_disabled = adapter.disable_profile_subscription(profile, subscription, update_rev=True)
