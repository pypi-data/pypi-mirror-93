...
from tests.unittest_base import (
...
class TestCLIList(TestCLI):
    ...
    def test_list_workspaces(self, mock_get_request):
        ...
        mock_get_request.return_value.json.return_value = MOCK_WORKSPACES_RESPONSE

        result = self.runner.invoke(matatika, ["list",
                                               "workspaces"])

        workspaces = MOCK_WORKSPACES_RESPONSE['_embedded']['workspaces']
    ...
    def test_list_datasets(self, mock_get_request):
        ...
        mock_get_request.return_value.status_code = 200
        mock_get_request.return_value.json.return_value = MOCK_DATASETS_RESPONSE
        ...
        datasets = MOCK_DATASETS_RESPONSE['_embedded']['datasets']
