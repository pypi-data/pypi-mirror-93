...
class DebugGroup(ArgumentGroup):
    ...
    def add_arguments(self, parser: ArgumentParser):
        ...
        parser.add_argument(
            "--auto-connect-repo",
            action="store_true",
            help="Automatically connect repo agent.",
        )
        parser.add_argument(
            "--auto-accept-invites",
            action="store_true",
        ...
        parser.add_argument(
            "--auto_connect_repo",
            action="store_true",
            help="Automatically connect repo",
        )
        parser.add_argument(
    ...
    def get_settings(self, args: Namespace) -> dict:
        ...
        if args.auto_connect_repo:
            settings["auto.connect.repo"] = args.auto_connect_repo
...
class GeneralGroup(ArgumentGroup):
    ...
    def get_settings(self, args: Namespace) -> dict:
        ...
        if args.repo_url:
            settings["repo_url"] = args.repo_url
