...
- items (list of strings | list of dicts | list of a list of or a singular dash component, string or numbers; default undefined): An array of items displayed by the UI component
