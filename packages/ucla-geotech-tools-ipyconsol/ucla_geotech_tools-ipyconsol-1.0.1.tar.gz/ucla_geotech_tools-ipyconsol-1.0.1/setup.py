...
with open("ucla_geotech_tools/ipyconsol/README.md","r") as fh:
    long_description = fh.read()

sourcefiles = ['ucla_geotech_tools/ipyconsol/ipyconsol.c']
...
setup(
    ...
    ext_modules=[Extension('ucla_geotech_tools.ipyconsol',['ucla_geotech_tools/ipyconsol/ipyconsol.c'])],
