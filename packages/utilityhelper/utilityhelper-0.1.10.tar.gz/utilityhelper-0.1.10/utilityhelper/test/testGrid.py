...
import wx
import wx.grid
from utilityhelper.wxwrap import HelpGridTable
...
class myGrid(wx.grid.Grid):
    def __init__(self, parent, dataTable, dataTypes = [], rowLabels=None, colLabels=None):
        ...
        self.tableBase = HelpGridTable.GenericTable(dataTable, dataTypes, rowLabels, colLabels)
...
############################################################    
#使用这通用的表来显示阵容
colLabels = ('Select', 'Last', 'First', "gender ")
rowLabels = None
