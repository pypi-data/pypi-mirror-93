...
from aistac.components.aistac_commons import AbstractAnalytics, AistacCommons, AbstractSection
...
class CommonsTest(unittest.TestCase):
    ...
    def test_analytics(self):
        ...
        class TestAnalysis(AbstractAnalytics):
