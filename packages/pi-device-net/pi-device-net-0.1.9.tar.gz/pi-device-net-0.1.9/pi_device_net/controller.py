...
class ControlNetwork():
    ...
    def __init__(self,
        ...
        if not testing:
            ...
            if ret != 0:
                ...
                LOG.error("sudo apt-get install mosquittosudo apt-get install mosquitto")
    ...
    def discover(self):
        ...
        while True:
            try:
                ...
                logging.error(f"Unmanaged exception {type(e)}: {e}")
                break
    ...
    def publish(self, topic_path, message):
        ...
        packet = asdict(cmd)
        # QOS 1 : At least once
        self._mqtt.publish(topic_path, json.dumps(packet).encode(), qos=1)
