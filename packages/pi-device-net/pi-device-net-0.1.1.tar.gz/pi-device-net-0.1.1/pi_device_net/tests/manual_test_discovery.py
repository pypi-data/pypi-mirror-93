...
if __name__ == '__main__':
    ...
    if mode == 'controller':
        ...
        # a controller (at least, until we give up). To retry forever,
        # don't specify either timeout or retries, or set retreis to
        # ModuleNetwork.RETRY_FOREVER.
        module.discover(timeout=2, retries=10)
        for i in range(10):
