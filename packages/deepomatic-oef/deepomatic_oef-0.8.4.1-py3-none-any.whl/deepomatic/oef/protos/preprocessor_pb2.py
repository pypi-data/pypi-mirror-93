...
_PREPROCESSINGSTEP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='probability', full_name='deepomatic.oef.preprocessor.PreprocessingStep.probability', index=30,
