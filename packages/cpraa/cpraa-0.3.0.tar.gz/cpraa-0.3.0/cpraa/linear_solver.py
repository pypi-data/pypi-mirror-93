...
class LinearSolver:
    ...
    def assignments_to_row(self, assignments: List[asg.Assignment]):
    ...
    def constraints_assignments_less_or_equal_value(
            self, assignments: List[asg.Assignment], value) -> List[Constraint]:
        """
    ...
    def constraints_assignments_less_or_equal_assignments(
            self, assignments_a: List[asg.Assignment], assignments_b: List[asg.Assignment]) -> List[Constraint]:
        """
    ...
    def get_node_value(self, node: AF.Node, distribution_vector):
        ...
        """
        prob_sum = 0
        for a in asg.get_node_full_assignments(node, self.af.get_nodes()):
