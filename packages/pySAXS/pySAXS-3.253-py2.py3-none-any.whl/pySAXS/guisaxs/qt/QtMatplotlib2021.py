...
class QtMatplotlib():#lQtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setXScaleAction= QtWidgets.QAction(QtGui.QIcon(ICON_PATH+'xscale.png'),'Set X Scale')#, self)
        ...
        #self.parent.ui.navi_toolbar.addWidget(PlotButton)
        #self.parent.ui.toolBar.addWidget(PlotButton)
        ...
        #--Autoscale
        self.AutoscaleAction= QtWidgets.QAction('Autoscale', self.parent)
    ...
    def OnSetXRange(self):
        ...
        self.xlim_min,self.xlim_max=self.axes.get_xlim()
        xlim, ok=QtWidgets.QInputDialog.getDouble(self.parent, "Setting X scale", "x min :", value=self.xlim_min)
        if ok:
            self.xlim_min=xlim
            self.axes.set_xlim((self.xlim_min,self.xlim_max))
            self.FixScaleAction.setChecked(True)
            self.replot()
        xlim, ok=QtWidgets.QInputDialog.getDouble(self.parent, "Setting X scale", "x max :", value=self.xlim_max)
        if ok:
            self.xlim_max=xlim
            self.axes.set_xlim((self.xlim_min,self.xlim_max))
            self.FixScaleAction.setChecked(True)
    ...
    def OnSetYRange(self):
        ...
        self.axes = self.plt.gca()
        self.ylim_min,self.ylim_max=self.axes.get_ylim()
        ylim, ok=QtWidgets.QInputDialog.getDouble(self.parent, "Setting Y scale", "y min :", value=self.ylim_min)
        if ok:
            self.ylim_min=ylim
            self.axes.set_ylim((self.ylim_min,self.ylim_max))
            self.FixScaleAction.setChecked(True)
            self.replot()
        ylim, ok=QtWidgets.QInputDialog.getDouble(self.parent, "Setting Y scale", "y max :", value=self.ylim_max)
        if ok:
            self.ylim_max=ylim
            self.axes.set_ylim((self.ylim_min,self.ylim_max))
            self.FixScaleAction.setChecked(True)
