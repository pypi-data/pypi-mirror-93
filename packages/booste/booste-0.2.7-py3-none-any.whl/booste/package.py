...
from .clip_utils import clip_main, clip_image_main, clip_text_main, clip_fast_main
import asyncio
...
def clip(api_key, prompts, images, forward=True):
    dict_out = asyncio.run(clip_main(api_key, prompts, images, forward))
    return(dict_out)
