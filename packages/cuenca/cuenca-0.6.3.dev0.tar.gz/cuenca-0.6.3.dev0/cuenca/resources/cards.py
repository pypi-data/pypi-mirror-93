...
from cuenca_validations.types import CardStatus, CardType, CardIssuer, CardFundingType
...
class Card(Retrievable, Queryable, Creatable, Updateable):
    ...
    def create(
        ...
        *,
        ...
        """
        req = CardRequest(ledger_account_id=ledger_account_id, user_id=user_id, issuer=issuer, funding_type=funding_type)
