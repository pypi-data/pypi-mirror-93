...
def dwave_example_qubo(config):
    ...
    config
        The config object that contains the users configuration data
    """
    # ra_dict = {"reinitialize_state": True, "anneal_schedule": [(0.0, 1.0), (2.5, 0.5), (27.5, 0.5), (30.0, 1.0)],
    #            "initial_state": [(168,1)]}
...
def find_chimera_embedding_example(config):
    ...
    # Note: If you generate a embedding via problem.find_chimera_embedding(), the embedding will be saved in the
...
def find_pegasus_embedding_example(config):
    ...
    # Note: If you generate a embedding via problem.find_chimera_embedding(), the emb,d in the
    #       variable problem.embedding - you can directly access, view and save it.
