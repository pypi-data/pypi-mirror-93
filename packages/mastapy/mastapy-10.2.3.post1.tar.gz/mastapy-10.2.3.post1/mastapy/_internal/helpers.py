...
def _match_versions():
    ...
    if hasattr(utility_methods, 'ReleaseVersionString'):
        release_version_str = utility_methods.ReleaseVersionString
    else:
        utility_methods = python_net_import('SMT.MastaAPI', 'Versioning')
        release_version_str = utility_methods.APIReleaseVersionString
