...
from mastapy.math_utility.optimisation import _1315, _1313
...
class ParetoOptimistaionVariable(_1313.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1315.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1315.PropertyTargetForDominantCandidateSearch)(value) if value else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1315.PropertyTargetForDominantCandidateSearch'):
