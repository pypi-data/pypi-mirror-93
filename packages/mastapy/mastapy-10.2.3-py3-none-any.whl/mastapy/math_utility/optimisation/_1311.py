...
from mastapy.math_utility.optimisation import _1310
...
class ParetoOptimisationStrategyChartInformation(_0.APIBase):
    ...
    @property
    def bars(self) -> 'List[_1310.ParetoOptimisationStrategyBars]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bars, constructor.new(_1310.ParetoOptimisationStrategyBars))
        return value
