...
from mastapy.math_utility.optimisation import _1318, _1317
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    @property
    def range(self) -> '_1249.Range':
        '''Range: 'Range' is the original name of this property.'''

        if _1249.Range.TYPE not in self.wrapped.Range.__class__.__mro__:
    ...
    @range.setter
    def range(self, value: '_1249.Range'):
        value = value.wrapped if value else None
        self.wrapped.Range = value

    @property
    def integer_range(self) -> '_1342.IntegerRange':
        '''IntegerRange: 'IntegerRange' is the original name of this property.'''

        return constructor.new(_1342.IntegerRange)(self.wrapped.IntegerRange) if self.wrapped.IntegerRange else None

    @integer_range.setter
    def integer_range(self, value: '_1342.IntegerRange'):
        value = value.wrapped if value else None
    ...
    @property
    def specification_type(self) -> '_1318.TargetingPropertyTo':
        ...
        return constructor.new(_1318.TargetingPropertyTo)(value) if value else None

    @specification_type.setter
    def specification_type(self, value: '_1318.TargetingPropertyTo'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def specify_input_range_as(self) -> '_1317.SpecifyOptimisationInputAs':
        ...
        return constructor.new(_1317.SpecifyOptimisationInputAs)(value) if value else None

    @specify_input_range_as.setter
    def specify_input_range_as(self, value: '_1317.SpecifyOptimisationInputAs'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
