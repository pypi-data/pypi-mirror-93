...
from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1203
...
class KeywayRating(_1211.InterferenceFitRating):
    '''KeywayRating
    ...
    @property
    def keyed_joint_design(self) -> '_1199.KeyedJointDesign':
        ...
        return constructor.new(_1199.KeyedJointDesign)(self.wrapped.KeyedJointDesign) if self.wrapped.KeyedJointDesign else None

    @property
    def keyway_half_ratings(self) -> 'List[_1203.KeywayHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KeywayHalfRatings, constructor.new(_1203.KeywayHalfRating))
        return value
