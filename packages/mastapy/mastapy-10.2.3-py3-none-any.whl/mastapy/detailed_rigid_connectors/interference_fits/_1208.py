...
from mastapy.bearings.tolerances import _1618, _1604, _1610
...
class InterferenceFitHalfDesign(_1150.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1209.StressRegions':
        ...
        return constructor.new(_1209.StressRegions)(value) if value else None
    ...
    @property
    def tolerance(self) -> '_1618.SupportTolerance':
        ...
        if _1618.SupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1604.InnerSupportTolerance':
        ...
        if _1604.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1610.OuterSupportTolerance':
        ...
        if _1610.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
