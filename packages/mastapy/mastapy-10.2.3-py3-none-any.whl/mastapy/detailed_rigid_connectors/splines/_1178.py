...
from mastapy.detailed_rigid_connectors.splines import _1160
...
class SplineMaterial(_234.Material):
    '''SplineMaterial
    ...
    @property
    def heat_treatment_type(self) -> '_1160.HeatTreatmentTypes':
    ...
    def heat_treatment_type(self, value: '_1160.HeatTreatmentTypes'):
