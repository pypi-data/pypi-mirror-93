...
from mastapy.detailed_rigid_connectors.splines import _1157, _1182
...
class SAESplineJointDesign(_1182.StandardSplineJointDesign):
    '''SAESplineJointDesign
    ...
    @property
    def fit_type(self) -> '_1157.FitTypes':
        '''FitTypes: 'FitType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FitType)
        return constructor.new(_1157.FitTypes)(value) if value else None

    @fit_type.setter
    def fit_type(self, value: '_1157.FitTypes'):
