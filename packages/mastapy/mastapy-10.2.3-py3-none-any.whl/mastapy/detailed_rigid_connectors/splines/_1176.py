...
from mastapy.detailed_rigid_connectors.splines import (
    _1160, _1177, _1152, _1155,
    _1159, _1162, _1163, _1170,
    _1182
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1183
...
class SplineHalfDesign(_1150.DetailedRigidConnectorHalfDesign):
    '''SplineHalfDesign
    ...
    @property
    def heat_treatment(self) -> '_1160.HeatTreatmentTypes':
        ...
        return constructor.new(_1160.HeatTreatmentTypes)(value) if value else None

    @heat_treatment.setter
    def heat_treatment(self, value: '_1160.HeatTreatmentTypes'):
    ...
    @property
    def fit_and_tolerance(self) -> '_1183.FitAndTolerance':
        ...
        return constructor.new(_1183.FitAndTolerance)(self.wrapped.FitAndTolerance) if self.wrapped.FitAndTolerance else None
