...
from mastapy.detailed_rigid_connectors.splines import _1164, _1173, _1181
...
class DIN5480SplineHalfDesign(_1181.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_1164.ManufacturingTypes':
        ...
        return constructor.new(_1164.ManufacturingTypes)(value) if value else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_1164.ManufacturingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ManufacturingType = value

    @property
    def finishing_method(self) -> '_1173.FinishingMethods':
        ...
        return constructor.new(_1173.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1173.FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
