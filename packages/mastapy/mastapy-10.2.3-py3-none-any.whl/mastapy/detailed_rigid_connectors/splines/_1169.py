...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1184
...
class SAESplineHalfDesign(_1181.StandardSplineHalfDesign):
    '''SAESplineHalfDesign
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_1184.SAESplineTolerances':
        ...
        return constructor.new(_1184.SAESplineTolerances)(self.wrapped.SAEAccuracyAndTolerance) if self.wrapped.SAEAccuracyAndTolerance else None
