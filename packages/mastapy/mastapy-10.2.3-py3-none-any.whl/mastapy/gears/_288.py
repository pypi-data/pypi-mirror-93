...
from mastapy.gears.rating.cylindrical import _434, _419
from mastapy.gears.gear_designs.cylindrical import _1007, _945
from mastapy.materials import _232, _221
...
class GearSetDesignGroup(_0.APIBase):
    ...
    @property
    def misalignment_contact_pattern_enhancement(self) -> '_434.MisalignmentContactPatternEnhancements':
        ...
        return constructor.new(_434.MisalignmentContactPatternEnhancements)(value) if value else None

    @misalignment_contact_pattern_enhancement.setter
    def misalignment_contact_pattern_enhancement(self, value: '_434.MisalignmentContactPatternEnhancements'):
    ...
    @property
    def default_rough_toleranced_metal_measurement(self) -> '_1007.TolerancedMetalMeasurements':
        ...
        return constructor.new(_1007.TolerancedMetalMeasurements)(value) if value else None

    @default_rough_toleranced_metal_measurement.setter
    def default_rough_toleranced_metal_measurement(self, value: '_1007.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubrication_detail(self) -> '_232.LubricationDetail':
        ...
        return constructor.new(_232.LubricationDetail)(self.wrapped.LubricationDetail) if self.wrapped.LubricationDetail else None

    @property
    def general_transmission_properties(self) -> '_221.GeneralTransmissionProperties':
        ...
        return constructor.new(_221.GeneralTransmissionProperties)(self.wrapped.GeneralTransmissionProperties) if self.wrapped.GeneralTransmissionProperties else None

    @property
    def settings(self) -> '_419.CylindricalGearRatingSettings':
        ...
        return constructor.new(_419.CylindricalGearRatingSettings)(self.wrapped.Settings) if self.wrapped.Settings else None
