...
from mastapy.gears.ltca import _779, _777
...
class GearMeshLoadDistributionAnalysis(_1130.GearMeshImplementationAnalysis):
    '''GearMeshLoadDistributionAnalysis
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1274.FourierSeries':
        ...
        return constructor.new(_1274.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries else None

    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_779.GearMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_779.GearMeshLoadDistributionAtRotation))
        return value

    def maximum_root_stress(self, gear: '_777.GearLoadDistributionAnalysis', stress_type: '_78.StressResultsType') -> 'float':
    ...
    def maximum_root_stress_with_flanks(self, gear: '_777.GearLoadDistributionAnalysis', flank: '_286.GearFlanks', stress_type: '_78.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
