...
class CylindricalGearRatingSettings(_1345.PerMachineSettings):
    '''CylindricalGearRatingSettings
    ...
    @property
    def tip_relief_in_scuffing_calculation(self) -> '_441.TipReliefScuffingOptions':
        ...
        return constructor.new(_441.TipReliefScuffingOptions)(value) if value else None

    @tip_relief_in_scuffing_calculation.setter
    def tip_relief_in_scuffing_calculation(self, value: '_441.TipReliefScuffingOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TipReliefInScuffingCalculation = value

    @property
    def dynamic_factor_method(self) -> '_428.DynamicFactorMethods':
        ...
        return constructor.new(_428.DynamicFactorMethods)(value) if value else None

    @dynamic_factor_method.setter
    def dynamic_factor_method(self, value: '_428.DynamicFactorMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def gear_blank_factor_calculation_option(self) -> '_429.GearBlankFactorCalculationOptions':
        ...
        return constructor.new(_429.GearBlankFactorCalculationOptions)(value) if value else None

    @gear_blank_factor_calculation_option.setter
    def gear_blank_factor_calculation_option(self, value: '_429.GearBlankFactorCalculationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def film_thickness_equation_for_scuffing(self) -> '_438.ScuffingMethods':
        ...
        return constructor.new(_438.ScuffingMethods)(value) if value else None

    @film_thickness_equation_for_scuffing.setter
    def film_thickness_equation_for_scuffing(self, value: '_438.ScuffingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FilmThicknessEquationForScuffing = value

    @property
    def micropitting_rating_method(self) -> '_432.MicropittingRatingMethod':
        ...
        return constructor.new(_432.MicropittingRatingMethod)(value) if value else None

    @micropitting_rating_method.setter
    def micropitting_rating_method(self, value: '_432.MicropittingRatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def permissible_bending_stress_method(self) -> '_435.RatingMethod':
        ...
        return constructor.new(_435.RatingMethod)(value) if value else None

    @permissible_bending_stress_method.setter
    def permissible_bending_stress_method(self, value: '_435.RatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def chosen_tooth_thickness_for_bending_strength(self) -> '_442.ToothThicknesses':
        ...
        return constructor.new(_442.ToothThicknesses)(value) if value else None

    @chosen_tooth_thickness_for_bending_strength.setter
    def chosen_tooth_thickness_for_bending_strength(self, value: '_442.ToothThicknesses'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
