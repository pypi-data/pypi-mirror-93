...
from mastapy.utility.scripting import _1473
...
class FlankMicroGeometry(_0.APIBase):
    ...
    @property
    def micro_geometry_input_type(self) -> '_296.MicroGeometryInputTypes':
        ...
        return constructor.new(_296.MicroGeometryInputTypes)(value) if value else None

    @micro_geometry_input_type.setter
    def micro_geometry_input_type(self, value: '_296.MicroGeometryInputTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MicroGeometryInputType = value

    @property
    def user_specified_data(self) -> '_1473.UserSpecifiedData':
        ...
        return constructor.new(_1473.UserSpecifiedData)(self.wrapped.UserSpecifiedData) if self.wrapped.UserSpecifiedData else None

    @property
    def gear_design(self) -> '_876.GearDesign':
        ...
        if _876.GearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_zerol_bevel_gear_design(self) -> '_881.ZerolBevelGearDesign':
        ...
        if _881.ZerolBevelGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_worm_design(self) -> '_885.WormDesign':
        ...
        if _885.WormDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_worm_gear_design(self) -> '_886.WormGearDesign':
        ...
        if _886.WormGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_worm_wheel_design(self) -> '_889.WormWheelDesign':
        ...
        if _889.WormWheelDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_straight_bevel_diff_gear_design(self) -> '_890.StraightBevelDiffGearDesign':
        ...
        if _890.StraightBevelDiffGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_straight_bevel_gear_design(self) -> '_894.StraightBevelGearDesign':
        ...
        if _894.StraightBevelGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_spiral_bevel_gear_design(self) -> '_898.SpiralBevelGearDesign':
        ...
        if _898.SpiralBevelGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_design(self) -> '_902.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        if _902.KlingelnbergCycloPalloidSpiralBevelGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_klingelnberg_cyclo_palloid_hypoid_gear_design(self) -> '_906.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        if _906.KlingelnbergCycloPalloidHypoidGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_klingelnberg_conical_gear_design(self) -> '_910.KlingelnbergConicalGearDesign':
        ...
        if _910.KlingelnbergConicalGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_hypoid_gear_design(self) -> '_914.HypoidGearDesign':
        ...
        if _914.HypoidGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_face_gear_design(self) -> '_918.FaceGearDesign':
        ...
        if _918.FaceGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_face_gear_pinion_design(self) -> '_923.FaceGearPinionDesign':
        ...
        if _923.FaceGearPinionDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_face_gear_wheel_design(self) -> '_926.FaceGearWheelDesign':
        ...
        if _926.FaceGearWheelDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_cylindrical_gear_design(self) -> '_941.CylindricalGearDesign':
    ...
    @property
    def gear_design_of_type_cylindrical_planet_gear_design(self) -> '_967.CylindricalPlanetGearDesign':
        ...
        if _967.CylindricalPlanetGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_conical_gear_design(self) -> '_1064.ConicalGearDesign':
        ...
        if _1064.ConicalGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_concept_gear_design(self) -> '_1086.ConceptGearDesign':
        ...
        if _1086.ConceptGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_bevel_gear_design(self) -> '_1090.BevelGearDesign':
        ...
        if _1090.BevelGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_agma_gleason_conical_gear_design(self) -> '_1103.AGMAGleasonConicalGearDesign':
        ...
        if _1103.AGMAGleasonConicalGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
