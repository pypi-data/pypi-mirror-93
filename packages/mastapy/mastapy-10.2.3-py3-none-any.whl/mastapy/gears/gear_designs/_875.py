...
from mastapy.utility.property import _1555
...
class DesignConstraintsCollection(_1550.NamedDatabaseItem):
    '''DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1555.DeletableCollectionMember[_873.DesignConstraint]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_1555.DeletableCollectionMember)[_873.DesignConstraint])
        return value
