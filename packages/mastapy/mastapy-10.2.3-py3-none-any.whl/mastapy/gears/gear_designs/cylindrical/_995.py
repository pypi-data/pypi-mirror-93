...
from mastapy.gears.gear_designs.cylindrical import _997, _998, _996
...
class Scuffing(_1340.IndependentReportablePropertiesBase['Scuffing']):
    '''Scuffing
    ...
    @property
    def scuffing_temperature_method_agma(self) -> '_997.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_997.ScuffingTemperatureMethodsAGMA)(value) if value else None

    @scuffing_temperature_method_agma.setter
    def scuffing_temperature_method_agma(self, value: '_997.ScuffingTemperatureMethodsAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ScuffingTemperatureMethodAGMA = value

    @property
    def scuffing_temperature_method_iso(self) -> '_998.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_998.ScuffingTemperatureMethodsISO)(value) if value else None

    @scuffing_temperature_method_iso.setter
    def scuffing_temperature_method_iso(self, value: '_998.ScuffingTemperatureMethodsISO'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
