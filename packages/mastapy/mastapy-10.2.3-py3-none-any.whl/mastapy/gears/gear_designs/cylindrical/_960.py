...
class CylindricalGearTableWithMGCharts(_1510.CustomTable):
    '''CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self) -> '_959.CylindricalGearTableMGItemDetail':
        ...
        return constructor.new(_959.CylindricalGearTableMGItemDetail)(value) if value else None

    @item_detail.setter
    def item_detail(self, value: '_959.CylindricalGearTableMGItemDetail'):
