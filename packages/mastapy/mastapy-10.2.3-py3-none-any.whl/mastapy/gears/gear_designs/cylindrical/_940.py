...
from mastapy.gears.gear_designs.cylindrical.thickness_stock_and_backlash import _1013
...
class CylindricalGearDefaults(_1345.PerMachineSettings):
    '''CylindricalGearDefaults
    ...
    @property
    def gear_fit_system(self) -> '_972.GearFitSystems':
        ...
        return constructor.new(_972.GearFitSystems)(value) if value else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_972.GearFitSystems'):
    ...
    @property
    def finish_stock_type(self) -> '_1013.FinishStockType':
        ...
        return constructor.new(_1013.FinishStockType)(value) if value else None

    @finish_stock_type.setter
    def finish_stock_type(self, value: '_1013.FinishStockType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FinishStockType = value

    @property
    def system_of_fits_defaults(self) -> '_1052.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_1052.DIN3967SystemOfGearFits)(self.wrapped.SystemOfFitsDefaults) if self.wrapped.SystemOfFitsDefaults else None

    @property
    def rough_cutter_creation_settings(self) -> '_686.RoughCutterCreationSettings':
        ...
        return constructor.new(_686.RoughCutterCreationSettings)(self.wrapped.RoughCutterCreationSettings) if self.wrapped.RoughCutterCreationSettings else None

    @property
    def rough_manufacturing_process_controls(self) -> '_660.ManufacturingProcessControls':
        ...
        return constructor.new(_660.ManufacturingProcessControls)(self.wrapped.RoughManufacturingProcessControls) if self.wrapped.RoughManufacturingProcessControls else None

    @property
    def finish_manufacturing_process_controls(self) -> '_660.ManufacturingProcessControls':
        ...
        return constructor.new(_660.ManufacturingProcessControls)(self.wrapped.FinishManufacturingProcessControls) if self.wrapped.FinishManufacturingProcessControls else None
