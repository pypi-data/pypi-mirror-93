...
class TiffAnalysisSettings(_1340.IndependentReportablePropertiesBase['TiffAnalysisSettings']):
    '''TiffAnalysisSettings
    ...
    @property
    def surface_material_properties(self) -> '_977.HardenedMaterialProperties':
        ...
        return constructor.new(_977.HardenedMaterialProperties)(self.wrapped.SurfaceMaterialProperties) if self.wrapped.SurfaceMaterialProperties else None

    @property
    def core_material_properties(self) -> '_977.HardenedMaterialProperties':
        ...
        return constructor.new(_977.HardenedMaterialProperties)(self.wrapped.CoreMaterialProperties) if self.wrapped.CoreMaterialProperties else None
