...
class CylindricalGearDesignConstraintSettings(_1345.PerMachineSettings):
    '''CylindricalGearDesignConstraintSettings
    ...
    @property
    def cylindrical_gear_design_constraints(self) -> '_943.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_943.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints else None
