...
class Usage(_1340.IndependentReportablePropertiesBase['Usage']):
    '''Usage
    ...
    @property
    def safety_requirement(self) -> '_305.SafetyRequirementsAGMA':
        ...
        return constructor.new(_305.SafetyRequirementsAGMA)(value) if value else None

    @safety_requirement.setter
    def safety_requirement(self, value: '_305.SafetyRequirementsAGMA'):
    ...
    @property
    def spur_gear_load_sharing_code(self) -> '_1000.SpurGearLoadSharingCodes':
        ...
        return constructor.new(_1000.SpurGearLoadSharingCodes)(value) if value else None

    @spur_gear_load_sharing_code.setter
    def spur_gear_load_sharing_code(self, value: '_1000.SpurGearLoadSharingCodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
