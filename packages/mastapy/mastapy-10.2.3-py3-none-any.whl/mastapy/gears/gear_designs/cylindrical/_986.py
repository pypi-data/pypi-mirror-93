...
class LtcaSettings(_1340.IndependentReportablePropertiesBase['LtcaSettings']):
    '''LtcaSettings
    ...
    @property
    def load_case_modifiable_settings(self) -> '_985.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_985.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
