...
class SelectedDesignConstraintsCollection(_1345.PerMachineSettings):
    '''SelectedDesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> '_875.DesignConstraintsCollection':
        ...
        return constructor.new(_875.DesignConstraintsCollection)(self.wrapped.DesignConstraints) if self.wrapped.DesignConstraints else None
