...
from mastapy.gears.manufacturing.cylindrical import _579, _583
...
class MicroGeometryInputsProfile(_579.MicroGeometryInputs['_583.ProfileModificationSegment']):
    '''MicroGeometryInputsProfile
    ...
    @property
    def profile_micro_geometry_range(self) -> '_1249.Range':
        ...
        if _1249.Range.TYPE not in self.wrapped.ProfileMicroGeometryRange.__class__.__mro__:
