...
class CylindricalGearRealCutterDesign(_670.CylindricalGearAbstractCutterDesign):
    ...
    @property
    def nominal_cutter_drawing(self) -> '_7154.SMTBitmap':
        ...
        return constructor.new(_7154.SMTBitmap)(self.wrapped.NominalCutterDrawing) if self.wrapped.NominalCutterDrawing else None
