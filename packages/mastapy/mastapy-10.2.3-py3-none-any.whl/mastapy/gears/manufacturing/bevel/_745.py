...
from mastapy.gears.manufacturing.bevel import _744, _758
...
class ManufacturingMachine(_1550.NamedDatabaseItem):
    '''ManufacturingMachine
    ...
    @property
    def machine_type(self) -> '_744.MachineTypes':
        '''MachineTypes: 'MachineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.MachineType)
        return constructor.new(_744.MachineTypes)(value) if value else None

    @machine_type.setter
    def machine_type(self, value: '_744.MachineTypes'):
    ...
    @property
    def wheel_formate_machine_type(self) -> '_758.WheelFormatMachineTypes':
        ...
        return constructor.new(_758.WheelFormatMachineTypes)(value) if value else None

    @wheel_formate_machine_type.setter
    def wheel_formate_machine_type(self, value: '_758.WheelFormatMachineTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
