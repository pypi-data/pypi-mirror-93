...
from mastapy.bearings import _1581
...
class LinearBearing(_1813.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1581.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1581.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1581.BearingStiffnessMatrixOption'):
