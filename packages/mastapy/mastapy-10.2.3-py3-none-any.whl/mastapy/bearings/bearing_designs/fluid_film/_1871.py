...
from mastapy.bearings.bearing_designs.fluid_film import _1863
...
class TiltingPadThrustBearing(_1863.PadFluidFilmBearing):
    '''TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1597.TiltingPadTypes':
        ...
        return constructor.new(_1597.TiltingPadTypes)(value) if value else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1597.TiltingPadTypes'):
