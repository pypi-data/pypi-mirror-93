...
class PlainGreaseFilledJournalBearing(_1867.PlainJournalBearing):
    '''PlainGreaseFilledJournalBearing
    ...
    @property
    def housing_type(self) -> '_1866.PlainGreaseFilledJournalBearingHousingType':
        ...
        return constructor.new(_1866.PlainGreaseFilledJournalBearingHousingType)(value) if value else None

    @housing_type.setter
    def housing_type(self, value: '_1866.PlainGreaseFilledJournalBearingHousingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HousingType = value

    @property
    def housing_detail(self) -> '_1868.PlainJournalHousing':
        ...
        if _1868.PlainJournalHousing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_cylindrical_housing_journal_bearing(self) -> '_1861.CylindricalHousingJournalBearing':
        ...
        if _1861.CylindricalHousingJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_machinery_encased_journal_bearing(self) -> '_1862.MachineryEncasedJournalBearing':
        ...
        if _1862.MachineryEncasedJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_pedestal_journal_bearing(self) -> '_1864.PedestalJournalBearing':
        ...
        if _1864.PedestalJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
