...
class PlainGreaseFilledJournalBearing(_1802.PlainJournalBearing):
    ...
    def housing_detail(self) -> '_1803.PlainJournalHousing':
        ...
        return constructor.new(_1803.PlainJournalHousing)(self.wrapped.HousingDetail) if self.wrapped.HousingDetail else None
    ...
    def housing_detail_of_type_cylindrical_housing_journal_bearing(self) -> '_1796.CylindricalHousingJournalBearing':
        ...
        return constructor.new(_1796.CylindricalHousingJournalBearing)(self.wrapped.HousingDetail) if self.wrapped.HousingDetail else None
    ...
    def housing_detail_of_type_machinery_encased_journal_bearing(self) -> '_1797.MachineryEncasedJournalBearing':
        ...
        return constructor.new(_1797.MachineryEncasedJournalBearing)(self.wrapped.HousingDetail) if self.wrapped.HousingDetail else None
    ...
    def housing_detail_of_type_pedestal_journal_bearing(self) -> '_1799.PedestalJournalBearing':
        ...
        return constructor.new(_1799.PedestalJournalBearing)(self.wrapped.HousingDetail) if self.wrapped.HousingDetail else None
