...
from mastapy.bearings.bearing_designs.rolling import _1824, _1842
...
class BallBearing(_1842.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1824.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1824.BallBearingShoulderDefinition))
        return value
