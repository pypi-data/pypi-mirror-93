...
from mastapy.bearings.bearing_designs.rolling import _1841, _1838
...
class TaperRollerBearing(_1838.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1577.BearingMeasurementType':
        ...
        return constructor.new(_1577.BearingMeasurementType)(value) if value else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1577.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_1841.RollerRibDetail':
        ...
        return constructor.new(_1841.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail else None
