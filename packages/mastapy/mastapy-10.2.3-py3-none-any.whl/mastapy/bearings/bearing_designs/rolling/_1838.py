...
from mastapy.bearings.bearing_designs.rolling import _1840, _1841, _1839
...
class NonBarrelRollerBearing(_1839.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1840.RollerEndShape':
        ...
        return constructor.new(_1840.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1840.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1841.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1841.RollerRibDetail))
        return value
