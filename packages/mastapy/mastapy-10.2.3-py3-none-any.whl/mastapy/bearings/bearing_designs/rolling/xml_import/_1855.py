...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1853, _1852
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1853.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1853.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1852.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1852.AbstractXmlVariableAssignment))
        return value
