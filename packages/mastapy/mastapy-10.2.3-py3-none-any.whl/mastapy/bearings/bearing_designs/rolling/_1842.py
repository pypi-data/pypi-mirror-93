...
class RollingBearing(_1814.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def catalogue(self) -> '_1570.BearingCatalog':
        ...
        return constructor.new(_1570.BearingCatalog)(value) if value else None
    ...
    @property
    def type_information(self) -> '_1829.BearingTypeExtraInformation':
        ...
        return constructor.new(_1829.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1573.BearingCageMaterial':
        ...
        return constructor.new(_1573.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1573.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1844.SleeveType':
        ...
        return constructor.new(_1844.SleeveType)(value) if value else None
    ...
    @property
    def protection(self) -> '_1826.BearingProtection':
        ...
        return constructor.new(_1826.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None

    @property
    def element_material(self) -> '_212.BearingMaterial':
        ...
        return constructor.new(_212.BearingMaterial)(self.wrapped.ElementMaterial) if self.wrapped.ElementMaterial else None

    @property
    def inner_ring_material(self) -> '_212.BearingMaterial':
        ...
        return constructor.new(_212.BearingMaterial)(self.wrapped.InnerRingMaterial) if self.wrapped.InnerRingMaterial else None

    @property
    def outer_ring_material(self) -> '_212.BearingMaterial':
        ...
        return constructor.new(_212.BearingMaterial)(self.wrapped.OuterRingMaterial) if self.wrapped.OuterRingMaterial else None
