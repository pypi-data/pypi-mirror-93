...
class ThrustBallBearing(_1823.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1588.OuterRingMounting':
        ...
        return constructor.new(_1588.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1588.OuterRingMounting'):
