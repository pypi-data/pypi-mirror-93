...
class LoadedDetailedBearingResults(_1651.LoadedNonLinearBearingResults):
    '''LoadedDetailedBearingResults
    ...
    @property
    def lubrication(self) -> '_232.LubricationDetail':
        ...
        return constructor.new(_232.LubricationDetail)(self.wrapped.Lubrication) if self.wrapped.Lubrication else None
