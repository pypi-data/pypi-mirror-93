...
from mastapy.bearings.bearing_results.fluid_film import _1806, _1802
...
class LoadedPlainJournalBearingResults(_1802.LoadedFluidFilmBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1806.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1806.LoadedPlainJournalBearingRow))
        return value
