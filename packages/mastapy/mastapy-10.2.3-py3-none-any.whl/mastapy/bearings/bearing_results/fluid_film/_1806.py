...
from mastapy.bearings import _1579
...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    def row(self) -> '_1579.BearingRow':
        ...
        return constructor.new(_1579.BearingRow)(value) if value else None
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_7154.SMTBitmap':
        ...
        return constructor.new(_7154.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
