...
from mastapy.bearings.bearing_results.rolling import _1731, _1718
...
class LoadedSphericalRollerThrustBearingRow(_1718.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1731.LoadedSphericalRollerThrustBearingResults':
        ...
        return constructor.new(_1731.LoadedSphericalRollerThrustBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
