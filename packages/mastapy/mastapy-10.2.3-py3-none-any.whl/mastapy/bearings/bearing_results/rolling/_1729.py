...
from mastapy.bearings.bearing_results.rolling import _1728, _1718
...
class LoadedSphericalRollerRadialBearingRow(_1718.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1728.LoadedSphericalRollerRadialBearingResults':
        ...
        return constructor.new(_1728.LoadedSphericalRollerRadialBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
