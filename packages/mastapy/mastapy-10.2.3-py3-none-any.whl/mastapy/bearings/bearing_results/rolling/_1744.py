...
from mastapy.bearings.bearing_results.rolling import _1743, _1691
...
class LoadedThrustBallBearingRow(_1691.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1743.LoadedThrustBallBearingResults':
        ...
        return constructor.new(_1743.LoadedThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
