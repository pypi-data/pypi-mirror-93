...
from mastapy.bearings.bearing_results.rolling import _1610, _1630
...
class LoadedAngularContactBallBearingRow(_1630.LoadedBallBearingRow):
    ...
    def loaded_bearing(self) -> '_1610.LoadedAngularContactBallBearingResults':
        ...
        return constructor.new(_1610.LoadedAngularContactBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
