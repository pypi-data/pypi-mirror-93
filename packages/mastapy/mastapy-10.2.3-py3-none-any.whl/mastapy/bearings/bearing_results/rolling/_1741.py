...
from mastapy.bearings.bearing_results.rolling import _1740, _1691
...
class LoadedThreePointContactBallBearingRow(_1691.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1740.LoadedThreePointContactBallBearingResults':
        ...
        return constructor.new(_1740.LoadedThreePointContactBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
