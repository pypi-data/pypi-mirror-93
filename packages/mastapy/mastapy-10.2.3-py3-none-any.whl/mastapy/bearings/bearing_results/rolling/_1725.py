...
from mastapy.bearings.bearing_results.rolling import _1724, _1691
...
class LoadedSelfAligningBallBearingRow(_1691.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1724.LoadedSelfAligningBallBearingResults':
        ...
        return constructor.new(_1724.LoadedSelfAligningBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
