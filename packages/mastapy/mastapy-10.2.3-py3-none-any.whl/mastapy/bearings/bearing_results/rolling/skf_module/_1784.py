...
from mastapy.bearings.bearing_results.rolling.skf_module import _1778, _1780
...
class Viscosities(_1780.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1778.OperatingViscosity':
        ...
        return constructor.new(_1778.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
