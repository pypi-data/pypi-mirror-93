...
from mastapy.bearings.bearing_results.rolling.skf_module import _1776, _1780
...
class BearingRatingLife(_1780.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1776.LifeModel':
        ...
        return constructor.new(_1776.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
