...
class GreaseLifeAndRelubricationInterval(_1780.SKFCalculationResult):
    '''GreaseLifeAndRelubricationInterval
    ...
    def grease(self) -> '_1772.Grease':
        ...
        return constructor.new(_1772.Grease)(self.wrapped.Grease) if self.wrapped.Grease else None

    @property
    def initial_fill(self) -> '_1775.InitialFill':
        ...
        return constructor.new(_1775.InitialFill)(self.wrapped.InitialFill) if self.wrapped.InitialFill else None

    @property
    def grease_quantity(self) -> '_1774.GreaseQuantity':
        ...
        return constructor.new(_1774.GreaseQuantity)(self.wrapped.GreaseQuantity) if self.wrapped.GreaseQuantity else None
