...
from mastapy.bearings.tolerances import _1613, _1605
...
class SupportDetail(_1605.InterferenceDetail):
    '''SupportDetail
    ...
    @property
    def radial_specification_method(self) -> '_1613.RadialSpecificationMethod':
        ...
        return constructor.new(_1613.RadialSpecificationMethod)(value) if value else None

    @radial_specification_method.setter
    def radial_specification_method(self, value: '_1613.RadialSpecificationMethod'):
