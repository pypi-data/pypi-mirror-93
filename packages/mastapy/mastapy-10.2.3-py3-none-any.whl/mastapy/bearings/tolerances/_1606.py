...
from mastapy.bearings.tolerances import _1601, _1598
...
class InterferenceTolerance(_1598.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1601.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1601.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1587.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1587.MountingPointSurfaceFinishes)(value) if value else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1587.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
