...
from mastapy.system_model.optimization import _1907, _1905
...
TStep = TypeVar('TStep', bound='_1905.OptimizationStep')


class OptimizationStrategy(_1907.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
