...
from mastapy import _3, _6553, _0
...
from mastapy.system_model.part_model.configurations import _2191, _2189, _2192
...
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2524
...
class Design(_0.APIBase):
    ...
    @property
    def shaft_detail_configurations(self) -> 'List[_2191.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2191.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def imported_fe_configurations(self) -> 'List[_2189.ActiveImportedFESelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEConfigurations, constructor.new(_2189.ActiveImportedFESelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2192.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2192.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_5285.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5285.DesignState))
        return value
    ...
    @property
    def duty_cycles(self) -> 'List[_5286.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_5286.DutyCycle))
        return value
    ...
    def design_state_named(self, name: 'str') -> '_5285.DesignState':
    ...
    def duty_cycle_named(self, name: 'str') -> '_5286.DutyCycle':
    ...
    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_6553.TaskProgress') -> '_1330.Status':
        ''' 'Save' is the original name of this method.
    ...
    def remove_synchroniser_shift(self, shift: '_2524.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2524.SynchroniserShift':
    ...
    def add_synchroniser_shift_empty(self) -> '_2524.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5285.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5286.DutyCycle':
