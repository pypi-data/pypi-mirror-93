...
from mastapy.system_model.part_model import _2126, _2124
...
class PowerLoad(_2124.VirtualComponent):
    '''PowerLoad
    ...
    @property
    def single_blade_details(self) -> '_2126.WindTurbineSingleBladeDetails':
        ...
        return constructor.new(_2126.WindTurbineSingleBladeDetails)(self.wrapped.SingleBladeDetails) if self.wrapped.SingleBladeDetails else None

    @property
    def electric_machine_detail(self) -> '_6466.ElectricMachineDetail':
        ...
        return constructor.new(_6466.ElectricMachineDetail)(self.wrapped.ElectricMachineDetail) if self.wrapped.ElectricMachineDetail else None

    @property
    def oil_pump_detail(self) -> '_261.OilPumpDetail':
        ...
        return constructor.new(_261.OilPumpDetail)(self.wrapped.OilPumpDetail) if self.wrapped.OilPumpDetail else None
