...
class FlexiblePinAssembly(_2038.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2085.CylindricalGear':
        ...
        return constructor.new(_2085.CylindricalGear)(self.wrapped.PlanetGear) if self.wrapped.PlanetGear else None
