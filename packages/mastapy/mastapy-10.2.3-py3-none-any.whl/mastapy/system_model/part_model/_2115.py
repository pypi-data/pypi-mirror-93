...
from mastapy.system_model.part_model import _2107, _2110
from mastapy.system_model.connections_and_sockets import _1939
...
class PlanetCarrier(_2110.MountableComponent):
    '''PlanetCarrier
    ...
    @property
    def planetary_sockets(self) -> 'List[_1939.PlanetarySocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySockets, constructor.new(_1939.PlanetarySocket))
        return value

    def attach_carrier_shaft(self, shaft: '_2127.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2127.Shaft', offset: Optional['float'] = float('nan')):
