...
from mastapy.system_model.part_model.part_groups import _2132, _2134, _2131
...
class ParallelPartGroup(_2131.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2132.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2132.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2134.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2134.DesignMeasurements))
        return value
