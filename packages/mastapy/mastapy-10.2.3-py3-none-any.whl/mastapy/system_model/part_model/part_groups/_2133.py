...
from mastapy.system_model.part_model.part_groups import _2131, _2132, _2135
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2131.ConcentricOrParallelPartGroup':
        ...
        if _2131.ConcentricOrParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2132.ConcentricPartGroup':
        ...
        if _2132.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2135.ParallelPartGroup':
        ...
        if _2135.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
