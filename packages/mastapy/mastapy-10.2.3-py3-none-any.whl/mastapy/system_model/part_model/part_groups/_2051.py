...
from mastapy.system_model.part_model.part_groups import _2048, _2050, _2047
...
class ParallelPartGroup(_2047.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2048.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2048.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2050.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2050.DesignMeasurements))
        return value
