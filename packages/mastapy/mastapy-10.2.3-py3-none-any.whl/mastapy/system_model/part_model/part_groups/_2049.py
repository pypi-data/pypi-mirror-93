...
from mastapy.system_model.part_model.part_groups import _2047, _2048, _2051
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2047.ConcentricOrParallelPartGroup':
        ...
        return constructor.new(_2047.ConcentricOrParallelPartGroup)(self.wrapped.ParallelGroup) if self.wrapped.ParallelGroup else None

    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2048.ConcentricPartGroup':
        ...
        if _2048.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
        ...
        return constructor.new(_2048.ConcentricPartGroup)(self.wrapped.ParallelGroup) if self.wrapped.ParallelGroup else None

    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2051.ParallelPartGroup':
        ...
        if _2051.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
        ...
        return constructor.new(_2051.ParallelPartGroup)(self.wrapped.ParallelGroup) if self.wrapped.ParallelGroup else None
