...
from mastapy.system_model.part_model.part_groups import _2049, _2047
...
class ConcentricPartGroup(_2047.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2049.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2049.ConcentricPartGroupParallelToThis))
        return value
