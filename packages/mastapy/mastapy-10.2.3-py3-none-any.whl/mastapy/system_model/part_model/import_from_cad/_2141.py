...
from mastapy.system_model.part_model.import_from_cad import _2147, _2148
...
class ConnectorFromCAD(_2148.MountableComponentFromCAD):
    '''ConnectorFromCAD
    ...
    @property
    def mounting(self) -> '_2147.HousedOrMounted':
        '''HousedOrMounted: 'Mounting' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Mounting)
        return constructor.new(_2147.HousedOrMounted)(value) if value else None

    @mounting.setter
    def mounting(self, value: '_2147.HousedOrMounted'):
