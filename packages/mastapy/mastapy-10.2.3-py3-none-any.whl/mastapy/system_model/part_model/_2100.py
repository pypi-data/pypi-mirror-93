...
class FlexiblePinAssembly(_2122.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2169.CylindricalGear':
        ...
        if _2169.CylindricalGear.TYPE not in self.wrapped.PlanetGear.__class__.__mro__:
