...
from mastapy.cycloidal import _1222, _1223
...
class RingPins(_2110.MountableComponent):
    '''RingPins
    ...
    @property
    def ring_pins_design(self) -> '_1222.RingPinsDesign':
        ...
        return constructor.new(_1222.RingPinsDesign)(self.wrapped.RingPinsDesign) if self.wrapped.RingPinsDesign else None

    @property
    def ring_pins_material(self) -> '_1223.RingPinsMaterial':
        ...
        return constructor.new(_1223.RingPinsMaterial)(self.wrapped.RingPinsMaterial) if self.wrapped.RingPinsMaterial else None
