...
from mastapy.system_model.part_model.couplings import _2136, _2139
...
class Clutch(_2139.Coupling):
    ...
    @property
    def clutch_type(self) -> '_2136.ClutchType':
        '''ClutchType: 'ClutchType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ClutchType)
        return constructor.new(_2136.ClutchType)(value) if value else None

    @clutch_type.setter
    def clutch_type(self, value: '_2136.ClutchType'):
    ...
    @property
    def spring_type(self) -> '_5011.ClutchSpringType':
        '''ClutchSpringType: 'SpringType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SpringType)
        return constructor.new(_5011.ClutchSpringType)(value) if value else None

    @spring_type.setter
    def spring_type(self, value: '_5011.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
