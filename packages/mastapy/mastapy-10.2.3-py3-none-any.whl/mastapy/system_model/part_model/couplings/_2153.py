...
class ShaftHubConnection(_2011.Connector):
    '''ShaftHubConnection
    ...
    @property
    def tilt_stiffness_type(self) -> '_2147.RigidConnectorTiltStiffnessTypes':
        ...
        return constructor.new(_2147.RigidConnectorTiltStiffnessTypes)(value) if value else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2147.RigidConnectorTiltStiffnessTypes'):
    ...
    @property
    def twod_spline_drawing(self) -> '_6529.SMTBitmap':
        ...
        return constructor.new(_6529.SMTBitmap)(self.wrapped.TwoDSplineDrawing) if self.wrapped.TwoDSplineDrawing else None
    ...
    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2148.RigidConnectorToothLocation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothLocationsExternalSplineHalf, constructor.new(_2148.RigidConnectorToothLocation))
        return value
