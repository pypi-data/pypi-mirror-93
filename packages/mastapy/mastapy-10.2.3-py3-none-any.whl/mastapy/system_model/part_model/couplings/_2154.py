...
from mastapy.system_model.part_model.couplings import _2155, _2168
...
class BeltDrive(_2060.SpecialisedAssembly):
    ...
    @property
    def pulleys(self) -> 'List[_2168.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2168.Pulley))
        return value
