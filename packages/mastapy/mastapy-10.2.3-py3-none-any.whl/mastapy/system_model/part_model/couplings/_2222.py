...
from mastapy.system_model.part_model.couplings import _2224, _2227
...
class Clutch(_2227.Coupling):
    ...
    @property
    def clutch_type(self) -> '_2224.ClutchType':
        '''ClutchType: 'ClutchType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ClutchType)
        return constructor.new(_2224.ClutchType)(value) if value else None

    @clutch_type.setter
    def clutch_type(self, value: '_2224.ClutchType'):
    ...
    @property
    def spring_type(self) -> '_5023.ClutchSpringType':
        '''ClutchSpringType: 'SpringType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SpringType)
        return constructor.new(_5023.ClutchSpringType)(value) if value else None

    @spring_type.setter
    def spring_type(self, value: '_5023.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clutch_connection(self) -> '_1992.ClutchConnection':
        ...
        return constructor.new(_1992.ClutchConnection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
