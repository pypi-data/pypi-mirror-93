...
from mastapy.system_model.part_model.couplings import (
    _2236, _2239, _2235, _2238,
    _2229, _2237
)
from mastapy.detailed_rigid_connectors.splines import (
    _1172, _1157, _1177, _1152,
    _1155, _1159, _1162, _1163,
    _1170, _1182
)
...
from mastapy.system_model.part_model import _2094
...
class ShaftHubConnection(_2094.Connector):
    '''ShaftHubConnection
    ...
    @property
    def tilt_stiffness_type(self) -> '_2236.RigidConnectorTiltStiffnessTypes':
        ...
        return constructor.new(_2236.RigidConnectorTiltStiffnessTypes)(value) if value else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2236.RigidConnectorTiltStiffnessTypes'):
    ...
    @property
    def spline_type(self) -> '_1172.SplineDesignTypes':
        '''SplineDesignTypes: 'SplineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SplineType)
        return constructor.new(_1172.SplineDesignTypes)(value) if value else None

    @spline_type.setter
    def spline_type(self, value: '_1172.SplineDesignTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def spline_joint_design(self) -> '_1177.SplineJointDesign':
        ...
        if _1177.SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_custom_spline_joint_design(self) -> '_1152.CustomSplineJointDesign':
        ...
        if _1152.CustomSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_din5480_spline_joint_design(self) -> '_1155.DIN5480SplineJointDesign':
        ...
        if _1155.DIN5480SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1159.GBT3478SplineJointDesign':
        ...
        if _1159.GBT3478SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_iso4156_spline_joint_design(self) -> '_1162.ISO4156SplineJointDesign':
        ...
        if _1162.ISO4156SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1163.JISB1603SplineJointDesign':
        ...
        if _1163.JISB1603SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_sae_spline_joint_design(self) -> '_1170.SAESplineJointDesign':
        ...
        if _1170.SAESplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_standard_spline_joint_design(self) -> '_1182.StandardSplineJointDesign':
        ...
        if _1182.StandardSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def interference_fit_design(self) -> '_1207.InterferenceFitDesign':
        ...
        if _1207.InterferenceFitDesign.TYPE not in self.wrapped.InterferenceFitDesign.__class__.__mro__:
    ...
    @property
    def flank_lead_crowning(self) -> '_2229.CrowningSpecification':
        ...
        return constructor.new(_2229.CrowningSpecification)(self.wrapped.FlankLeadCrowning) if self.wrapped.FlankLeadCrowning else None

    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2237.RigidConnectorToothLocation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothLocationsExternalSplineHalf, constructor.new(_2237.RigidConnectorToothLocation))
        return value
