...
from mastapy.system_model.part_model.couplings import _2251, _2253, _2227
...
class TorqueConverter(_2227.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2251.TorqueConverterPump':
        ...
        return constructor.new(_2251.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2253.TorqueConverterTurbine':
        ...
        return constructor.new(_2253.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
