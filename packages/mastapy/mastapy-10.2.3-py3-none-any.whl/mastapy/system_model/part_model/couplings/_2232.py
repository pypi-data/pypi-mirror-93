...
class PartToPartShearCoupling(_2227.Coupling):
    '''PartToPartShearCoupling
    ...
    @property
    def part_to_part_shear_coupling_connection(self) -> '_1998.PartToPartShearCouplingConnection':
        ...
        return constructor.new(_1998.PartToPartShearCouplingConnection)(self.wrapped.PartToPartShearCouplingConnection) if self.wrapped.PartToPartShearCouplingConnection else None
