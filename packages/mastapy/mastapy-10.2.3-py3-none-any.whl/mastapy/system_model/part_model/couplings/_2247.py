...
from mastapy.system_model.part_model.couplings import _2246, _2248
...
class SynchroniserHalf(_2248.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2246.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2246.SynchroniserCone))
        return value
