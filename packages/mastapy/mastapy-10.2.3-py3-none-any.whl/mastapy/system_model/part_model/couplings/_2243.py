...
class SpringDamper(_2227.Coupling):
    '''SpringDamper
    ...
    @property
    def connection(self) -> '_2000.SpringDamperConnection':
        ...
        return constructor.new(_2000.SpringDamperConnection)(self.wrapped.Connection) if self.wrapped.Connection else None
