...
class PartToPartShearCoupling(_2161.Coupling):
    ...
    @property
    def part_to_part_shear_coupling_connection(self) -> '_1940.PartToPartShearCouplingConnection':
        ...
        return constructor.new(_1940.PartToPartShearCouplingConnection)(self.wrapped.PartToPartShearCouplingConnection) if self.wrapped.PartToPartShearCouplingConnection else None
