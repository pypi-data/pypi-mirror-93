...
from mastapy.system_model.part_model.gears import _2083, _2092
...
class ConicalGearSet(_2092.GearSet):
    '''ConicalGearSet
    ...
    @property
    def conical_gears(self) -> 'List[_2083.ConicalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalGears, constructor.new(_2083.ConicalGear))
        return value
