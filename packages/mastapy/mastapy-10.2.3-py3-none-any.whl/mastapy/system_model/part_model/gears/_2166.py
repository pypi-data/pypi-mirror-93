...
from mastapy.system_model.part_model.gears import _2165, _2176
...
class ConceptGearSet(_2176.GearSet):
    '''ConceptGearSet
    ...
    @property
    def concept_gears(self) -> 'List[_2165.ConceptGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_2165.ConceptGear))
        return value

    @property
    def concept_meshes(self) -> 'List[_1957.ConceptGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_1957.ConceptGearMesh))
        return value
