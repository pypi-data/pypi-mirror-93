...
from mastapy.system_model.part_model.gears import _2079, _2080
...
class BevelDifferentialGearSet(_2080.BevelGearSet):
    '''BevelDifferentialGearSet
    ...
    @property
    def bevel_gears(self) -> 'List[_2079.BevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelGears, constructor.new(_2079.BevelGear))
        return value
