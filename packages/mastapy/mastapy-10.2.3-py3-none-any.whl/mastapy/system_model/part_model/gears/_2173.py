...
from mastapy.system_model.part_model.gears import _2172, _2176
...
class FaceGearSet(_2176.GearSet):
    '''FaceGearSet
    ...
    @property
    def face_gears(self) -> 'List[_2172.FaceGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_2172.FaceGear))
        return value

    @property
    def face_meshes(self) -> 'List[_1963.FaceGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_1963.FaceGearMesh))
        return value
