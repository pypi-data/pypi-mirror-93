...
from mastapy.system_model.part_model.gears import _2085, _2092
...
class CylindricalGearSet(_2092.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self) -> '_2123.SuperchargerRotorSet':
        ...
        return constructor.new(_2123.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_2085.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2085.CylindricalGear))
        return value
