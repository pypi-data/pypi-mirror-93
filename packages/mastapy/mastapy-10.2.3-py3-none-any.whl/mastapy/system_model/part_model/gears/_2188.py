...
from mastapy.system_model.part_model.gears import _2187, _2164
...
class SpiralBevelGearSet(_2164.BevelGearSet):
    '''SpiralBevelGearSet
    ...
    @property
    def spiral_bevel_gears(self) -> 'List[_2187.SpiralBevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGears, constructor.new(_2187.SpiralBevelGear))
        return value

    @property
    def spiral_bevel_meshes(self) -> 'List[_1975.SpiralBevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshes, constructor.new(_1975.SpiralBevelGearMesh))
        return value
