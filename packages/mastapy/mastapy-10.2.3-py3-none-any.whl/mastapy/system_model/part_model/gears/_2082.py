...
from mastapy.system_model.part_model.gears import _2081, _2092
...
class ConceptGearSet(_2092.GearSet):
    '''ConceptGearSet
    ...
    @property
    def concept_gears(self) -> 'List[_2081.ConceptGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_2081.ConceptGear))
        return value
