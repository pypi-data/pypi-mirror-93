...
from mastapy.system_model.part_model.gears import _2091, _2090
...
class ConicalGear(_2090.Gear):
    ...
    @property
    def orientation(self) -> '_2091.GearOrientations':
        ...
        return constructor.new(_2091.GearOrientations)(value) if value else None

    @orientation.setter
    def orientation(self, value: '_2091.GearOrientations'):
