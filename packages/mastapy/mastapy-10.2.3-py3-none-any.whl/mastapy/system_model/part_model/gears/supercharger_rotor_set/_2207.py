...
class SuperchargerRotorSet(_1550.NamedDatabaseItem):
    '''SuperchargerRotorSet
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2209.YVariableForImportedData':
        ...
        return constructor.new(_2209.YVariableForImportedData)(value) if value else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2209.YVariableForImportedData'):
    ...
    @property
    def file(self) -> '_2202.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2202.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File else None

    @property
    def rotor_speed(self) -> '_2204.RotorSpeedInputOptions':
        ...
        return constructor.new(_2204.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed else None

    @property
    def boost_pressure(self) -> '_2199.BoostPressureInputOptions':
        ...
        return constructor.new(_2199.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure else None

    @property
    def pressure_ratio(self) -> '_2201.PressureRatioInputOptions':
        ...
        return constructor.new(_2201.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio else None

    @property
    def input_power(self) -> '_2200.InputPowerInputOptions':
        ...
        return constructor.new(_2200.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower else None

    @property
    def measured_points(self) -> 'List[_2203.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2203.RotorSetMeasuredPoint))
        return value
