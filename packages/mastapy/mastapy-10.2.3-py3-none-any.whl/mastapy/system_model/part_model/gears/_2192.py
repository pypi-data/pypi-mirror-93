...
from mastapy.system_model.part_model.gears import _2191, _2164
...
class StraightBevelGearSet(_2164.BevelGearSet):
    '''StraightBevelGearSet
    ...
    @property
    def straight_bevel_gears(self) -> 'List[_2191.StraightBevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGears, constructor.new(_2191.StraightBevelGear))
        return value

    @property
    def straight_bevel_meshes(self) -> 'List[_1979.StraightBevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshes, constructor.new(_1979.StraightBevelGearMesh))
        return value
