...
from mastapy.system_model.part_model.gears import _2088, _2092
...
class FaceGearSet(_2092.GearSet):
    '''FaceGearSet
    ...
    @property
    def face_gears(self) -> 'List[_2088.FaceGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_2088.FaceGear))
        return value
