...
from mastapy.system_model.part_model.gears import _2167, _2176
...
class ConicalGearSet(_2176.GearSet):
    '''ConicalGearSet
    ...
    @property
    def conical_gears(self) -> 'List[_2167.ConicalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalGears, constructor.new(_2167.ConicalGear))
        return value
