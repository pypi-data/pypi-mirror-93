...
class WormGear(_2174.Gear):
    ...
    @property
    def active_gear_design(self) -> '_886.WormGearDesign':
    ...
    @property
    def worm_gear_design(self) -> '_886.WormGearDesign':
        ...
        if _886.WormGearDesign.TYPE not in self.wrapped.WormGearDesign.__class__.__mro__:
