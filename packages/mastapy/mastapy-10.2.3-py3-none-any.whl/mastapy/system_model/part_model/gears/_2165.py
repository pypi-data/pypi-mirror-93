...
from mastapy.system_model.part_model.gears import _2175, _2174
...
class ConceptGear(_2174.Gear):
    ...
    @property
    def orientation(self) -> '_2175.GearOrientations':
        ...
        return constructor.new(_2175.GearOrientations)(value) if value else None

    @orientation.setter
    def orientation(self, value: '_2175.GearOrientations'):
