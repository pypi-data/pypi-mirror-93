...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2207
from mastapy.system_model.part_model.gears import _2169, _2176
...
class CylindricalGearSet(_2176.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self) -> '_2207.SuperchargerRotorSet':
        ...
        return constructor.new(_2207.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_2169.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2169.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1961.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1961.CylindricalGearMesh))
        return value
