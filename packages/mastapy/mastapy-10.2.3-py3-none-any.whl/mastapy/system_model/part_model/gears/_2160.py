...
from mastapy.system_model.part_model.gears import _2163, _2164
...
class BevelDifferentialGearSet(_2164.BevelGearSet):
    '''BevelDifferentialGearSet
    ...
    @property
    def bevel_gears(self) -> 'List[_2163.BevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelGears, constructor.new(_2163.BevelGear))
        return value

    @property
    def bevel_meshes(self) -> 'List[_1955.BevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelMeshes, constructor.new(_1955.BevelGearMesh))
        return value
