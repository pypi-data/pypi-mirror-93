...
from mastapy.system_model.part_model.projections import _2130
from mastapy.system_model.part_model.part_groups import _2135
...
class RootAssembly(_2081.Assembly):
    '''RootAssembly
    ...
    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_2130.SpecifiedParallelPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroupsDrawingOrder, constructor.new(_2130.SpecifiedParallelPartGroupDrawingOrder))
        return value

    @property
    def parallel_part_groups(self) -> 'List[_2135.ParallelPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroups, constructor.new(_2135.ParallelPartGroup))
        return value
