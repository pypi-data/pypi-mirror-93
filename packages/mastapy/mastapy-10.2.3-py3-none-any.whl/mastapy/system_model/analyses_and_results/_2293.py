...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def safety_factors(self) -> '_242.SafetyFactorGroup':
        ...
        return constructor.new(_242.SafetyFactorGroup)(self.wrapped.SafetyFactors) if self.wrapped.SafetyFactors else None

    @property
    def component_design(self) -> '_1879.DesignEntity':
        ...
        if _1879.DesignEntity.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_connection(self) -> '_1924.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2114.Part':
