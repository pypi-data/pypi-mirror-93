...
class SteadyStateSynchronousResponseOnAShaft(_7144.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3240.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3240.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
