...
from mastapy.bearings.bearing_results import _1642
...
class BearingParametricStudyTool(_3959.ConnectorParametricStudyTool):
    '''BearingParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> 'List[_1642.LoadedBearingDutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDutyCycleResults, constructor.new(_1642.LoadedBearingDutyCycle))
        return value
