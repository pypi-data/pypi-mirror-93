...
class ParametricStudyDOEResultVariable(_1313.ParetoOptimisationVariableBase):
    '''ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1315.PropertyTargetForDominantCandidateSearch':
    ...
    @target.setter
    def target(self, value: '_1315.PropertyTargetForDominantCandidateSearch'):
