...
class ConnectionParametricStudyTool(_7132.ConnectionAnalysisCase):
    '''ConnectionParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_4015.ParametricStudyTool':
        ...
        return constructor.new(_4015.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None
