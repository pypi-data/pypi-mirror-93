...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4015, _3930
...
class RootAssemblyParametricStudyTool(_3930.AssemblyParametricStudyTool):
    '''RootAssemblyParametricStudyTool
    ...
    @property
    def parametric_study_tool_inputs(self) -> '_4015.ParametricStudyTool':
        ...
        return constructor.new(_4015.ParametricStudyTool)(self.wrapped.ParametricStudyToolInputs) if self.wrapped.ParametricStudyToolInputs else None

    @property
    def root_assembly_duty_cycle_results(self) -> 'List[_2534.DutyCycleEfficiencyResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RootAssemblyDutyCycleResults, constructor.new(_2534.DutyCycleEfficiencyResults))
        return value
