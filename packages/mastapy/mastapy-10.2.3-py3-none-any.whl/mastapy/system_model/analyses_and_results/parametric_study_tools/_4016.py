...
from mastapy.system_model.analyses_and_results.static_loads import _6413, _6520
from mastapy.system_model import _1883
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4017, _4018
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6520.ParametricStudyType':
        ...
        return constructor.new(_6520.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6520.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1883.ExternalFullFELoader':
        ...
        return constructor.new(_1883.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None

    @property
    def step_results(self) -> 'List[_4017.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_4017.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_4018.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_4018.ParametricStudyVariable))
        return value
