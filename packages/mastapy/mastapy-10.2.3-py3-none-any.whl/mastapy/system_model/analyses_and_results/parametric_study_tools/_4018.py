...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4010, _4007
...
class ParametricStudyVariable(_2290.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_4010.ParametricStudyDimension':
        ...
        return constructor.new(_4010.ParametricStudyDimension)(value) if value else None

    @dimension.setter
    def dimension(self, value: '_4010.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_4007.MonteCarloDistribution':
        ...
        return constructor.new(_4007.MonteCarloDistribution)(value) if value else None

    @distribution.setter
    def distribution(self, value: '_4007.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
