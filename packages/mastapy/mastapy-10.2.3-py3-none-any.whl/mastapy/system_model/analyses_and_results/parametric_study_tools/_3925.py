...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3924
...
class AbstractShaftParametricStudyTool(_3924.AbstractShaftOrHousingParametricStudyTool):
    '''AbstractShaftParametricStudyTool
