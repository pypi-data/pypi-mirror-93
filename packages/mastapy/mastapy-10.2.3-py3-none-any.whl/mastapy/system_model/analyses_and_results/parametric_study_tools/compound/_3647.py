...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3720
...
class AbstractAssemblyCompoundParametricStudyTool(_3720.PartCompoundParametricStudyTool):
    '''AbstractAssemblyCompoundParametricStudyTool
