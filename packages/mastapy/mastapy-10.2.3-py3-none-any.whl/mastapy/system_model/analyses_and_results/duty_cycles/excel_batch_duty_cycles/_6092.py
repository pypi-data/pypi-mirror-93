...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6096, _6093, _6095
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def masta_file_details(self) -> '_6096.MASTAFileDetails':
        ...
        return constructor.new(_6096.MASTAFileDetails)(self.wrapped.MASTAFileDetails) if self.wrapped.MASTAFileDetails else None

    @property
    def excel_file_details(self) -> '_6093.ExcelFileDetails':
        ...
        return constructor.new(_6093.ExcelFileDetails)(self.wrapped.ExcelFileDetails) if self.wrapped.ExcelFileDetails else None
    ...
    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6095.ExcelSheetDesignStateSelector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcelSheetDesignStateSelection, constructor.new(_6095.ExcelSheetDesignStateSelector))
        return value
