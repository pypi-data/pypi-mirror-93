...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5295, _5296, _5299
from mastapy.system_model.part_model.gears import _2114, _2112
from mastapy.system_model.analyses_and_results.static_loads import _6170, _6172, _6175
...
TGearSet = TypeVar('TGearSet', bound='_2114.GearSet')
TGear = TypeVar('TGear', bound='_2112.Gear')
TGearStaticLoad = TypeVar('TGearStaticLoad', bound='_6170.GearLoadCase')
TGearMesh = TypeVar('TGearMesh', bound='_1914.GearMesh')
TGearMeshStaticLoad = TypeVar('TGearMeshStaticLoad', bound='_6172.GearMeshLoadCase')
TGearSetStaticLoad = TypeVar('TGearSetStaticLoad', bound='_6175.GearSetLoadCase')


class GearSetStaticLoadCaseGroup(_5299.PartStaticLoadCaseGroup, Generic[TGearSet, TGear, TGearStaticLoad, TGearMesh, TGearMeshStaticLoad, TGearSetStaticLoad]):
    '''GearSetStaticLoadCaseGroup
    ...
    @property
    def gears_load_cases(self) -> 'List[_5295.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsLoadCases, constructor.new(_5295.ComponentStaticLoadCaseGroup)[TGear, TGearStaticLoad])
        return value

    @property
    def meshes_load_cases(self) -> 'List[_5296.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesLoadCases, constructor.new(_5296.ConnectionStaticLoadCaseGroup)[TGearMesh, TGearMeshStaticLoad])
        return value
