...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5268, _5269, _5272
from mastapy.system_model.part_model.gears import _2092, _2090
from mastapy.system_model.analyses_and_results.static_loads import _6142, _6144, _6147
...
TGearSet = TypeVar('TGearSet', bound='_2092.GearSet')
TGear = TypeVar('TGear', bound='_2090.Gear')
TGearStaticLoad = TypeVar('TGearStaticLoad', bound='_6142.GearLoadCase')
TGearMesh = TypeVar('TGearMesh', bound='_1893.GearMesh')
TGearMeshStaticLoad = TypeVar('TGearMeshStaticLoad', bound='_6144.GearMeshLoadCase')
TGearSetStaticLoad = TypeVar('TGearSetStaticLoad', bound='_6147.GearSetLoadCase')


class GearSetStaticLoadCaseGroup(_5272.PartStaticLoadCaseGroup, Generic[TGearSet, TGear, TGearStaticLoad, TGearMesh, TGearMeshStaticLoad, TGearSetStaticLoad]):
    '''GearSetStaticLoadCaseGroup
    ...
    @property
    def gears_load_cases(self) -> 'List[_5268.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsLoadCases, constructor.new(_5268.ComponentStaticLoadCaseGroup)[TGear, TGearStaticLoad])
        return value

    @property
    def meshes_load_cases(self) -> 'List[_5269.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesLoadCases, constructor.new(_5269.ConnectionStaticLoadCaseGroup)[TGearMesh, TGearMeshStaticLoad])
        return value
