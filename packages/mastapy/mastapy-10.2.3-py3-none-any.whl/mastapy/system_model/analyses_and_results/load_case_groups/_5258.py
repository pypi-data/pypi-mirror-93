...
from mastapy.system_model.analyses_and_results.load_case_groups import _5256, _5257, _5253
...
class DesignState(_5253.AbstractDesignStateLoadCaseGroup):
    '''DesignState
    ...
    @property
    def clutches(self) -> 'List[_5256.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Clutches, constructor.new(_5256.ClutchEngagementStatus))
        return value

    @property
    def concept_synchro_mounted_gears(self) -> 'List[_5257.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptSynchroMountedGears, constructor.new(_5257.ConceptSynchroGearEngagementStatus))
        return value

    def clutch_engagement_status_for(self, clutch_connection: '_1913.ClutchConnection') -> '_5256.ClutchEngagementStatus':
        ...
        return constructor.new(_5256.ClutchEngagementStatus)(method_result) if method_result else None

    def concept_synchro_gear_engagement_status_for(self, gear: '_2085.CylindricalGear') -> '_5257.ConceptSynchroGearEngagementStatus':
        ...
        return constructor.new(_5257.ConceptSynchroGearEngagementStatus)(method_result) if method_result else None
    ...
    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_6208.StaticLoadCase':
        ...
        return constructor.new(_6208.StaticLoadCase)(method_result) if method_result else None
