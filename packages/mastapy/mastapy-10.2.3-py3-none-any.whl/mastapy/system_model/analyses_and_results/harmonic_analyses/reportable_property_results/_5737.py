...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5733
...
class SingleWhineAnalysisResultsPropertyAccessor(_0.APIBase):
    ...
    @property
    def orders(self) -> 'List[_5733.ResultsForOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5733.ResultsForOrder))
        return value
