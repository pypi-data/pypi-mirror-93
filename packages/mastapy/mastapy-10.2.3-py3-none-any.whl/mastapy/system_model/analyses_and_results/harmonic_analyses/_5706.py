...
class WormGearMeshHarmonicAnalysis(_5631.GearMeshHarmonicAnalysis):
    '''WormGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2467.WormGearMeshSystemDeflection':
        ...
        return constructor.new(_2467.WormGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
