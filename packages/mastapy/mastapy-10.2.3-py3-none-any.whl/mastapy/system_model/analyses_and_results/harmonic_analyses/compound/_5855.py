...
class TorqueConverterCompoundHarmonicAnalysis(_5775.CouplingCompoundHarmonicAnalysis):
    '''TorqueConverterCompoundHarmonicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5699.TorqueConverterHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5699.TorqueConverterHarmonicAnalysis))
        return value

    @property
    def assembly_harmonic_analysis_load_cases(self) -> 'List[_5699.TorqueConverterHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyHarmonicAnalysisLoadCases, constructor.new(_5699.TorqueConverterHarmonicAnalysis))
        return value
