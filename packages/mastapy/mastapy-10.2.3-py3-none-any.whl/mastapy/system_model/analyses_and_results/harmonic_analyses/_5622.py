...
class ExternalCADModelHarmonicAnalysis(_5584.ComponentHarmonicAnalysis):
    '''ExternalCADModelHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2383.ExternalCADModelSystemDeflection':
        ...
        return constructor.new(_2383.ExternalCADModelSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
