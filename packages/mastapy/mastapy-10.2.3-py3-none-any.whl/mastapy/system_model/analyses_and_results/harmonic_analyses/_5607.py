...
from mastapy.system_model.analyses_and_results.system_deflections import _2372, _2373, _2374
...
class CylindricalGearMeshHarmonicAnalysis(_5631.GearMeshHarmonicAnalysis):
    '''CylindricalGearMeshHarmonicAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_6916.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_6916.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionResults) if self.wrapped.AdvancedSystemDeflectionResults else None
