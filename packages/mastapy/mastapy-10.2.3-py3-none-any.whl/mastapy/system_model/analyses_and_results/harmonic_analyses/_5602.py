...
class CycloidalAssemblyHarmonicAnalysis(_5678.SpecialisedAssemblyHarmonicAnalysis):
    '''CycloidalAssemblyHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2368.CycloidalAssemblySystemDeflection':
        ...
        return constructor.new(_2368.CycloidalAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
