...
class SynchroniserSleeveHarmonicAnalysis(_5696.SynchroniserPartHarmonicAnalysis):
    '''SynchroniserSleeveHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2454.SynchroniserSleeveSystemDeflection':
        ...
        return constructor.new(_2454.SynchroniserSleeveSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
