...
class ZerolBevelGearHarmonicAnalysis(_5574.BevelGearHarmonicAnalysis):
    '''ZerolBevelGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2472.ZerolBevelGearSystemDeflection':
        ...
        return constructor.new(_2472.ZerolBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
