...
class ClutchHarmonicAnalysis(_5598.CouplingHarmonicAnalysis):
    '''ClutchHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2346.ClutchSystemDeflection':
        ...
        return constructor.new(_2346.ClutchSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
