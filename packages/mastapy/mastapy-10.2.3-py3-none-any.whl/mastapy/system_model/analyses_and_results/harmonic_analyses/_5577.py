...
class BoltedJointHarmonicAnalysis(_5678.SpecialisedAssemblyHarmonicAnalysis):
    '''BoltedJointHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2342.BoltedJointSystemDeflection':
        ...
        return constructor.new(_2342.BoltedJointSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
