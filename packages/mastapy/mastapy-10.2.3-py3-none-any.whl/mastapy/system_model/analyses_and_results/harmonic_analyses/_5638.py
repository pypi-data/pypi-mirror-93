...
from mastapy.math_utility import _1267
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5639, _5679, _5628
...
class HarmonicAnalysisFEExportOptions(_0.APIBase):
    '''HarmonicAnalysisFEExportOptions
    ...
    @property
    def export_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_HarmonicAnalysisFEExportOptions_ExportOutputType':
        '''enum_with_selected_value.EnumWithSelectedValue_HarmonicAnalysisFEExportOptions_ExportOutputType: 'ExportType' is the original name of this property.'''

        value = enum_with_selected_value.EnumWithSelectedValue_HarmonicAnalysisFEExportOptions_ExportOutputType.wrapped_type()
        return enum_with_selected_value_runtime.create(self.wrapped.ExportType, value) if self.wrapped.ExportType else None

    @export_type.setter
    def export_type(self, value: 'enum_with_selected_value.EnumWithSelectedValue_HarmonicAnalysisFEExportOptions_ExportOutputType.implicit_type()'):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_HarmonicAnalysisFEExportOptions_ExportOutputType.implicit_type()
    ...
    @property
    def analysis_options(self) -> '_5639.HarmonicAnalysisOptions':
        ...
        if _5639.HarmonicAnalysisOptions.TYPE not in self.wrapped.AnalysisOptions.__class__.__mro__:
    ...
    @property
    def reference_speed_options(self) -> '_5679.SpeedOptionsForHarmonicAnalysisResults':
        ...
        return constructor.new(_5679.SpeedOptionsForHarmonicAnalysisResults)(self.wrapped.ReferenceSpeedOptions) if self.wrapped.ReferenceSpeedOptions else None

    @property
    def frequency_options(self) -> '_5628.FrequencyOptionsForHarmonicAnalysisResults':
        ...
        return constructor.new(_5628.FrequencyOptionsForHarmonicAnalysisResults)(self.wrapped.FrequencyOptions) if self.wrapped.FrequencyOptions else None

    @property
    def eigenvalue_options(self) -> '_150.EigenvalueOptions':
        ...
        return constructor.new(_150.EigenvalueOptions)(self.wrapped.EigenvalueOptions) if self.wrapped.EigenvalueOptions else None
