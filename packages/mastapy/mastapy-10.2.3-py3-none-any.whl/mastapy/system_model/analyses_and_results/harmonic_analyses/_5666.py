...
class PowerLoadHarmonicAnalysis(_5704.VirtualComponentHarmonicAnalysis):
    '''PowerLoadHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2423.PowerLoadSystemDeflection':
        ...
        return constructor.new(_2423.PowerLoadSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
