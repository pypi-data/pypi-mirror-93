...
class PartToPartShearCouplingConnectionHarmonicAnalysis(_5596.CouplingConnectionHarmonicAnalysis):
    '''PartToPartShearCouplingConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2417.PartToPartShearCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2417.PartToPartShearCouplingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
