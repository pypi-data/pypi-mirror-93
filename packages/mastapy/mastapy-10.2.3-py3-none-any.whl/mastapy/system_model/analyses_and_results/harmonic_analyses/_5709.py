...
class ZerolBevelGearMeshHarmonicAnalysis(_5575.BevelGearMeshHarmonicAnalysis):
    '''ZerolBevelGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2470.ZerolBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2470.ZerolBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
