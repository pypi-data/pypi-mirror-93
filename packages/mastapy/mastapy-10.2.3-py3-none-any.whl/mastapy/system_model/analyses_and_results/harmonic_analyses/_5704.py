...
class VirtualComponentHarmonicAnalysis(_5655.MountableComponentHarmonicAnalysis):
    '''VirtualComponentHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2466.VirtualComponentSystemDeflection':
