...
class CycloidalDiscCentralBearingConnectionHarmonicAnalysis(_5582.CoaxialConnectionHarmonicAnalysis):
    '''CycloidalDiscCentralBearingConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2369.CycloidalDiscCentralBearingConnectionSystemDeflection':
        ...
        return constructor.new(_2369.CycloidalDiscCentralBearingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
