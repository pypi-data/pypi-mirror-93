...
class OilSealHarmonicAnalysis(_5595.ConnectorHarmonicAnalysis):
    '''OilSealHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2415.OilSealSystemDeflection':
        ...
        return constructor.new(_2415.OilSealSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
