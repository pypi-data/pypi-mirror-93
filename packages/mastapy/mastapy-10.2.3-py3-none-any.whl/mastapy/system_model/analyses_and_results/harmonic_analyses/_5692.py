...
class StraightBevelPlanetGearHarmonicAnalysis(_5686.StraightBevelDiffGearHarmonicAnalysis):
    '''StraightBevelPlanetGearHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_2193.StraightBevelPlanetGear':
        ...
        return constructor.new(_2193.StraightBevelPlanetGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2450.StraightBevelPlanetGearSystemDeflection':
        ...
        return constructor.new(_2450.StraightBevelPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
