...
class TorqueConverterHarmonicAnalysis(_5598.CouplingHarmonicAnalysis):
    '''TorqueConverterHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2461.TorqueConverterSystemDeflection':
        ...
        return constructor.new(_2461.TorqueConverterSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
