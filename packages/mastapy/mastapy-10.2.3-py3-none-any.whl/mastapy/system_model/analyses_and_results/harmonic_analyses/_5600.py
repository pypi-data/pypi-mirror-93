...
class CVTHarmonicAnalysis(_5568.BeltDriveHarmonicAnalysis):
    '''CVTHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2367.CVTSystemDeflection':
        ...
        return constructor.new(_2367.CVTSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
