...
class DatumHarmonicAnalysis(_5584.ComponentHarmonicAnalysis):
    '''DatumHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2382.DatumSystemDeflection':
        ...
        return constructor.new(_2382.DatumSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
