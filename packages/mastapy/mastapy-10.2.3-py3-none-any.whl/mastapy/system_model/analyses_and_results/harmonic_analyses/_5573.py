...
class BevelDifferentialSunGearHarmonicAnalysis(_5569.BevelDifferentialGearHarmonicAnalysis):
    '''BevelDifferentialSunGearHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_2162.BevelDifferentialSunGear':
        ...
        return constructor.new(_2162.BevelDifferentialSunGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2338.BevelDifferentialSunGearSystemDeflection':
        ...
        return constructor.new(_2338.BevelDifferentialSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
