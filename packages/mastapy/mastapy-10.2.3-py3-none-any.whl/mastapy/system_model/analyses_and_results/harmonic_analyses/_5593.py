...
class ConicalGearSetHarmonicAnalysis(_5634.GearSetHarmonicAnalysis):
    '''ConicalGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2358.ConicalGearSetSystemDeflection':
