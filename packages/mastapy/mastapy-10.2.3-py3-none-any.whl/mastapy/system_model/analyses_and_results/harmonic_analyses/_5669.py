...
class RingPinsToDiscConnectionHarmonicAnalysis(_5643.InterMountableComponentConnectionHarmonicAnalysis):
    '''RingPinsToDiscConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2426.RingPinsToDiscConnectionSystemDeflection':
        ...
        return constructor.new(_2426.RingPinsToDiscConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
