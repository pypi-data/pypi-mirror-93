...
class StraightBevelDiffGearMeshHarmonicAnalysis(_5575.BevelGearMeshHarmonicAnalysis):
    '''StraightBevelDiffGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2444.StraightBevelDiffGearMeshSystemDeflection':
        ...
        return constructor.new(_2444.StraightBevelDiffGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
