...
class SynchroniserHalfHarmonicAnalysis(_5696.SynchroniserPartHarmonicAnalysis):
    '''SynchroniserHalfHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2452.SynchroniserHalfSystemDeflection':
        ...
        return constructor.new(_2452.SynchroniserHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
