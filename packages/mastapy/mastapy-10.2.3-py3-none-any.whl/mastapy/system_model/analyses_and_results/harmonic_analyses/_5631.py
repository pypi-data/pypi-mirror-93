...
class GearMeshHarmonicAnalysis(_5643.InterMountableComponentConnectionHarmonicAnalysis):
    '''GearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2390.GearMeshSystemDeflection':
