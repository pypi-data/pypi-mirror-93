...
class PlanetCarrierHarmonicAnalysis(_5655.MountableComponentHarmonicAnalysis):
    '''PlanetCarrierHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2421.PlanetCarrierSystemDeflection':
        ...
        return constructor.new(_2421.PlanetCarrierSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
