...
class ClutchHalfHarmonicAnalysis(_5597.CouplingHalfHarmonicAnalysis):
    '''ClutchHalfHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2345.ClutchHalfSystemDeflection':
        ...
        return constructor.new(_2345.ClutchHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
