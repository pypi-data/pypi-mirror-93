...
class BevelDifferentialPlanetGearHarmonicAnalysis(_5569.BevelDifferentialGearHarmonicAnalysis):
    '''BevelDifferentialPlanetGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2337.BevelDifferentialPlanetGearSystemDeflection':
        ...
        return constructor.new(_2337.BevelDifferentialPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
