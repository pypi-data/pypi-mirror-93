...
class KlingelnbergCycloPalloidConicalGearHarmonicAnalysis(_5591.ConicalGearHarmonicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2401.KlingelnbergCycloPalloidConicalGearSystemDeflection':
