...
class BevelDifferentialGearMeshHarmonicAnalysis(_5575.BevelGearMeshHarmonicAnalysis):
    '''BevelDifferentialGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2334.BevelDifferentialGearMeshSystemDeflection':
        ...
        return constructor.new(_2334.BevelDifferentialGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
