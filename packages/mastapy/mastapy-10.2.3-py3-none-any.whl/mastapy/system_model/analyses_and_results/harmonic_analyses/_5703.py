...
class UnbalancedMassHarmonicAnalysis(_5704.VirtualComponentHarmonicAnalysis):
    '''UnbalancedMassHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2465.UnbalancedMassSystemDeflection':
        ...
        return constructor.new(_2465.UnbalancedMassSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
