...
class SynchroniserHarmonicAnalysis(_5678.SpecialisedAssemblyHarmonicAnalysis):
    '''SynchroniserHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2455.SynchroniserSystemDeflection':
        ...
        return constructor.new(_2455.SynchroniserSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
