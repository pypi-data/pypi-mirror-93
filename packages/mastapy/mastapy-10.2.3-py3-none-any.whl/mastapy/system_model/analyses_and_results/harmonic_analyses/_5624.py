...
class FaceGearMeshHarmonicAnalysis(_5631.GearMeshHarmonicAnalysis):
    '''FaceGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2385.FaceGearMeshSystemDeflection':
        ...
        return constructor.new(_2385.FaceGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
