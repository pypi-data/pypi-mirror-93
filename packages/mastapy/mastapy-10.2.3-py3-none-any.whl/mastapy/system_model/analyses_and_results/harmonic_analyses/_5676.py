...
class ShaftToMountableComponentConnectionHarmonicAnalysis(_5561.AbstractShaftToMountableComponentConnectionHarmonicAnalysis):
    '''ShaftToMountableComponentConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2436.ShaftToMountableComponentConnectionSystemDeflection':
