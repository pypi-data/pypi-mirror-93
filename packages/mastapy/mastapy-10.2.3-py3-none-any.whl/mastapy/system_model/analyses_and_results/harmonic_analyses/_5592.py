...
class ConicalGearMeshHarmonicAnalysis(_5631.GearMeshHarmonicAnalysis):
    '''ConicalGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2357.ConicalGearMeshSystemDeflection':
