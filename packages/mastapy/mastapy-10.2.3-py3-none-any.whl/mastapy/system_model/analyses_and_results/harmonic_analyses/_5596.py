...
class CouplingConnectionHarmonicAnalysis(_5643.InterMountableComponentConnectionHarmonicAnalysis):
    '''CouplingConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2362.CouplingConnectionSystemDeflection':
