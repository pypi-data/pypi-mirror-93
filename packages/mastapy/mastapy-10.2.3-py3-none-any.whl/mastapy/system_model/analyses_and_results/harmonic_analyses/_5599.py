...
class CVTBeltConnectionHarmonicAnalysis(_5567.BeltConnectionHarmonicAnalysis):
    '''CVTBeltConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2365.CVTBeltConnectionSystemDeflection':
        ...
        return constructor.new(_2365.CVTBeltConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
