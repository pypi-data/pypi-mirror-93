...
class PointLoadHarmonicAnalysis(_5704.VirtualComponentHarmonicAnalysis):
    '''PointLoadHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2422.PointLoadSystemDeflection':
        ...
        return constructor.new(_2422.PointLoadSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
