...
class SpringDamperConnectionHarmonicAnalysis(_5596.CouplingConnectionHarmonicAnalysis):
    '''SpringDamperConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2441.SpringDamperConnectionSystemDeflection':
        ...
        return constructor.new(_2441.SpringDamperConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
