...
class FaceGearHarmonicAnalysis(_5629.GearHarmonicAnalysis):
    '''FaceGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2387.FaceGearSystemDeflection':
        ...
        return constructor.new(_2387.FaceGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
