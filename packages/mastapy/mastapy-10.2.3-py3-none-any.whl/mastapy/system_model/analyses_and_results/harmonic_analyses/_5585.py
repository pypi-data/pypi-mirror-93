...
class ConceptCouplingConnectionHarmonicAnalysis(_5596.CouplingConnectionHarmonicAnalysis):
    '''ConceptCouplingConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2350.ConceptCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2350.ConceptCouplingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
