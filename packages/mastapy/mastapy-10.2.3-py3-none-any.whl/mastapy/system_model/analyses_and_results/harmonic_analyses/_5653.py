...
class MassDiscHarmonicAnalysis(_5704.VirtualComponentHarmonicAnalysis):
    '''MassDiscHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2410.MassDiscSystemDeflection':
        ...
        return constructor.new(_2410.MassDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
