...
class ConceptGearHarmonicAnalysis(_5629.GearHarmonicAnalysis):
    '''ConceptGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2355.ConceptGearSystemDeflection':
        ...
        return constructor.new(_2355.ConceptGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
