...
from mastapy.system_model.analyses_and_results.system_deflections import _2446, _2450, _2451
...
class StraightBevelDiffGearHarmonicAnalysis(_5574.BevelGearHarmonicAnalysis):
    '''StraightBevelDiffGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2446.StraightBevelDiffGearSystemDeflection':
