...
class BevelGearSetHarmonicAnalysis(_5564.AGMAGleasonConicalGearSetHarmonicAnalysis):
    '''BevelGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2340.BevelGearSetSystemDeflection':
