...
class TorqueConverterTurbineHarmonicAnalysis(_5597.CouplingHalfHarmonicAnalysis):
    '''TorqueConverterTurbineHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2462.TorqueConverterTurbineSystemDeflection':
        ...
        return constructor.new(_2462.TorqueConverterTurbineSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
