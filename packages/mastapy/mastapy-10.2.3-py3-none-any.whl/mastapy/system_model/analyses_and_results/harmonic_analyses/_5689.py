...
class StraightBevelGearHarmonicAnalysis(_5574.BevelGearHarmonicAnalysis):
    '''StraightBevelGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2449.StraightBevelGearSystemDeflection':
        ...
        return constructor.new(_2449.StraightBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
