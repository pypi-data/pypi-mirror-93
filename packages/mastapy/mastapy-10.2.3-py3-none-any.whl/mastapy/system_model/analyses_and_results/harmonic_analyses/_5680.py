...
class SpiralBevelGearHarmonicAnalysis(_5574.BevelGearHarmonicAnalysis):
    '''SpiralBevelGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2440.SpiralBevelGearSystemDeflection':
        ...
        return constructor.new(_2440.SpiralBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
