...
class SpringDamperHalfHarmonicAnalysis(_5597.CouplingHalfHarmonicAnalysis):
    '''SpringDamperHalfHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2442.SpringDamperHalfSystemDeflection':
        ...
        return constructor.new(_2442.SpringDamperHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
