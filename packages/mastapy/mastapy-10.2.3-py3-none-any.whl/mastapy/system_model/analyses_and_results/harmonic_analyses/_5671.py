...
class RollingRingConnectionHarmonicAnalysis(_5643.InterMountableComponentConnectionHarmonicAnalysis):
    '''RollingRingConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2429.RollingRingConnectionSystemDeflection':
        ...
        return constructor.new(_2429.RollingRingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
