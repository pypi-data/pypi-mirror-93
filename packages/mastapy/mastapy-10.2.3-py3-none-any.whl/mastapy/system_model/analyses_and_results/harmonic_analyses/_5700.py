...
class TorqueConverterPumpHarmonicAnalysis(_5597.CouplingHalfHarmonicAnalysis):
    '''TorqueConverterPumpHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2460.TorqueConverterPumpSystemDeflection':
        ...
        return constructor.new(_2460.TorqueConverterPumpSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
