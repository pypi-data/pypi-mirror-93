...
class WormGearHarmonicAnalysis(_5629.GearHarmonicAnalysis):
    '''WormGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2469.WormGearSystemDeflection':
        ...
        return constructor.new(_2469.WormGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
