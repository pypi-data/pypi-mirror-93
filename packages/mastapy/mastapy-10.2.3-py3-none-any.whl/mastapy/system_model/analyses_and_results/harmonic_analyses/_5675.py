...
class ShaftHubConnectionHarmonicAnalysis(_5595.ConnectorHarmonicAnalysis):
    '''ShaftHubConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2432.ShaftHubConnectionSystemDeflection':
        ...
        return constructor.new(_2432.ShaftHubConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
