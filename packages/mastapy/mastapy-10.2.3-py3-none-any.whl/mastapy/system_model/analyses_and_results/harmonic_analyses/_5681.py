...
class SpiralBevelGearMeshHarmonicAnalysis(_5575.BevelGearMeshHarmonicAnalysis):
    '''SpiralBevelGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2438.SpiralBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2438.SpiralBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
