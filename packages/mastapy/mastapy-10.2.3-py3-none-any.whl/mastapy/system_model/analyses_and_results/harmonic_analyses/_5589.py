...
class ConceptGearMeshHarmonicAnalysis(_5631.GearMeshHarmonicAnalysis):
    '''ConceptGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2353.ConceptGearMeshSystemDeflection':
        ...
        return constructor.new(_2353.ConceptGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
