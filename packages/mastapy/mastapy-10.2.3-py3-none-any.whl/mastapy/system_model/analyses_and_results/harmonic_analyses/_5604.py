...
class CycloidalDiscHarmonicAnalysis(_5559.AbstractShaftHarmonicAnalysis):
    '''CycloidalDiscHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2371.CycloidalDiscSystemDeflection':
        ...
        return constructor.new(_2371.CycloidalDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
