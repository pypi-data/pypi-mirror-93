...
class StraightBevelSunGearHarmonicAnalysis(_5686.StraightBevelDiffGearHarmonicAnalysis):
    '''StraightBevelSunGearHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_2194.StraightBevelSunGear':
        ...
        return constructor.new(_2194.StraightBevelSunGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2451.StraightBevelSunGearSystemDeflection':
        ...
        return constructor.new(_2451.StraightBevelSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
