...
class ConceptGearMeshAdvancedSystemDeflection(_6928.GearMeshAdvancedSystemDeflection):
    '''ConceptGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6437.ConceptGearMeshLoadCase':
        ...
        return constructor.new(_6437.ConceptGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2353.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2353.ConceptGearMeshSystemDeflection))
        return value
