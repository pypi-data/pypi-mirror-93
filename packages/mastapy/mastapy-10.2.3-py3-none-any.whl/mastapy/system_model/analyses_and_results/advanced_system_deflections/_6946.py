...
class MeasurementComponentAdvancedSystemDeflection(_6993.VirtualComponentAdvancedSystemDeflection):
    '''MeasurementComponentAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6515.MeasurementComponentLoadCase':
        ...
        return constructor.new(_6515.MeasurementComponentLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2411.MeasurementComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2411.MeasurementComponentSystemDeflection))
        return value
