...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6915, _6916, _6929
...
class CylindricalGearSetAdvancedSystemDeflection(_6929.GearSetAdvancedSystemDeflection):
    '''CylindricalGearSetAdvancedSystemDeflection
    ...
    @property
    def gear_set_design(self) -> '_955.CylindricalGearSetDesign':
    ...
    @property
    def micro_geometry(self) -> '_1027.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1027.CylindricalGearSetMicroGeometry)(self.wrapped.MicroGeometry) if self.wrapped.MicroGeometry else None
    ...
    @property
    def cylindrical_gears_advanced_system_deflection(self) -> 'List[_6915.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsAdvancedSystemDeflection, constructor.new(_6915.CylindricalGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshes_advanced_system_deflection(self) -> 'List[_6916.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesAdvancedSystemDeflection, constructor.new(_6916.CylindricalGearMeshAdvancedSystemDeflection))
        return value
