...
class ConceptCouplingConnectionAdvancedSystemDeflection(_6906.CouplingConnectionAdvancedSystemDeflection):
    '''ConceptCouplingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6433.ConceptCouplingConnectionLoadCase':
        ...
        return constructor.new(_6433.ConceptCouplingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2350.ConceptCouplingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2350.ConceptCouplingConnectionSystemDeflection))
        return value
