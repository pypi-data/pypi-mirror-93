...
from mastapy.system_model.analyses_and_results.static_loads import _6554, _6560, _6561
...
class StraightBevelDiffGearAdvancedSystemDeflection(_6883.BevelGearAdvancedSystemDeflection):
    '''StraightBevelDiffGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6554.StraightBevelDiffGearLoadCase':
        ...
        if _6554.StraightBevelDiffGearLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2446.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2446.StraightBevelDiffGearSystemDeflection))
        return value
