...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6867
...
class CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection(_6867.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection):
    '''CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2370.CycloidalDiscPlanetaryBearingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2370.CycloidalDiscPlanetaryBearingConnectionSystemDeflection))
        return value
