...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6884
...
class SpiralBevelGearMeshAdvancedSystemDeflection(_6884.BevelGearMeshAdvancedSystemDeflection):
    '''SpiralBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2438.SpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2438.SpiralBevelGearMeshSystemDeflection))
        return value
