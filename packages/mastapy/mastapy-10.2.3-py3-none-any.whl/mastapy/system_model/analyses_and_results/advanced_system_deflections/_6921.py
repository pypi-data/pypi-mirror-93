...
class ExternalCADModelAdvancedSystemDeflection(_6892.ComponentAdvancedSystemDeflection):
    '''ExternalCADModelAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6477.ExternalCADModelLoadCase':
        ...
        return constructor.new(_6477.ExternalCADModelLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2383.ExternalCADModelSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2383.ExternalCADModelSystemDeflection))
        return value
