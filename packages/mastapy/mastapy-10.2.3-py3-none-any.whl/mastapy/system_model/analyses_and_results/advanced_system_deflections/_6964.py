...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6868, _6874
...
class RootAssemblyAdvancedSystemDeflection(_6874.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6868.AdvancedSystemDeflection':
        ...
        return constructor.new(_6868.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs else None
