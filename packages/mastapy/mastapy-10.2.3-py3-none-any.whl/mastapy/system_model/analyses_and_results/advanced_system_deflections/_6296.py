...
from mastapy.system_model.analyses_and_results.static_loads import _6109, _6112, _6113
...
class BevelDifferentialGearAdvancedSystemDeflection(_6301.BevelGearAdvancedSystemDeflection):
    '''BevelDifferentialGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6109.BevelDifferentialGearLoadCase':
        ...
        if _6109.BevelDifferentialGearLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2263.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2263.BevelDifferentialGearSystemDeflection))
        return value
