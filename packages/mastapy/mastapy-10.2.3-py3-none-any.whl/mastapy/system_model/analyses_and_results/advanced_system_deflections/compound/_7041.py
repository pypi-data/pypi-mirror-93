...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7010
...
class CVTCompoundAdvancedSystemDeflection(_7010.BeltDriveCompoundAdvancedSystemDeflection):
    '''CVTCompoundAdvancedSystemDeflection
