...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6871
...
class HypoidGearAdvancedSystemDeflection(_6871.AGMAGleasonConicalGearAdvancedSystemDeflection):
    '''HypoidGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2396.HypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2396.HypoidGearSystemDeflection))
        return value
