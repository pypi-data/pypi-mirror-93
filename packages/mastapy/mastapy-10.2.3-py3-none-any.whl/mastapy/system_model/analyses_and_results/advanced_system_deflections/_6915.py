...
from mastapy.system_model.part_model.gears import _2169, _2171
from mastapy.system_model.analyses_and_results.static_loads import _6456, _6461
from mastapy.gears.rating.cylindrical import _417
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6916, _6918, _6927
...
class CylindricalGearAdvancedSystemDeflection(_6927.GearAdvancedSystemDeflection):
    '''CylindricalGearAdvancedSystemDeflection
    ...
    @property
    def component_design(self) -> '_2169.CylindricalGear':
    ...
    @property
    def component_load_case(self) -> '_6456.CylindricalGearLoadCase':
        ...
        if _6456.CylindricalGearLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_advanced_system_deflection_meshes(self) -> 'List[_6916.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedSystemDeflectionMeshes, constructor.new(_6916.CylindricalGearMeshAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshed_gear_advanced_system_deflections(self) -> 'List[_6918.CylindricalMeshedGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGearAdvancedSystemDeflections, constructor.new(_6918.CylindricalMeshedGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_gear_advanced_system_deflections_in_meshes(self) -> 'List[_6918.CylindricalMeshedGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedSystemDeflectionsInMeshes, constructor.new(_6918.CylindricalMeshedGearAdvancedSystemDeflection))
        return value
