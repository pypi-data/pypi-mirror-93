...
class ClutchHalfAdvancedSystemDeflection(_6907.CouplingHalfAdvancedSystemDeflection):
    '''ClutchHalfAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6429.ClutchHalfLoadCase':
        ...
        return constructor.new(_6429.ClutchHalfLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2345.ClutchHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2345.ClutchHalfSystemDeflection))
        return value
