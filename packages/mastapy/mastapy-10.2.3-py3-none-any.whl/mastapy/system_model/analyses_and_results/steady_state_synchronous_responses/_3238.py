...
class SteadyStateSynchronousResponse(_7131.CompoundAnalysisCase):
    '''SteadyStateSynchronousResponse
    ...
    @property
    def steady_state_analysis_options(self) -> '_3240.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3240.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions else None
