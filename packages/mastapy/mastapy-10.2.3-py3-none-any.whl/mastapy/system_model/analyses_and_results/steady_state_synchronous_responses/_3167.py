...
class ConnectionSteadyStateSynchronousResponse(_7135.ConnectionStaticLoadAnalysisCase):
    '''ConnectionSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_3238.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3238.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponse) if self.wrapped.SteadyStateSynchronousResponse else None
