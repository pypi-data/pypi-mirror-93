...
from mastapy.system_model.analyses_and_results.stability_analyses import _3450, _3448, _3454
...
class FaceGearSetStabilityAnalysis(_3454.GearSetStabilityAnalysis):
    '''FaceGearSetStabilityAnalysis
    ...
    @property
    def face_gears_stability_analysis(self) -> 'List[_3450.FaceGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsStabilityAnalysis, constructor.new(_3450.FaceGearStabilityAnalysis))
        return value

    @property
    def face_meshes_stability_analysis(self) -> 'List[_3448.FaceGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesStabilityAnalysis, constructor.new(_3448.FaceGearMeshStabilityAnalysis))
        return value
