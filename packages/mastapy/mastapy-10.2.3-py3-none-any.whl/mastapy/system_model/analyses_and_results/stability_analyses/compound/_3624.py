...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3526
...
class SpecialisedAssemblyCompoundStabilityAnalysis(_3526.AbstractAssemblyCompoundStabilityAnalysis):
    '''SpecialisedAssemblyCompoundStabilityAnalysis
