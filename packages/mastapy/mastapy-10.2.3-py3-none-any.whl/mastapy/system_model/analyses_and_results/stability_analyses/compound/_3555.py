...
from mastapy.system_model.analyses_and_results.stability_analyses import _3425
...
class ConceptGearCompoundStabilityAnalysis(_3584.GearCompoundStabilityAnalysis):
    '''ConceptGearCompoundStabilityAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3425.ConceptGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3425.ConceptGearStabilityAnalysis))
        return value

    @property
    def component_stability_analysis_load_cases(self) -> 'List[_3425.ConceptGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentStabilityAnalysisLoadCases, constructor.new(_3425.ConceptGearStabilityAnalysis))
        return value
