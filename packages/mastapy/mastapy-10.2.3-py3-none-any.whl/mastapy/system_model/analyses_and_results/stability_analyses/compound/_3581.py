...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3579, _3580, _3586
...
class FaceGearSetCompoundStabilityAnalysis(_3586.GearSetCompoundStabilityAnalysis):
    '''FaceGearSetCompoundStabilityAnalysis
    ...
    @property
    def face_gears_compound_stability_analysis(self) -> 'List[_3579.FaceGearCompoundStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsCompoundStabilityAnalysis, constructor.new(_3579.FaceGearCompoundStabilityAnalysis))
        return value

    @property
    def face_meshes_compound_stability_analysis(self) -> 'List[_3580.FaceGearMeshCompoundStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesCompoundStabilityAnalysis, constructor.new(_3580.FaceGearMeshCompoundStabilityAnalysis))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_3449.FaceGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3449.FaceGearSetStabilityAnalysis))
        return value

    @property
    def assembly_stability_analysis_load_cases(self) -> 'List[_3449.FaceGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyStabilityAnalysisLoadCases, constructor.new(_3449.FaceGearSetStabilityAnalysis))
        return value
