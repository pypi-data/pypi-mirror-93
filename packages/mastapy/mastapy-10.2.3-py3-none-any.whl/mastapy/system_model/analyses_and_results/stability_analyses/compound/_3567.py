...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3536
...
class CVTCompoundStabilityAnalysis(_3536.BeltDriveCompoundStabilityAnalysis):
    '''CVTCompoundStabilityAnalysis
