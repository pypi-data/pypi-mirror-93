...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3535
...
class CVTBeltConnectionCompoundStabilityAnalysis(_3535.BeltConnectionCompoundStabilityAnalysis):
    '''CVTBeltConnectionCompoundStabilityAnalysis
