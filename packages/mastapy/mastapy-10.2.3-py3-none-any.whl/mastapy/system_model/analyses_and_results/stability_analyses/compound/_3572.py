...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3529
...
class CycloidalDiscPlanetaryBearingConnectionCompoundStabilityAnalysis(_3529.AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    '''CycloidalDiscPlanetaryBearingConnectionCompoundStabilityAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3440.CycloidalDiscPlanetaryBearingConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3440.CycloidalDiscPlanetaryBearingConnectionStabilityAnalysis))
        return value

    @property
    def connection_stability_analysis_load_cases(self) -> 'List[_3440.CycloidalDiscPlanetaryBearingConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionStabilityAnalysisLoadCases, constructor.new(_3440.CycloidalDiscPlanetaryBearingConnectionStabilityAnalysis))
        return value
