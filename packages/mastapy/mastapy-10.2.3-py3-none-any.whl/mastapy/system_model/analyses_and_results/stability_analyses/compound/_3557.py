...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3555, _3556, _3586
...
class ConceptGearSetCompoundStabilityAnalysis(_3586.GearSetCompoundStabilityAnalysis):
    '''ConceptGearSetCompoundStabilityAnalysis
    ...
    @property
    def concept_gears_compound_stability_analysis(self) -> 'List[_3555.ConceptGearCompoundStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCompoundStabilityAnalysis, constructor.new(_3555.ConceptGearCompoundStabilityAnalysis))
        return value

    @property
    def concept_meshes_compound_stability_analysis(self) -> 'List[_3556.ConceptGearMeshCompoundStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCompoundStabilityAnalysis, constructor.new(_3556.ConceptGearMeshCompoundStabilityAnalysis))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_3424.ConceptGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3424.ConceptGearSetStabilityAnalysis))
        return value

    @property
    def assembly_stability_analysis_load_cases(self) -> 'List[_3424.ConceptGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyStabilityAnalysisLoadCases, constructor.new(_3424.ConceptGearSetStabilityAnalysis))
        return value
