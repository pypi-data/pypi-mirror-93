...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3575
...
class PlanetaryGearSetCompoundStabilityAnalysis(_3575.CylindricalGearSetCompoundStabilityAnalysis):
    '''PlanetaryGearSetCompoundStabilityAnalysis
