...
from mastapy.system_model.analyses_and_results.stability_analyses import _3434, _3396
...
class ShaftStabilityAnalysis(_3396.AbstractShaftStabilityAnalysis):
    '''ShaftStabilityAnalysis
    ...
    @property
    def critical_speeds(self) -> 'List[_3434.CriticalSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CriticalSpeeds, constructor.new(_3434.CriticalSpeed))
        return value
