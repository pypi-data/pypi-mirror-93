...
from mastapy.system_model.analyses_and_results.stability_analyses import _3522, _3520, _3454
...
class WormGearSetStabilityAnalysis(_3454.GearSetStabilityAnalysis):
    '''WormGearSetStabilityAnalysis
    ...
    @property
    def worm_gears_stability_analysis(self) -> 'List[_3522.WormGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsStabilityAnalysis, constructor.new(_3522.WormGearStabilityAnalysis))
        return value

    @property
    def worm_meshes_stability_analysis(self) -> 'List[_3520.WormGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesStabilityAnalysis, constructor.new(_3520.WormGearMeshStabilityAnalysis))
        return value
