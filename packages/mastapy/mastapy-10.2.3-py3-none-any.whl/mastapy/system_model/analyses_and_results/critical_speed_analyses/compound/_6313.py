...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6282
...
class CVTCompoundCriticalSpeedAnalysis(_6282.BeltDriveCompoundCriticalSpeedAnalysis):
    '''CVTCompoundCriticalSpeedAnalysis
