...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6158
...
class SpiralBevelGearMeshCriticalSpeedAnalysis(_6158.BevelGearMeshCriticalSpeedAnalysis):
    '''SpiralBevelGearMeshCriticalSpeedAnalysis
