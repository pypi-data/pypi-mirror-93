...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _2268
...
class ConnectionCriticalSpeedAnalysis(_7135.ConnectionStaticLoadAnalysisCase):
    '''ConnectionCriticalSpeedAnalysis
