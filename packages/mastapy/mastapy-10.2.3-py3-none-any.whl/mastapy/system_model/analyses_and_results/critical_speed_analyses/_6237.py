...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _2268, _6148
...
class RootAssemblyCriticalSpeedAnalysis(_6148.AssemblyCriticalSpeedAnalysis):
    '''RootAssemblyCriticalSpeedAnalysis
    ...
    @property
    def critical_speed_analysis_inputs(self) -> '_2268.CriticalSpeedAnalysis':
        ...
        return constructor.new(_2268.CriticalSpeedAnalysis)(self.wrapped.CriticalSpeedAnalysisInputs) if self.wrapped.CriticalSpeedAnalysisInputs else None
