...
from mastapy.system_model.drawing import _1912, _1910
...
class SystemDeflectionDrawStyle(_1910.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1912.ScalingDrawStyle':
        ...
        return constructor.new(_1912.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
