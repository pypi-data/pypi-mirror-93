...
class StraightBevelGearSystemDeflection(_2341.BevelGearSystemDeflection):
    '''StraightBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3773.StraightBevelGearPowerFlow':
        ...
        return constructor.new(_3773.StraightBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
