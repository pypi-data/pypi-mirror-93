...
class BearingSystemDeflection(_2288.ConnectorSystemDeflection):
    '''BearingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3269.BearingPowerFlow':
        ...
        return constructor.new(_3269.BearingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
