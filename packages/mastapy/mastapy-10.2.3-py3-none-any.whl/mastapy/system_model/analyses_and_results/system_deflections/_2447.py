...
class StraightBevelGearMeshSystemDeflection(_2339.BevelGearMeshSystemDeflection):
    '''StraightBevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3772.StraightBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3772.StraightBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
