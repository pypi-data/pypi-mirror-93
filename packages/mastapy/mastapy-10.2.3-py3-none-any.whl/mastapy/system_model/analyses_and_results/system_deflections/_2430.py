...
class RollingRingSystemDeflection(_2363.CouplingHalfSystemDeflection):
    '''RollingRingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3757.RollingRingPowerFlow':
        ...
        return constructor.new(_3757.RollingRingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
