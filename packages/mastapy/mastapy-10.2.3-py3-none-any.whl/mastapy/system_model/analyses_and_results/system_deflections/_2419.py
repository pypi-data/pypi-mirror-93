...
from mastapy.system_model.analyses_and_results.system_deflections import _2417, _2364
...
class PartToPartShearCouplingSystemDeflection(_2364.CouplingSystemDeflection):
    '''PartToPartShearCouplingSystemDeflection
    ...
    @property
    def part_to_part_shear_coupling_connection(self) -> '_2417.PartToPartShearCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2417.PartToPartShearCouplingConnectionSystemDeflection)(self.wrapped.PartToPartShearCouplingConnection) if self.wrapped.PartToPartShearCouplingConnection else None
    ...
    @property
    def power_flow_results(self) -> '_3744.PartToPartShearCouplingPowerFlow':
        ...
        return constructor.new(_3744.PartToPartShearCouplingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
