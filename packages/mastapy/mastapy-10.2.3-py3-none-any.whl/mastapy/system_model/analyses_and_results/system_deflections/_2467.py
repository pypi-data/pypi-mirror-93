...
class WormGearMeshSystemDeflection(_2390.GearMeshSystemDeflection):
    '''WormGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3788.WormGearMeshPowerFlow':
        ...
        return constructor.new(_3788.WormGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
