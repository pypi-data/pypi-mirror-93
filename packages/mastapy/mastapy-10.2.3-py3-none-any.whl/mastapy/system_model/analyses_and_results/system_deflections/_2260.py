...
from mastapy.system_model.analyses_and_results.power_flows import _3271, _3302
from mastapy.system_model.analyses_and_results.system_deflections import _2259, _2356
...
class BeltDriveSystemDeflection(_2356.SpecialisedAssemblySystemDeflection):
    '''BeltDriveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3271.BeltDrivePowerFlow':
    ...
    @property
    def belts(self) -> 'List[_2259.BeltConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Belts, constructor.new(_2259.BeltConnectionSystemDeflection))
        return value
