...
from mastapy.system_model.analyses_and_results.system_deflections import _2408, _2458
...
class SystemDeflection(_7138.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def overall_efficiency_results(self) -> '_2408.LoadCaseOverallEfficiencyResult':
        ...
        return constructor.new(_2408.LoadCaseOverallEfficiencyResult)(self.wrapped.OverallEfficiencyResults) if self.wrapped.OverallEfficiencyResults else None

    @property
    def analysis_options(self) -> '_2458.SystemDeflectionOptions':
        ...
        return constructor.new(_2458.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
