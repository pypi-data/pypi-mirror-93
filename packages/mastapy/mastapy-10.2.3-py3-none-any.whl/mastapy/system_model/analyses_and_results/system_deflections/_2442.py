...
class SpringDamperHalfSystemDeflection(_2363.CouplingHalfSystemDeflection):
    '''SpringDamperHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3767.SpringDamperHalfPowerFlow':
        ...
        return constructor.new(_3767.SpringDamperHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
