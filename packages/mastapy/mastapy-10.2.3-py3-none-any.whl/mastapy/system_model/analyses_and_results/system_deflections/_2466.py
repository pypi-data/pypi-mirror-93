...
class VirtualComponentSystemDeflection(_2413.MountableComponentSystemDeflection):
    '''VirtualComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3787.VirtualComponentPowerFlow':
