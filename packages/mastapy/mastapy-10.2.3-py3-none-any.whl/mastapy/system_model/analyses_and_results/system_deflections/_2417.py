...
class PartToPartShearCouplingConnectionSystemDeflection(_2362.CouplingConnectionSystemDeflection):
    '''PartToPartShearCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3742.PartToPartShearCouplingConnectionPowerFlow':
        ...
        return constructor.new(_3742.PartToPartShearCouplingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
