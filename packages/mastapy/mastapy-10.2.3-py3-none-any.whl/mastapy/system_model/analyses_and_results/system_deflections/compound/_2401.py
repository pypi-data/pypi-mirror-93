...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2475
...
class AbstractAssemblyCompoundSystemDeflection(_2475.PartCompoundSystemDeflection):
    '''AbstractAssemblyCompoundSystemDeflection
