...
class BevelDifferentialGearMeshSystemDeflection(_2266.BevelGearMeshSystemDeflection):
    '''BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3272.BevelDifferentialGearMeshPowerFlow':
        ...
        return constructor.new(_3272.BevelDifferentialGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
