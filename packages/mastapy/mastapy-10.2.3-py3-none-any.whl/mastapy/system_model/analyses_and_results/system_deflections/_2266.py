...
class BevelGearMeshSystemDeflection(_2254.AGMAGleasonConicalGearMeshSystemDeflection):
    '''BevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3277.BevelGearMeshPowerFlow':
