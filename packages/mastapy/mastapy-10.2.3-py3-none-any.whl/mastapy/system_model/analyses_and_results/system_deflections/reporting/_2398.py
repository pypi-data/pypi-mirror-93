...
from mastapy.system_model.analyses_and_results import _2226
...
class RigidlyConnectedComponentGroupSystemDeflection(_2226.DesignEntityGroupAnalysis):
    '''RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def components(self) -> 'List[_2275.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Components, constructor.new(_2275.ComponentSystemDeflection))
        return value
