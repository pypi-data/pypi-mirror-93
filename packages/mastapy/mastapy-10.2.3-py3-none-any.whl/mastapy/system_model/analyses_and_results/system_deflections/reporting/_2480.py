...
from mastapy.utility.enums import _1544
...
class ShaftSystemDeflectionSectionsReport(_1486.CustomReportChart):
    '''ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self) -> '_1544.TableAndChartOptions':
        '''TableAndChartOptions: 'Display' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Display)
        return constructor.new(_1544.TableAndChartOptions)(value) if value else None

    @display.setter
    def display(self, value: '_1544.TableAndChartOptions'):
