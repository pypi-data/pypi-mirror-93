...
class ZerolBevelGearMeshSystemDeflection(_2339.BevelGearMeshSystemDeflection):
    '''ZerolBevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3791.ZerolBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3791.ZerolBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
