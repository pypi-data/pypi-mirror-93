...
from mastapy.system_model.analyses_and_results.power_flows import (
    _3265, _3272, _3277, _3319,
    _3357, _3363, _3366, _3385
)
...
class AGMAGleasonConicalGearMeshSystemDeflection(_2284.ConicalGearMeshSystemDeflection):
    '''AGMAGleasonConicalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3265.AGMAGleasonConicalGearMeshPowerFlow':
        ...
        if _3265.AGMAGleasonConicalGearMeshPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_bevel_differential_gear_mesh_power_flow(self) -> '_3272.BevelDifferentialGearMeshPowerFlow':
        ...
        if _3272.BevelDifferentialGearMeshPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_bevel_gear_mesh_power_flow(self) -> '_3277.BevelGearMeshPowerFlow':
        ...
        if _3277.BevelGearMeshPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_hypoid_gear_mesh_power_flow(self) -> '_3319.HypoidGearMeshPowerFlow':
        ...
        if _3319.HypoidGearMeshPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_spiral_bevel_gear_mesh_power_flow(self) -> '_3357.SpiralBevelGearMeshPowerFlow':
        ...
        if _3357.SpiralBevelGearMeshPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_straight_bevel_diff_gear_mesh_power_flow(self) -> '_3363.StraightBevelDiffGearMeshPowerFlow':
        ...
        if _3363.StraightBevelDiffGearMeshPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_straight_bevel_gear_mesh_power_flow(self) -> '_3366.StraightBevelGearMeshPowerFlow':
        ...
        if _3366.StraightBevelGearMeshPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_zerol_bevel_gear_mesh_power_flow(self) -> '_3385.ZerolBevelGearMeshPowerFlow':
        ...
        if _3385.ZerolBevelGearMeshPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
