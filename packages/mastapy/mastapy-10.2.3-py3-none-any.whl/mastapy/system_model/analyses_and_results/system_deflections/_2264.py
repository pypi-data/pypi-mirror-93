...
class BevelDifferentialPlanetGearSystemDeflection(_2263.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3275.BevelDifferentialPlanetGearPowerFlow':
        ...
        return constructor.new(_3275.BevelDifferentialPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
