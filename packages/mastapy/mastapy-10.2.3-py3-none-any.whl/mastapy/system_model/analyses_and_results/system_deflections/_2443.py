...
class SpringDamperSystemDeflection(_2364.CouplingSystemDeflection):
    '''SpringDamperSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3768.SpringDamperPowerFlow':
        ...
        return constructor.new(_3768.SpringDamperPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
