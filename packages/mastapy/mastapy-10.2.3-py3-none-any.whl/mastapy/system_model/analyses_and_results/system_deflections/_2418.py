...
class PartToPartShearCouplingHalfSystemDeflection(_2363.CouplingHalfSystemDeflection):
    '''PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3743.PartToPartShearCouplingHalfPowerFlow':
        ...
        return constructor.new(_3743.PartToPartShearCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
