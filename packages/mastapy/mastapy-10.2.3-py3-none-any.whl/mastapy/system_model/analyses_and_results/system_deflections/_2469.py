...
class WormGearSystemDeflection(_2392.GearSystemDeflection):
    '''WormGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3789.WormGearPowerFlow':
        ...
        return constructor.new(_3789.WormGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
