...
class SpiralBevelGearMeshSystemDeflection(_2339.BevelGearMeshSystemDeflection):
    '''SpiralBevelGearMeshSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6548.SpiralBevelGearMeshLoadCase':
        ...
        return constructor.new(_6548.SpiralBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def power_flow_results(self) -> '_3763.SpiralBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3763.SpiralBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def rating(self) -> '_362.SpiralBevelGearMeshRating':
        ...
        return constructor.new(_362.SpiralBevelGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def component_detailed_analysis(self) -> '_362.SpiralBevelGearMeshRating':
        ...
        return constructor.new(_362.SpiralBevelGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
