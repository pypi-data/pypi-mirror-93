...
class BevelDifferentialSunGearSystemDeflection(_2240.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3251.BevelDifferentialSunGearPowerFlow':
