...
from mastapy.system_model.analyses_and_results.power_flows import _3770, _3775, _3776
...
class StraightBevelDiffGearSystemDeflection(_2341.BevelGearSystemDeflection):
    '''StraightBevelDiffGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3770.StraightBevelDiffGearPowerFlow':
