...
from mastapy.system_model.analyses_and_results.power_flows import _3264, _3322, _3354
...
class AbstractShaftOrHousingSystemDeflection(_2275.ComponentSystemDeflection):
    '''AbstractShaftOrHousingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3264.AbstractShaftOrHousingPowerFlow':
        ...
        if _3264.AbstractShaftOrHousingPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_imported_fe_component_power_flow(self) -> '_3322.ImportedFEComponentPowerFlow':
        ...
        if _3322.ImportedFEComponentPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_shaft_power_flow(self) -> '_3354.ShaftPowerFlow':
        ...
        if _3354.ShaftPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
