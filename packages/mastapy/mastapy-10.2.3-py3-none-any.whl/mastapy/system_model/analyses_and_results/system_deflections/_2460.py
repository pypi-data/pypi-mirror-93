...
class TorqueConverterPumpSystemDeflection(_2363.CouplingHalfSystemDeflection):
    '''TorqueConverterPumpSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3784.TorqueConverterPumpPowerFlow':
        ...
        return constructor.new(_3784.TorqueConverterPumpPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
