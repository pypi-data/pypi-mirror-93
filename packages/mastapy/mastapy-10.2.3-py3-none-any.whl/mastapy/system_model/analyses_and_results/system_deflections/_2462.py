...
class TorqueConverterTurbineSystemDeflection(_2363.CouplingHalfSystemDeflection):
    '''TorqueConverterTurbineSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3785.TorqueConverterTurbinePowerFlow':
        ...
        return constructor.new(_3785.TorqueConverterTurbinePowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
