...
from mastapy.system_model.analyses_and_results.power_flows import (
    _3266, _3273, _3275, _3276,
    _3278, _3320, _3358, _3364,
    _3367, _3369, _3370, _3386
)
...
class AGMAGleasonConicalGearSystemDeflection(_2286.ConicalGearSystemDeflection):
    '''AGMAGleasonConicalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3266.AGMAGleasonConicalGearPowerFlow':
        ...
        if _3266.AGMAGleasonConicalGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_bevel_differential_gear_power_flow(self) -> '_3273.BevelDifferentialGearPowerFlow':
        ...
        if _3273.BevelDifferentialGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_bevel_differential_planet_gear_power_flow(self) -> '_3275.BevelDifferentialPlanetGearPowerFlow':
        ...
        if _3275.BevelDifferentialPlanetGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_bevel_differential_sun_gear_power_flow(self) -> '_3276.BevelDifferentialSunGearPowerFlow':
        ...
        if _3276.BevelDifferentialSunGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_bevel_gear_power_flow(self) -> '_3278.BevelGearPowerFlow':
        ...
        if _3278.BevelGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_hypoid_gear_power_flow(self) -> '_3320.HypoidGearPowerFlow':
        ...
        if _3320.HypoidGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_spiral_bevel_gear_power_flow(self) -> '_3358.SpiralBevelGearPowerFlow':
        ...
        if _3358.SpiralBevelGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_straight_bevel_diff_gear_power_flow(self) -> '_3364.StraightBevelDiffGearPowerFlow':
        ...
        if _3364.StraightBevelDiffGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_straight_bevel_gear_power_flow(self) -> '_3367.StraightBevelGearPowerFlow':
        ...
        if _3367.StraightBevelGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_straight_bevel_planet_gear_power_flow(self) -> '_3369.StraightBevelPlanetGearPowerFlow':
        ...
        if _3369.StraightBevelPlanetGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_straight_bevel_sun_gear_power_flow(self) -> '_3370.StraightBevelSunGearPowerFlow':
        ...
        if _3370.StraightBevelSunGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_zerol_bevel_gear_power_flow(self) -> '_3386.ZerolBevelGearPowerFlow':
        ...
        if _3386.ZerolBevelGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
