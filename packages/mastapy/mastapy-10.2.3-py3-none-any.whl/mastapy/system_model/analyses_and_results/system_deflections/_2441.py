...
class SpringDamperConnectionSystemDeflection(_2362.CouplingConnectionSystemDeflection):
    '''SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3766.SpringDamperConnectionPowerFlow':
        ...
        return constructor.new(_3766.SpringDamperConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
