...
class BeltConnectionSystemDeflection(_2320.InterMountableComponentConnectionSystemDeflection):
    '''BeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3270.BeltConnectionPowerFlow':
        ...
        if _3270.BeltConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
