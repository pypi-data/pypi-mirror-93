...
class StraightBevelSunGearSystemDeflection(_2446.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3776.StraightBevelSunGearPowerFlow':
        ...
        return constructor.new(_3776.StraightBevelSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
