...
class BevelDifferentialPlanetGearSystemDeflection(_2240.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3250.BevelDifferentialPlanetGearPowerFlow':
