...
class BevelDifferentialGearMeshGearWhineAnalysis(_5289.BevelGearMeshGearWhineAnalysis):
    '''BevelDifferentialGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2238.BevelDifferentialGearMeshSystemDeflection':
