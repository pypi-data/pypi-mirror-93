...
class BevelDifferentialPlanetGearGearWhineAnalysis(_5283.BevelDifferentialGearGearWhineAnalysis):
    '''BevelDifferentialPlanetGearGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2077.BevelDifferentialPlanetGear':
    ...
    @property
    def system_deflection_results(self) -> '_2241.BevelDifferentialPlanetGearSystemDeflection':
