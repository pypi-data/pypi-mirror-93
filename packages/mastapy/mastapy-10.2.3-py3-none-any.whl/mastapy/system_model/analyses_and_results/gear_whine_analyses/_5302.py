...
from mastapy.system_model.analyses_and_results.system_deflections import _2253, _2319, _2354
...
class AbstractShaftOrHousingGearWhineAnalysis(_5325.ComponentGearWhineAnalysis):
    '''AbstractShaftOrHousingGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2253.AbstractShaftOrHousingSystemDeflection':
