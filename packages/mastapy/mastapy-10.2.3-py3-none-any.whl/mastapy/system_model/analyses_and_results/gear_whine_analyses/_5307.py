...
class BearingGearWhineAnalysis(_5336.ConnectorGearWhineAnalysis):
    '''BearingGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2258.BearingSystemDeflection':
        ...
        return constructor.new(_2258.BearingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
