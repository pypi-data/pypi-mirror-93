...
class ConceptGearMeshSingleMeshWhineAnalysis(_5483.GearMeshSingleMeshWhineAnalysis):
    '''ConceptGearMeshSingleMeshWhineAnalysis
    ...
    @property
    def connection_load_case(self) -> '_6100.ConceptGearMeshLoadCase':
        ...
        return constructor.new(_6100.ConceptGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
