...
class ConceptCouplingConnectionGearWhineAnalysis(_5310.CouplingConnectionGearWhineAnalysis):
    '''ConceptCouplingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2254.ConceptCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2254.ConceptCouplingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
