...
from mastapy.system_model.analyses_and_results.system_deflections import _2260, _2294
...
class BeltDriveGearWhineAnalysis(_5415.SpecialisedAssemblyGearWhineAnalysis):
    '''BeltDriveGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2260.BeltDriveSystemDeflection':
