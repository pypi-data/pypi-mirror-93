...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5691
...
class BevelGearCompoundGearWhineAnalysis(_5691.AGMAGleasonConicalGearCompoundGearWhineAnalysis):
    '''BevelGearCompoundGearWhineAnalysis
