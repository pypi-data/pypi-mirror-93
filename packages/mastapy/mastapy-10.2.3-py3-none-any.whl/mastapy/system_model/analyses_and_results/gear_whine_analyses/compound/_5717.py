...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5790
...
class AbstractAssemblyCompoundGearWhineAnalysis(_5790.PartCompoundGearWhineAnalysis):
    '''AbstractAssemblyCompoundGearWhineAnalysis
