...
class BevelDifferentialSunGearGearWhineAnalysis(_5310.BevelDifferentialGearGearWhineAnalysis):
    '''BevelDifferentialSunGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2265.BevelDifferentialSunGearSystemDeflection':
        ...
        return constructor.new(_2265.BevelDifferentialSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
