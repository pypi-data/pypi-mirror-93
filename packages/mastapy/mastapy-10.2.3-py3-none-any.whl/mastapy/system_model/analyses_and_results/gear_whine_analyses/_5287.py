...
class BevelDifferentialSunGearGearWhineAnalysis(_5283.BevelDifferentialGearGearWhineAnalysis):
    '''BevelDifferentialSunGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2242.BevelDifferentialSunGearSystemDeflection':
