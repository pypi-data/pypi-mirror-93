...
class BevelGearMeshGearWhineAnalysis(_5277.AGMAGleasonConicalGearMeshGearWhineAnalysis):
    '''BevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2243.BevelGearMeshSystemDeflection':
