...
from mastapy.system_model.analyses_and_results.static_loads import _6107, _6140
from mastapy.system_model.analyses_and_results.system_deflections import _2259, _2292
...
class BeltConnectionGearWhineAnalysis(_5382.InterMountableComponentConnectionGearWhineAnalysis):
    '''BeltConnectionGearWhineAnalysis
    ...
    @property
    def connection_load_case(self) -> '_6107.BeltConnectionLoadCase':
        ...
        if _6107.BeltConnectionLoadCase.TYPE not in self.wrapped.ConnectionLoadCase.__class__.__mro__:
    ...
    @property
    def system_deflection_results(self) -> '_2259.BeltConnectionSystemDeflection':
        ...
        if _2259.BeltConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
