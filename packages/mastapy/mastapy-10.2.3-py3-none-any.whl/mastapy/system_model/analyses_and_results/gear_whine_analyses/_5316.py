...
class BevelGearMeshGearWhineAnalysis(_5304.AGMAGleasonConicalGearMeshGearWhineAnalysis):
    '''BevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2266.BevelGearMeshSystemDeflection':
