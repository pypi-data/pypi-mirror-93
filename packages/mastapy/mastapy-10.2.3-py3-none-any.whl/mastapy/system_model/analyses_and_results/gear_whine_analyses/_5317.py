...
class BevelGearSetGearWhineAnalysis(_5305.AGMAGleasonConicalGearSetGearWhineAnalysis):
    '''BevelGearSetGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2267.BevelGearSetSystemDeflection':
