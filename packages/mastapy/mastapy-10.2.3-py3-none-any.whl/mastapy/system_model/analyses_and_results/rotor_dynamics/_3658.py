...
from mastapy.system_model.analyses_and_results.rotor_dynamics import _3656
from mastapy.utility.units_and_measurements.measurements import _1426
...
class ShaftModalComplexShape(_3656.ShaftComplexShape['_1426.Number', 'SMT.MastaAPI.Utility.UnitsAndMeasurements.Measurements.Number']):
    '''ShaftModalComplexShape
