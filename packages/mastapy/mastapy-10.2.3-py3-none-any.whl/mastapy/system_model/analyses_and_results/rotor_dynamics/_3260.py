...
from mastapy.system_model.analyses_and_results.rotor_dynamics import _3258
...
class ShaftModalComplexShape(_3258.ShaftComplexShape['_1237.Number', 'SMT.MastaAPI.Utility.UnitsAndMeasurements.Measurements.Number']):
    '''ShaftModalComplexShape
