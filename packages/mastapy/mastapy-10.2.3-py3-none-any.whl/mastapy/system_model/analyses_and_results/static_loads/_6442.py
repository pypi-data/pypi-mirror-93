...
class ConicalGearSetHarmonicLoadData(_6488.GearSetHarmonicLoadData):
    '''ConicalGearSetHarmonicLoadData
    ...
    @property
    def te_specification_type(self) -> '_309.TESpecificationType':
        ...
        return constructor.new(_309.TESpecificationType)(value) if value else None

    @te_specification_type.setter
    def te_specification_type(self, value: '_309.TESpecificationType'):
