...
from mastapy.system_model.analyses_and_results.static_loads import _6553, _6407, _6567
...
class ConnectionLoadCase(_2291.ConnectionAnalysis):
    '''ConnectionLoadCase
    ...
    @property
    def static_load_case(self) -> '_6553.StaticLoadCase':
        ...
        if _6553.StaticLoadCase.TYPE not in self.wrapped.StaticLoadCase.__class__.__mro__:
