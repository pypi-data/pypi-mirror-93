...
from mastapy.system_model.analyses_and_results.static_loads import _6412, _6517
...
class RingPinsLoadCase(_6517.MountableComponentLoadCase):
    '''RingPinsLoadCase
    ...
    @property
    def all_ring_pins_manufacturing_error(self) -> '_6412.AllRingPinsManufacturingError':
        ...
        return constructor.new(_6412.AllRingPinsManufacturingError)(self.wrapped.AllRingPinsManufacturingError) if self.wrapped.AllRingPinsManufacturingError else None
