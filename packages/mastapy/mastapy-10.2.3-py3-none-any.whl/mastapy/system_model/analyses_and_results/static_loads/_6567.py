...
class TimeSeriesLoadCase(_6401.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5082.MBDAnalysisOptions':
        ...
        return constructor.new(_5082.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
