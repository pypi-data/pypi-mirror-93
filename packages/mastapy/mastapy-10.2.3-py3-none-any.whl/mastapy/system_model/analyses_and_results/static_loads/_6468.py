...
from mastapy.system_model.analyses_and_results.static_loads import _6572, _6498, _6546
...
class ElectricMachineHarmonicLoadData(_6546.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    @property
    def force_distribution(self) -> '_7154.SMTBitmap':
        ...
        return constructor.new(_7154.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
