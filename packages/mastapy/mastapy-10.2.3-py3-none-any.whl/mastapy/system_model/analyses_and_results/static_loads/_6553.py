...
from mastapy.system_model.analyses_and_results.load_case_groups import _5281, _5282, _5283
...
class StaticLoadCase(_6401.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def planetary_rating_load_sharing_method(self) -> '_301.PlanetaryRatingLoadSharingOption':
        ...
        return constructor.new(_301.PlanetaryRatingLoadSharingOption)(value) if value else None

    @planetary_rating_load_sharing_method.setter
    def planetary_rating_load_sharing_method(self, value: '_301.PlanetaryRatingLoadSharingOption'):
    ...
    @property
    def advanced_system_deflection_options(self) -> '_6869.AdvancedSystemDeflectionOptions':
        ...
        return constructor.new(_6869.AdvancedSystemDeflectionOptions)(self.wrapped.AdvancedSystemDeflectionOptions) if self.wrapped.AdvancedSystemDeflectionOptions else None

    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2321.TESetUpForDynamicAnalysisOptions':
        ...
        return constructor.new(_2321.TESetUpForDynamicAnalysisOptions)(self.wrapped.TESetUpForDynamicAnalysesOptions) if self.wrapped.TESetUpForDynamicAnalysesOptions else None
    ...
    @property
    def harmonic_analysis_options_for_atsam(self) -> '_5639.HarmonicAnalysisOptions':
        ...
        if _5639.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisOptionsForATSAM.__class__.__mro__:
    ...
    @property
    def clutch_engagements(self) -> 'List[_5281.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5281.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5282.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5282.ConceptSynchroGearEngagementStatus))
        return value
    ...
    def duplicate(self, new_design_state_group: '_5283.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
