...
from mastapy.system_model.analyses_and_results.static_loads import _6451, _6417
...
class CVTLoadCase(_6417.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6451.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6451.CVTPulleyLoadCase))
        return value
