...
from mastapy.system_model.analyses_and_results.static_loads import _6498, _6494, _6474
...
class HarmonicLoadDataImportFromMotorPackages(_6494.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
