...
from mastapy.system_model.analyses_and_results.static_loads import _6578, _6579, _6489
...
class WormGearSetLoadCase(_6489.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6578.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6578.WormGearLoadCase))
        return value

    @property
    def worm_gears_load_case(self) -> 'List[_6578.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_6578.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_6579.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_6579.WormGearMeshLoadCase))
        return value
