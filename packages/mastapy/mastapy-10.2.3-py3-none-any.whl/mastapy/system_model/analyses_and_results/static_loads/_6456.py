...
from mastapy.system_model.analyses_and_results.static_loads import _6457, _6484
...
class CylindricalGearLoadCase(_6484.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6457.CylindricalGearManufactureError':
        ...
        return constructor.new(_6457.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None

    @property
    def overridden_micro_geometry(self) -> '_1022.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_1022.CylindricalGearMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry else None
