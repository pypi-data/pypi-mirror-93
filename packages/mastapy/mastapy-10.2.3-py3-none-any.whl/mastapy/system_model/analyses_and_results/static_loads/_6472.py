...
from mastapy.system_model.analyses_and_results.static_loads import _6468, _6474
...
T = TypeVar('T', bound='_6474.ElectricMachineHarmonicLoadImportOptionsBase')


class ElectricMachineHarmonicLoadDataFromMotorPackages(_6468.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
