...
from mastapy.system_model.analyses_and_results.static_loads import _6487, _6492
...
class GearSetHarmonicLoadData(_6492.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6487.GearMeshTEOrderType':
        ...
        return constructor.new(_6487.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6487.GearMeshTEOrderType'):
