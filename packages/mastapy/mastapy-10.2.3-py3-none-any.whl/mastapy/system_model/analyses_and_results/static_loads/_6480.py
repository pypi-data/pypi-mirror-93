...
from mastapy.system_model.analyses_and_results.static_loads import _6478, _6479, _6489
...
class FaceGearSetLoadCase(_6489.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6478.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6478.FaceGearLoadCase))
        return value

    @property
    def face_gears_load_case(self) -> 'List[_6478.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_6478.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_6479.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_6479.FaceGearMeshLoadCase))
        return value
