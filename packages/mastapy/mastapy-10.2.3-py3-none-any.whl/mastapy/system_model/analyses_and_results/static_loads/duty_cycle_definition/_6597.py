...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6587, _6598, _6589, _6586,
    _6590, _6592, _6599, _6596,
    _6588, _6591, _6585
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6502.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6502.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6502.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6598.TimeStepInputOptions':
        ...
        return constructor.new(_6598.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6589.GearRatioInputOptions':
        ...
        return constructor.new(_6589.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6586.DesignStateOptions':
        ...
        return constructor.new(_6586.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6590.LoadCaseNameOptions':
        ...
        return constructor.new(_6590.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6592.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6592.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6599.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6599.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6596.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6596.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6588.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6588.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6591.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6591.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6585.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6585.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1542.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1542.ColumnTitle))
        return value
