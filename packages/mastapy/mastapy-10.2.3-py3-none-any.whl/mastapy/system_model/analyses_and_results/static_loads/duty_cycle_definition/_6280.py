...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6270, _6281, _6272, _6269,
    _6273, _6275, _6282, _6279,
    _6271, _6274, _6268
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6189.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6189.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6189.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6281.TimeStepInputOptions':
        ...
        return constructor.new(_6281.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6272.GearRatioInputOptions':
        ...
        return constructor.new(_6272.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6269.DesignStateOptions':
        ...
        return constructor.new(_6269.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6273.LoadCaseNameOptions':
        ...
        return constructor.new(_6273.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6275.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6275.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6282.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6282.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6279.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6279.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6271.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6271.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6274.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6274.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6268.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6268.BoostPressureLoadCaseInputOptions))
        return value
