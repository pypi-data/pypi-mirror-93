...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6600, _6594
...
class TorqueInputOptions(_6594.PowerLoadInputOptions):
    '''TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6600.TorqueValuesObtainedFrom':
        ...
        return constructor.new(_6600.TorqueValuesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6600.TorqueValuesObtainedFrom'):
