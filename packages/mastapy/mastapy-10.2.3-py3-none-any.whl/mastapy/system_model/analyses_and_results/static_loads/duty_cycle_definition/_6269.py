...
class DesignStateOptions(_1529.ColumnInputOptions):
    ...
    @property
    def design_state_destinations(self) -> 'List[_1838.DutyCycleImporterDesignEntityMatch[_5285.DesignState]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStateDestinations, constructor.new(_1838.DutyCycleImporterDesignEntityMatch)[_5285.DesignState])
        return value
