...
from mastapy.utility.file_access_helpers import _1543
from mastapy.utility_gui import _1566
...
class MultiTimeSeriesDataInputFileOptions(_1566.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1543.TextFileDelimiterOptions':
        ...
        return constructor.new(_1543.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
