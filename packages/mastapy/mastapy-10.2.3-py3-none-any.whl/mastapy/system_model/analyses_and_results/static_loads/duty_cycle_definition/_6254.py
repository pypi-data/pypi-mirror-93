...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6255, _6249
...
class TorqueInputOptions(_6249.PowerLoadInputOptions):
    '''TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6255.TorqueValuesObtainedFrom':
        ...
        return constructor.new(_6255.TorqueValuesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6255.TorqueValuesObtainedFrom'):
