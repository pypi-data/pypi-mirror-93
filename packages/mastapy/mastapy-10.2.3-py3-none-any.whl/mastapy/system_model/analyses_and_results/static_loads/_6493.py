...
from mastapy.system_model.analyses_and_results.static_loads import _6518, _6494, _6473
...
class HarmonicLoadDataExcelImport(_6494.HarmonicLoadDataImportBase['_6473.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6518.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6518.NamedSpeed))
        return value
