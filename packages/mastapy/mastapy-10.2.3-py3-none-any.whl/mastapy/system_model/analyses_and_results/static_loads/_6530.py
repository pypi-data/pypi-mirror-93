...
from mastapy.math_utility import _1264, _1274
...
class PointLoadHarmonicLoadData(_6546.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1264.DegreesOfFreedom':
        ...
        return constructor.new(_1264.DegreesOfFreedom)(value) if value else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1264.DegreesOfFreedom'):
