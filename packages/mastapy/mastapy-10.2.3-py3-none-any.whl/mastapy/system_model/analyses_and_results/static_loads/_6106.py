...
class BearingLoadCase(_6136.ConnectorLoadCase):
    '''BearingLoadCase
    ...
    @property
    def bearing_stiffness_model(self) -> '_5022.BearingStiffnessModel':
        ...
        return constructor.new(_5022.BearingStiffnessModel)(value) if value else None

    @bearing_stiffness_model.setter
    def bearing_stiffness_model(self, value: '_5022.BearingStiffnessModel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BearingStiffnessModel = value

    @property
    def bearing_stiffness_model_used_in_analysis(self) -> '_5022.BearingStiffnessModel':
