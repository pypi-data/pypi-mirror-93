...
from mastapy.system_model.analyses_and_results.static_loads import _6527, _6517
...
class PlanetCarrierLoadCase(_6517.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6527.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6527.PlanetarySocketManufactureError))
        return value
