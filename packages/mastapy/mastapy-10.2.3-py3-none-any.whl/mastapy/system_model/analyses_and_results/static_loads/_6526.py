...
class PlanetaryGearSetLoadCase(_6460.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1343.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1343.LoadCaseOverrideOption'):
