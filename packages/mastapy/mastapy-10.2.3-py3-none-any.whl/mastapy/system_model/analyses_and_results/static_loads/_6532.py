...
from mastapy.system_model import _1888, _1889, _1890
from mastapy.system_model.analyses_and_results.mbd_analyses import _5136
from mastapy.system_model.analyses_and_results.static_loads import _6573, _6468, _6577
from mastapy.system_model.fe import _2023
from mastapy.system_model.part_model import _2118
from mastapy.math_utility.control import _1331
from mastapy.nodal_analysis.varying_input_components import _88
...
class PowerLoadLoadCase(_6577.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1888.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1888.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1888.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_5136.WheelSlipType':
        ...
        return constructor.new(_5136.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5136.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1890.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1890.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1890.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1331.PIDControlSettings':
        ...
        return constructor.new(_1331.PIDControlSettings)(self.wrapped.EngineIdleSpeedControlPIDSettings) if self.wrapped.EngineIdleSpeedControlPIDSettings else None

    @property
    def coefficient_of_friction_with_ground(self) -> '_88.NonDimensionalInputComponent':
        ...
        return constructor.new(_88.NonDimensionalInputComponent)(self.wrapped.CoefficientOfFrictionWithGround) if self.wrapped.CoefficientOfFrictionWithGround else None

    @property
    def pid_control_settings(self) -> '_1331.PIDControlSettings':
        ...
        return constructor.new(_1331.PIDControlSettings)(self.wrapped.PIDControlSettings) if self.wrapped.PIDControlSettings else None

    def get_harmonic_load_data_for_import(self) -> '_6468.ElectricMachineHarmonicLoadData':
