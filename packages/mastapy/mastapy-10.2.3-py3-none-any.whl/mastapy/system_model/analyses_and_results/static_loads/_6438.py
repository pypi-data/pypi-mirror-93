...
from mastapy.system_model.analyses_and_results.static_loads import _6436, _6437, _6489
...
class ConceptGearSetLoadCase(_6489.GearSetLoadCase):
    '''ConceptGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6436.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6436.ConceptGearLoadCase))
        return value

    @property
    def concept_gears_load_case(self) -> 'List[_6436.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsLoadCase, constructor.new(_6436.ConceptGearLoadCase))
        return value

    @property
    def concept_meshes_load_case(self) -> 'List[_6437.ConceptGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesLoadCase, constructor.new(_6437.ConceptGearMeshLoadCase))
        return value
