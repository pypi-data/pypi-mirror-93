...
from mastapy.system_model.fe import _2009, _2032
...
class FEPartLoadCase(_6404.AbstractShaftOrHousingLoadCase):
    '''FEPartLoadCase
    ...
    @property
    def angle_source(self) -> '_2009.AngleSource':
        ...
        return constructor.new(_2009.AngleSource)(value) if value else None
