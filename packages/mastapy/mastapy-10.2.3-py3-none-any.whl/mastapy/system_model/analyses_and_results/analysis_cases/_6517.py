...
class PartCompoundAnalysis(_6514.DesignEntityCompoundAnalysis):
    '''PartCompoundAnalysis
    ...
    @property
    def twod_drawing(self) -> '_6529.SMTBitmap':
        ...
        return constructor.new(_6529.SMTBitmap)(self.wrapped.TwoDDrawing) if self.wrapped.TwoDDrawing else None
