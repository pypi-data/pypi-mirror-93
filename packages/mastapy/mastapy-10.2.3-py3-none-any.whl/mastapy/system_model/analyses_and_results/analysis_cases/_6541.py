...
from mastapy.system_model.analyses_and_results import _2227, _2225
...
class DesignEntityCompoundAnalysis(_2225.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2227.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2227.DesignEntitySingleContextAnalysis))
        return value
