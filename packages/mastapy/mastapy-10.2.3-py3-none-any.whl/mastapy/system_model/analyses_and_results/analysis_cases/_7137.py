...
from mastapy.system_model.analyses_and_results import _2295, _2293
...
class DesignEntityCompoundAnalysis(_2293.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2295.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2295.DesignEntitySingleContextAnalysis))
        return value
