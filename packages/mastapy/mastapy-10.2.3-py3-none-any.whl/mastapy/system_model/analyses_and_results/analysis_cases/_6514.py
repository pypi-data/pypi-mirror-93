...
from mastapy.system_model.analyses_and_results import _2204, _2202
...
class DesignEntityCompoundAnalysis(_2202.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2204.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2204.DesignEntitySingleContextAnalysis))
        return value
