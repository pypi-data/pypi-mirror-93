...
class TimeSeriesLoadAnalysisCase(_6506.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6222.TimeSeriesLoadCase':
        ...
        return constructor.new(_6222.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
