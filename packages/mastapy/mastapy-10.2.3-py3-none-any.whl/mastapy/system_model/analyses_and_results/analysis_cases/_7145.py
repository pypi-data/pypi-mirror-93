...
class TimeSeriesLoadAnalysisCase(_7129.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6567.TimeSeriesLoadCase':
        ...
        return constructor.new(_6567.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
