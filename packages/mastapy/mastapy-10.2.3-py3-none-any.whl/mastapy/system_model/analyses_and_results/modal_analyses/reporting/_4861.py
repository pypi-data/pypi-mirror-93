...
class PerModeResultsReport(_1486.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1544.TableAndChartOptions':
    ...
    def display_option(self, value: '_1544.TableAndChartOptions'):
