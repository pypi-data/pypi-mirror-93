...
from mastapy.utility.modal_analysis import _1523
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2294.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1523.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1523.DesignEntityExcitationDescription))
        return value
