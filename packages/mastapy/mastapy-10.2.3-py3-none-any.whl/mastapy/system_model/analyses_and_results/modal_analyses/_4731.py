...
class BevelGearMeshModalAnalysis(_4719.AGMAGleasonConicalGearMeshModalAnalysis):
    '''BevelGearMeshModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2339.BevelGearMeshSystemDeflection':
