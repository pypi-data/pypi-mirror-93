...
class BoltedJointModalAnalysis(_4845.SpecialisedAssemblyModalAnalysis):
    '''BoltedJointModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2269.BoltedJointSystemDeflection':
        ...
        return constructor.new(_2269.BoltedJointSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
