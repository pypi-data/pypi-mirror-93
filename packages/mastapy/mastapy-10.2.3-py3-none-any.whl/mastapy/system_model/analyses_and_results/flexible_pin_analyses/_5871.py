...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2531, _2567, _2490
...
class FlexiblePinAnalysisGearAndBearingRating(_5868.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisGearAndBearingRating
    ...
    @property
    def gear_set_analysis(self) -> '_2531.CylindricalGearSetCompoundSystemDeflection':
        ...
        if _2531.CylindricalGearSetCompoundSystemDeflection.TYPE not in self.wrapped.GearSetAnalysis.__class__.__mro__:
    ...
    @property
    def bearing_analyses(self) -> 'List[_2490.BearingCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingAnalyses, constructor.new(_2490.BearingCompoundSystemDeflection))
        return value
