...
class FlexiblePinAnalysisManufactureLevel(_5868.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_3970.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_3970.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
