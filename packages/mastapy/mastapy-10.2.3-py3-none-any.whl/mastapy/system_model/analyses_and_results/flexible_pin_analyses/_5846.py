...
class WindTurbineCertificationReport(_5838.CombinationAnalysis):
    ...
    @property
    def ldd_static_analysis(self) -> '_2488.RootAssemblyCompoundSystemDeflection':
        ...
        return constructor.new(_2488.RootAssemblyCompoundSystemDeflection)(self.wrapped.LDDStaticAnalysis) if self.wrapped.LDDStaticAnalysis else None

    @property
    def nominal_load_case_static_analysis(self) -> '_2350.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2350.RootAssemblySystemDeflection)(self.wrapped.NominalLoadCaseStaticAnalysis) if self.wrapped.NominalLoadCaseStaticAnalysis else None

    @property
    def extreme_load_case_static_analysis(self) -> '_2350.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2350.RootAssemblySystemDeflection)(self.wrapped.ExtremeLoadCaseStaticAnalysis) if self.wrapped.ExtremeLoadCaseStaticAnalysis else None
