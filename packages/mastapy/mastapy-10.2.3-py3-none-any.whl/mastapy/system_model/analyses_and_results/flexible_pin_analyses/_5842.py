...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2444, _2480, _2407
...
class FlexiblePinAnalysisGearAndBearingRating(_5839.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisGearAndBearingRating
    ...
    @property
    def gear_set_analysis(self) -> '_2444.CylindricalGearSetCompoundSystemDeflection':
        ...
        if _2444.CylindricalGearSetCompoundSystemDeflection.TYPE not in self.wrapped.GearSetAnalysis.__class__.__mro__:
    ...
    @property
    def bearing_analyses(self) -> 'List[_2407.BearingCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingAnalyses, constructor.new(_2407.BearingCompoundSystemDeflection))
        return value
