...
class CouplingConnectionAdvancedTimeSteppingAnalysisForModulation(_6671.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''CouplingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_design(self) -> '_1996.CouplingConnection':
