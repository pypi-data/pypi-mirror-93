...
class CouplingHalfAdvancedTimeSteppingAnalysisForModulation(_6683.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    '''CouplingHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2228.CouplingHalf':
