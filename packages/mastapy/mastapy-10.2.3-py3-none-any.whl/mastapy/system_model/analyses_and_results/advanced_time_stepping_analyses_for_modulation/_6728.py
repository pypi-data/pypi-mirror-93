...
class VirtualComponentAdvancedTimeSteppingAnalysisForModulation(_6683.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    '''VirtualComponentAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2124.VirtualComponent':
