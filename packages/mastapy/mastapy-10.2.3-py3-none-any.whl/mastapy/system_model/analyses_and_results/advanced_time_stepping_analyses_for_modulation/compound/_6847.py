...
class StraightBevelSunGearCompoundAdvancedTimeSteppingAnalysisForModulation(_6840.StraightBevelDiffGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelSunGearCompoundAdvancedTimeSteppingAnalysisForModulation
