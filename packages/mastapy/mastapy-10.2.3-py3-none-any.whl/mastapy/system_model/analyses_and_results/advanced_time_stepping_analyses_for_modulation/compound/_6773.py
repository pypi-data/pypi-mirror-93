...
class CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_6800.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
