...
from mastapy.system_model.analyses_and_results.analysis_cases import _7133
...
class ConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7133.ConnectionCompoundAnalysis):
    '''ConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
