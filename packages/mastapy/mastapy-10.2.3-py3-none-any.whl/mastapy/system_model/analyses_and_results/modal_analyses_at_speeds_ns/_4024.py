...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4023, _4022, _4029
...
class BevelDifferentialGearSetModalAnalysesAtSpeeds(_4029.BevelGearSetModalAnalysesAtSpeeds):
    '''BevelDifferentialGearSetModalAnalysesAtSpeeds
    ...
    @property
    def bevel_differential_gears_modal_analyses_at_speeds(self) -> 'List[_4023.BevelDifferentialGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsModalAnalysesAtSpeeds, constructor.new(_4023.BevelDifferentialGearModalAnalysesAtSpeeds))
        return value

    @property
    def bevel_differential_meshes_modal_analyses_at_speeds(self) -> 'List[_4022.BevelDifferentialGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesModalAnalysesAtSpeeds, constructor.new(_4022.BevelDifferentialGearMeshModalAnalysesAtSpeeds))
        return value
