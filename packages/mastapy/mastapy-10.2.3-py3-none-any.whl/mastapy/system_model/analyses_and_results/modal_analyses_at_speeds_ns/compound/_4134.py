...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _4201
...
class CoaxialConnectionCompoundModalAnalysesAtSpeeds(_4201.ShaftToMountableComponentConnectionCompoundModalAnalysesAtSpeeds):
    '''CoaxialConnectionCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4009.CoaxialConnectionModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4009.CoaxialConnectionModalAnalysesAtSpeeds))
        return value

    @property
    def connection_modal_analyses_at_speeds_load_cases(self) -> 'List[_4009.CoaxialConnectionModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtSpeedsLoadCases, constructor.new(_4009.CoaxialConnectionModalAnalysesAtSpeeds))
        return value
