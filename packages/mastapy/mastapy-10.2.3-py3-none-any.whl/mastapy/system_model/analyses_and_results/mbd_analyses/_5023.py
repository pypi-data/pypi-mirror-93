...
class BeltConnectionMultiBodyDynamicsAnalysis(_5081.InterMountableComponentConnectionMultiBodyDynamicsAnalysis):
    '''BeltConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def loading_status(self) -> '_1398.LoadingStatus':
        ...
        return constructor.new(_1398.LoadingStatus)(value) if value else None
