...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5145
...
class BearingMultibodyDynamicsAnalysis(_5036.ConnectorMultibodyDynamicsAnalysis):
    '''BearingMultibodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5145.DynamicForceVector3DResult':
        ...
        return constructor.new(_5145.DynamicForceVector3DResult)(self.wrapped.PeakDynamicForce) if self.wrapped.PeakDynamicForce else None
