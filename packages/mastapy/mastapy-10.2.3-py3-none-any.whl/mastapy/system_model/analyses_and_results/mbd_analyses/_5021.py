...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5155
...
class BearingMultiBodyDynamicsAnalysis(_5051.ConnectorMultiBodyDynamicsAnalysis):
    '''BearingMultiBodyDynamicsAnalysis
