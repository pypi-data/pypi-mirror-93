...
class BevelDifferentialGearMeshCompoundMultiBodyDynamicsAnalysis(_5147.BevelGearMeshCompoundMultiBodyDynamicsAnalysis):
    '''BevelDifferentialGearMeshCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4998.BevelDifferentialGearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4998.BevelDifferentialGearMeshMultiBodyDynamicsAnalysis))
        return value

    @property
    def connection_multi_body_dynamics_analysis_load_cases(self) -> 'List[_4998.BevelDifferentialGearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionMultiBodyDynamicsAnalysisLoadCases, constructor.new(_4998.BevelDifferentialGearMeshMultiBodyDynamicsAnalysis))
        return value
