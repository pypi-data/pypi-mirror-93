...
from mastapy.system_model.analyses_and_results.power_flows import _3749, _3668
...
class RootAssemblyPowerFlow(_3668.AssemblyPowerFlow):
    '''RootAssemblyPowerFlow
    ...
    @property
    def power_flow_inputs(self) -> '_3749.PowerFlow':
        ...
        return constructor.new(_3749.PowerFlow)(self.wrapped.PowerFlowInputs) if self.wrapped.PowerFlowInputs else None
