...
from mastapy.system_model.analyses_and_results.power_flows import _3777, _3762
...
class SynchroniserPowerFlow(_3762.SpecialisedAssemblyPowerFlow):
    '''SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_3777.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_3777.SynchroniserHalfPowerFlow))
        return value
