...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3805
...
class BevelDifferentialPlanetGearCompoundPowerFlow(_3805.BevelDifferentialGearCompoundPowerFlow):
    '''BevelDifferentialPlanetGearCompoundPowerFlow
