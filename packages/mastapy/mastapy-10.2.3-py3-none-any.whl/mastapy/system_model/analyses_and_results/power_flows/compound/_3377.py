...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3365
...
class BevelGearCompoundPowerFlow(_3365.AGMAGleasonConicalGearCompoundPowerFlow):
    '''BevelGearCompoundPowerFlow
