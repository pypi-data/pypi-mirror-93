...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3794
...
class SpecialisedAssemblyCompoundPowerFlow(_3794.AbstractAssemblyCompoundPowerFlow):
    '''SpecialisedAssemblyCompoundPowerFlow
