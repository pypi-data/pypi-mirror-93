...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3843
...
class PlanetaryGearSetCompoundPowerFlow(_3843.CylindricalGearSetCompoundPowerFlow):
    '''PlanetaryGearSetCompoundPowerFlow
