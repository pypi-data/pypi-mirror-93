...
from mastapy import _3, _6526, _0
...
from mastapy.system_model.part_model import (
    _2037, _2034, _2036, _2030,
    _1999, _2000, _2001, _2004,
    _2006, _2007, _2008, _2011,
    _2012, _2015, _2016, _2017,
    _2020, _2024, _2025, _2026,
    _2028, _2031, _2033, _2038,
    _2039, _2040
)
...
from mastapy.system_model.part_model.configurations import _2168, _2166, _2169
...
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2499
...
class Design(_0.APIBase):
    ...
    @property
    def selected_gear_set_selection_group(self) -> '_2072.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_2072.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None
    ...
    @property
    def gear_set_configurations(self) -> 'List[_2072.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_2072.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_2168.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2168.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def imported_fe_configurations(self) -> 'List[_2166.ActiveImportedFESelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEConfigurations, constructor.new(_2166.ActiveImportedFESelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2169.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2169.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_5258.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5258.DesignState))
        return value
    ...
    @property
    def duty_cycles(self) -> 'List[_5259.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_5259.DutyCycle))
        return value

    @property
    def root_assembly(self) -> '_2036.RootAssembly':
        ...
        return constructor.new(_2036.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly else None

    @property
    def gear_set_config(self) -> '_2093.GearSetConfiguration':
        '''GearSetConfiguration: 'GearSetConfig' is the original name of this property.'''

        return constructor.new(_2093.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig else None

    @gear_set_config.setter
    def gear_set_config(self, value: '_2093.GearSetConfiguration'):
    ...
    def design_state_named(self, name: 'str') -> '_5258.DesignState':
        ...
        return constructor.new(_5258.DesignState)(method_result) if method_result else None

    def duty_cycle_named(self, name: 'str') -> '_5259.DutyCycle':
        ...
        return constructor.new(_5259.DutyCycle)(method_result) if method_result else None
    ...
    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_6526.TaskProgress') -> '_1317.Status':
        ''' 'Save' is the original name of this method.
    ...
    def remove_synchroniser_shift(self, shift: '_2499.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2499.SynchroniserShift':
        ...
        return constructor.new(_2499.SynchroniserShift)(method_result) if method_result else None

    def add_synchroniser_shift_empty(self) -> '_2499.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5258.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5259.DutyCycle':
    ...
    def all_parts_of_type_assembly(self) -> 'List[_1999.Assembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1999.Assembly.TYPE](), constructor.new(_1999.Assembly))
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.1, pulley_b_diameter: Optional['float'] = 0.1, name: Optional['str'] = 'Belt Drive') -> '_2128.BeltCreationOptions':
        ...
        return constructor.new(_2128.BeltCreationOptions)(method_result) if method_result else None

    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.1) -> '_2130.PlanetCarrierCreationOptions':
        ...
        return constructor.new(_2130.PlanetCarrierCreationOptions)(method_result) if method_result else None

    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.0, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2131.ShaftCreationOptions':
        ...
        return constructor.new(_2131.ShaftCreationOptions)(method_result) if method_result else None
    ...
    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2129.CylindricalGearLinearTrainCreationOptions':
        ...
        return constructor.new(_2129.CylindricalGearLinearTrainCreationOptions)(method_result) if method_result else None
