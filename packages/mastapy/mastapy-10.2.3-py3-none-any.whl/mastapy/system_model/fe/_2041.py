...
from mastapy.system_model.fe import _2047, _2037
...
class FESubstructureWithSelectionForStaticAnalysis(_2037.FESubstructureWithSelection):
    '''FESubstructureWithSelectionForStaticAnalysis
    ...
    @property
    def static_draw_style(self) -> '_161.FEModelStaticAnalysisDrawStyle':
        ...
        return constructor.new(_161.FEModelStaticAnalysisDrawStyle)(self.wrapped.StaticDrawStyle) if self.wrapped.StaticDrawStyle else None

    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_2047.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsSelectedNodes, constructor.new(_2047.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def boundary_conditions_all_nodes(self) -> 'List[_2047.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAllNodes, constructor.new(_2047.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def force_results(self) -> 'List[_1324.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceResults, constructor.new(_1324.VectorWithLinearAndAngularComponents))
        return value

    @property
    def displacement_results(self) -> 'List[_1324.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DisplacementResults, constructor.new(_1324.VectorWithLinearAndAngularComponents))
        return value
