...
from mastapy.system_model.fe import _2015
...
class BearingRaceNodeLink(_0.APIBase):
    ...
    @property
    def race_position(self) -> '_2015.BearingRacePosition':
        ...
        return constructor.new(_2015.BearingRacePosition)(value) if value else None
