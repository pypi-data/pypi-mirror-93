...
class FESubstructureWithSelectionForHarmonicAnalysis(_2037.FESubstructureWithSelection):
    '''FESubstructureWithSelectionForHarmonicAnalysis
    ...
    @property
    def harmonic_draw_style(self) -> '_157.FEModelHarmonicAnalysisDrawStyle':
        ...
        return constructor.new(_157.FEModelHarmonicAnalysisDrawStyle)(self.wrapped.HarmonicDrawStyle) if self.wrapped.HarmonicDrawStyle else None
