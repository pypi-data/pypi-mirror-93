...
class FESubstructureWithSelection(_2010.BaseFEWithSelection):
    '''FESubstructureWithSelection
    ...
    @property
    def fe_substructure(self) -> '_2032.FESubstructure':
        ...
        return constructor.new(_2032.FESubstructure)(self.wrapped.FESubstructure) if self.wrapped.FESubstructure else None

    @property
    def element_face_groups(self) -> 'List[_2025.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_2025.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_2048.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_2048.NodeGroupWithSelection))
        return value
