...
from mastapy.system_model.fe import _2027
...
class ElementFaceGroupWithSelection(_2027.FEEntityGroupWithSelection['_193.CMSElementFaceGroup', '_1140.ElementFace']):
    '''ElementFaceGroupWithSelection
