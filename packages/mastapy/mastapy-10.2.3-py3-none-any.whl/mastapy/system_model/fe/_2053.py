...
from mastapy.system_model.fe import _2007, _2014
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2007.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_2007.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_2007.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_2014.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2014.BearingRaceNodeLink))
        return value
