...
class Databases(_0.APIBase):
    ...
    @property
    def supercharger_rotor_set_database(self) -> '_2124.SuperchargerRotorSetDatabase':
        ...
        return constructor.new(_2124.SuperchargerRotorSetDatabase)(self.wrapped.SuperchargerRotorSetDatabase) if self.wrapped.SuperchargerRotorSetDatabase else None
