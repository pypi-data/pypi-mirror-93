...
class Connection(_1835.DesignEntity):
    ...
    @property
    def owner_a_of_type_cvt_pulley(self) -> '_2165.CVTPulley':
        ...
        if _2165.CVTPulley.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to CVTPulley. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_part_to_part_shear_coupling_half(self) -> '_2167.PartToPartShearCouplingHalf':
        ...
        if _2167.PartToPartShearCouplingHalf.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_pulley(self) -> '_2168.Pulley':
        ...
        if _2168.Pulley.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to Pulley. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_rolling_ring(self) -> '_2174.RollingRing':
        ...
        if _2174.RollingRing.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
            raise CastException('Failed to cast owner_a to RollingRing. Expected: {}.'.format(self.wrapped.OwnerA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerA.__class__)(self.wrapped.OwnerA) if self.wrapped.OwnerA else None

    @property
    def owner_a_of_type_shaft_hub_connection(self) -> '_2176.ShaftHubConnection':
        ...
        if _2176.ShaftHubConnection.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_spring_damper_half(self) -> '_2178.SpringDamperHalf':
        ...
        if _2178.SpringDamperHalf.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_synchroniser_half(self) -> '_2181.SynchroniserHalf':
        ...
        if _2181.SynchroniserHalf.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_synchroniser_part(self) -> '_2182.SynchroniserPart':
        ...
        if _2182.SynchroniserPart.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_synchroniser_sleeve(self) -> '_2183.SynchroniserSleeve':
        ...
        if _2183.SynchroniserSleeve.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_torque_converter_pump(self) -> '_2185.TorqueConverterPump':
        ...
        if _2185.TorqueConverterPump.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_a_of_type_torque_converter_turbine(self) -> '_2187.TorqueConverterTurbine':
        ...
        if _2187.TorqueConverterTurbine.TYPE not in self.wrapped.OwnerA.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_cvt_pulley(self) -> '_2165.CVTPulley':
        ...
        if _2165.CVTPulley.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to CVTPulley. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_part_to_part_shear_coupling_half(self) -> '_2167.PartToPartShearCouplingHalf':
        ...
        if _2167.PartToPartShearCouplingHalf.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_pulley(self) -> '_2168.Pulley':
        ...
        if _2168.Pulley.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to Pulley. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_rolling_ring(self) -> '_2174.RollingRing':
        ...
        if _2174.RollingRing.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
            raise CastException('Failed to cast owner_b to RollingRing. Expected: {}.'.format(self.wrapped.OwnerB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OwnerB.__class__)(self.wrapped.OwnerB) if self.wrapped.OwnerB else None

    @property
    def owner_b_of_type_shaft_hub_connection(self) -> '_2176.ShaftHubConnection':
        ...
        if _2176.ShaftHubConnection.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_spring_damper_half(self) -> '_2178.SpringDamperHalf':
        ...
        if _2178.SpringDamperHalf.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_synchroniser_half(self) -> '_2181.SynchroniserHalf':
        ...
        if _2181.SynchroniserHalf.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_synchroniser_part(self) -> '_2182.SynchroniserPart':
        ...
        if _2182.SynchroniserPart.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_synchroniser_sleeve(self) -> '_2183.SynchroniserSleeve':
        ...
        if _2183.SynchroniserSleeve.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_torque_converter_pump(self) -> '_2185.TorqueConverterPump':
        ...
        if _2185.TorqueConverterPump.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
    ...
    @property
    def owner_b_of_type_torque_converter_turbine(self) -> '_2187.TorqueConverterTurbine':
        ...
        if _2187.TorqueConverterTurbine.TYPE not in self.wrapped.OwnerB.__class__.__mro__:
