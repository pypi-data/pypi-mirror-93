...
from mastapy.system_model import _1877
...
class SpringDamperConnection(_1996.CouplingConnection):
    '''SpringDamperConnection
    ...
    @property
    def damping_option(self) -> '_1877.ComponentDampingOption':
        ...
        return constructor.new(_1877.ComponentDampingOption)(value) if value else None

    @damping_option.setter
    def damping_option(self, value: '_1877.ComponentDampingOption'):
