...
from mastapy.system_model.connections_and_sockets import _1918
...
class CycloidalDiscPlanetaryBearingConnection(_1918.AbstractShaftToMountableComponentConnection):
    '''CycloidalDiscPlanetaryBearingConnection
