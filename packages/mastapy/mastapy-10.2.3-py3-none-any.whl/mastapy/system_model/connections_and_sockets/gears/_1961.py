...
from mastapy.system_model.part_model.gears import _2170, _2186, _2169
...
class CylindricalGearMesh(_1965.GearMesh):
    '''CylindricalGearMesh
    ...
    @property
    def cylindrical_gear_set(self) -> '_2170.CylindricalGearSet':
        ...
        if _2170.CylindricalGearSet.TYPE not in self.wrapped.CylindricalGearSet.__class__.__mro__:
    ...
    @property
    def centre_distance_range(self) -> '_1325.ShortLengthRange':
        ...
        return constructor.new(_1325.ShortLengthRange)(self.wrapped.CentreDistanceRange) if self.wrapped.CentreDistanceRange else None
