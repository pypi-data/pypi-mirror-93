...
from mastapy.system_model.connections_and_sockets.gears import _1970
...
class KlingelnbergCycloPalloidSpiralBevelGearMesh(_1970.KlingelnbergCycloPalloidConicalGearMesh):
    '''KlingelnbergCycloPalloidSpiralBevelGearMesh
