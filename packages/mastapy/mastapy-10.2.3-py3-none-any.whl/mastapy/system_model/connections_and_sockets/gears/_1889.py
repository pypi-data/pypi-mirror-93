...
class CylindricalGearMesh(_1893.GearMesh):
    ...
    @property
    def cylindrical_gear_set(self) -> '_2086.CylindricalGearSet':
        ...
        return constructor.new(_2086.CylindricalGearSet)(self.wrapped.CylindricalGearSet) if self.wrapped.CylindricalGearSet else None
