...
from mastapy.cycloidal import _1222, _1216, _1221
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self) -> '_1222.RingPinsDesign':
        ...
        return constructor.new(_1222.RingPinsDesign)(self.wrapped.RingPins) if self.wrapped.RingPins else None

    @property
    def discs(self) -> 'List[_1216.CycloidalDiscDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Discs, constructor.new(_1216.CycloidalDiscDesign))
        return value

    @property
    def disc_phases(self) -> 'List[_1221.NamedDiscPhase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DiscPhases, constructor.new(_1221.NamedDiscPhase))
        return value
