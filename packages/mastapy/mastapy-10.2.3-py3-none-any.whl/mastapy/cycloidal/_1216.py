...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def modifications_specification(self) -> '_1219.CycloidalDiscModificationsSpecification':
        ...
        return constructor.new(_1219.CycloidalDiscModificationsSpecification)(self.wrapped.ModificationsSpecification) if self.wrapped.ModificationsSpecification else None
