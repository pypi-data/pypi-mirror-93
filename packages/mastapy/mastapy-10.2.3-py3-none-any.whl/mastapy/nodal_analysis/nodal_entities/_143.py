...
from mastapy.math_utility.stiffness_calculators import _1297
...
class SurfaceToSurfaceContactStiffnessEntity(_121.ArbitraryNodalComponent):
    ...
    @property
    def contact(self) -> '_1297.SurfaceToSurfaceContact':
        ...
        return constructor.new(_1297.SurfaceToSurfaceContact)(self.wrapped.Contact) if self.wrapped.Contact else None
