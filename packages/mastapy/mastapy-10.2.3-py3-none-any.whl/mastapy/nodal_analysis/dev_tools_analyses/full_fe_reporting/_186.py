...
from mastapy.fe_tools.enums import _1148
...
class MaterialPropertiesReporting(_0.APIBase):
    ...
    @property
    def elastic_modulus_components(self) -> '_175.ElasticModulusOrthotropicComponents':
        ...
        return constructor.new(_175.ElasticModulusOrthotropicComponents)(self.wrapped.ElasticModulusComponents) if self.wrapped.ElasticModulusComponents else None

    @property
    def shear_modulus_components(self) -> '_190.ShearModulusOrthotropicComponents':
        ...
        return constructor.new(_190.ShearModulusOrthotropicComponents)(self.wrapped.ShearModulusComponents) if self.wrapped.ShearModulusComponents else None

    @property
    def poissons_ratio_components(self) -> '_188.PoissonRatioOrthotropicComponents':
        ...
        return constructor.new(_188.PoissonRatioOrthotropicComponents)(self.wrapped.PoissonsRatioComponents) if self.wrapped.PoissonsRatioComponents else None

    @property
    def thermal_expansion_coefficient_components(self) -> '_191.ThermalExpansionOrthotropicComponents':
        ...
        return constructor.new(_191.ThermalExpansionOrthotropicComponents)(self.wrapped.ThermalExpansionCoefficientComponents) if self.wrapped.ThermalExpansionCoefficientComponents else None
