...
class ElementPropertiesMass(_177.ElementPropertiesBase):
    '''ElementPropertiesMass
    ...
    @property
    def inertia(self) -> '_1278.InertiaTensor':
        ...
        return constructor.new(_1278.InertiaTensor)(self.wrapped.Inertia) if self.wrapped.Inertia else None
