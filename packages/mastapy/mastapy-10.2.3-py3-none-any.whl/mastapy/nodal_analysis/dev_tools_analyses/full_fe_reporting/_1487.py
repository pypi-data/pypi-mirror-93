...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1494, _1483
...
class ElementPropertiesRigid(_1483.ElementPropertiesBase):
    '''ElementPropertiesRigid
    ...
    @property
    def degrees_of_freedom_list(self) -> 'List[_1494.RigidElementNodeDegreesOfFreedom]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedomList, constructor.new(_1494.RigidElementNodeDegreesOfFreedom))
        return value
