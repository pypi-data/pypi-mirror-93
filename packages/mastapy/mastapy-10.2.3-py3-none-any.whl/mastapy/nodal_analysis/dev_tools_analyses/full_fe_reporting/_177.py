...
from mastapy.fe_tools.enums import _1147
...
class ElementPropertiesBase(_0.APIBase):
    ...
    @property
    def class_(self) -> '_1147.ElementPropertyClass':
        ...
        return constructor.new(_1147.ElementPropertyClass)(value) if value else None
