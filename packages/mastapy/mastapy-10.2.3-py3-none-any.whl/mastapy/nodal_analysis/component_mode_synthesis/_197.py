...
from mastapy.fe_tools.vfx_tools import _1145
...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_1263.DataPrecision':
        ...
        return constructor.new(_1263.DataPrecision)(value) if value else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_1263.DataPrecision'):
    ...
    @property
    def internal_mode_options(self) -> '_150.EigenvalueOptions':
        ...
        return constructor.new(_150.EigenvalueOptions)(self.wrapped.InternalModeOptions) if self.wrapped.InternalModeOptions else None

    @property
    def solver_options(self) -> '_1145.ProSolveOptions':
        ...
        return constructor.new(_1145.ProSolveOptions)(self.wrapped.SolverOptions) if self.wrapped.SolverOptions else None
