...
from mastapy.bolts import _1245, _1226
...
class BoltMaterial(_1226.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1245.StrengthGrades':
        ...
        return constructor.new(_1245.StrengthGrades)(value) if value else None

    @strength_grade.setter
    def strength_grade(self, value: '_1245.StrengthGrades'):
