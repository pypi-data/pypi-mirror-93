...
from mastapy.materials import _237, _223
...
class Material(_1550.NamedDatabaseItem):
    '''Material
    ...
    @property
    def standard(self) -> '_237.MaterialStandards':
        '''MaterialStandards: 'Standard' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Standard)
        return constructor.new(_237.MaterialStandards)(value) if value else None

    @standard.setter
    def standard(self, value: '_237.MaterialStandards'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Standard = value

    @property
    def hardness_type(self) -> '_223.HardnessType':
        '''HardnessType: 'HardnessType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HardnessType)
        return constructor.new(_223.HardnessType)(value) if value else None

    @hardness_type.setter
    def hardness_type(self, value: '_223.HardnessType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
