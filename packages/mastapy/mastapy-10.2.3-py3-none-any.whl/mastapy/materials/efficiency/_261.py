...
class OilPumpDetail(_1340.IndependentReportablePropertiesBase['OilPumpDetail']):
    '''OilPumpDetail
    ...
    @property
    def oil_pump_drive_type(self) -> '_262.OilPumpDriveType':
        ...
        return constructor.new(_262.OilPumpDriveType)(value) if value else None

    @oil_pump_drive_type.setter
    def oil_pump_drive_type(self, value: '_262.OilPumpDriveType'):
