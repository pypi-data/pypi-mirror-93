...
class LubricationDetail(_1550.NamedDatabaseItem):
    '''LubricationDetail
    ...
    @property
    def density_specification_method(self) -> '_217.DensitySpecificationMethod':
        ...
        return constructor.new(_217.DensitySpecificationMethod)(value) if value else None

    @density_specification_method.setter
    def density_specification_method(self, value: '_217.DensitySpecificationMethod'):
    ...
    @property
    def pressure_viscosity_coefficient_method(self) -> '_240.PressureViscosityCoefficientMethod':
        ...
        return constructor.new(_240.PressureViscosityCoefficientMethod)(value) if value else None

    @pressure_viscosity_coefficient_method.setter
    def pressure_viscosity_coefficient_method(self, value: '_240.PressureViscosityCoefficientMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def oil_filtration_and_contamination(self) -> '_239.OilFiltrationOptions':
        ...
        return constructor.new(_239.OilFiltrationOptions)(value) if value else None

    @oil_filtration_and_contamination.setter
    def oil_filtration_and_contamination(self, value: '_239.OilFiltrationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OilFiltrationAndContamination = value

    @property
    def grease_contamination_level(self) -> '_222.GreaseContaminationOptions':
        ...
        return constructor.new(_222.GreaseContaminationOptions)(value) if value else None

    @grease_contamination_level.setter
    def grease_contamination_level(self, value: '_222.GreaseContaminationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubricant_type_supply(self) -> '_211.BearingLubricationCondition':
        ...
        return constructor.new(_211.BearingLubricationCondition)(value) if value else None

    @lubricant_type_supply.setter
    def lubricant_type_supply(self, value: '_211.BearingLubricationCondition'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubricant_viscosity_classification(self) -> '_229.LubricantViscosityClassification':
        ...
        return constructor.new(_229.LubricantViscosityClassification)(value) if value else None

    @lubricant_viscosity_classification.setter
    def lubricant_viscosity_classification(self, value: '_229.LubricantViscosityClassification'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubricant_grade_agma(self) -> '_228.LubricantViscosityClassAGMA':
        ...
        return constructor.new(_228.LubricantViscosityClassAGMA)(value) if value else None

    @lubricant_grade_agma.setter
    def lubricant_grade_agma(self, value: '_228.LubricantViscosityClassAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LubricantGradeAGMA = value

    @property
    def lubricant_grade_sae(self) -> '_231.LubricantViscosityClassSAE':
        ...
        return constructor.new(_231.LubricantViscosityClassSAE)(value) if value else None

    @lubricant_grade_sae.setter
    def lubricant_grade_sae(self, value: '_231.LubricantViscosityClassSAE'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def delivery(self) -> '_227.LubricantDelivery':
        ...
        return constructor.new(_227.LubricantDelivery)(value) if value else None

    @property
    def agma925a03_lubricant_type(self) -> '_206.AGMALubricantType':
        ...
        return constructor.new(_206.AGMALubricantType)(value) if value else None

    @agma925a03_lubricant_type.setter
    def agma925a03_lubricant_type(self, value: '_206.AGMALubricantType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AGMA925A03LubricantType = value

    @property
    def iso_lubricant_type(self) -> '_225.ISOLubricantType':
        ...
        return constructor.new(_225.ISOLubricantType)(value) if value else None

    @iso_lubricant_type.setter
    def iso_lubricant_type(self, value: '_225.ISOLubricantType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
