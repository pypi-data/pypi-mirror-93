...
from mastapy.units_and_measurements import _6554
...
class MeasurementTypeExtensions:
    ...
    @staticmethod
    def is_unmeasurable(measurement_type: '_6554.MeasurementType') -> 'bool':
    ...
    @staticmethod
    def is_valid(measurement_type: '_6554.MeasurementType') -> 'bool':
    ...
    @staticmethod
    def is_angle(measurement_type: '_6554.MeasurementType') -> 'bool':
