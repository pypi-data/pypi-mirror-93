...
from mastapy.utility.units_and_measurements.measurements import _1449
...
class DutyCyclePropertySummaryStress(_1556.DutyCyclePropertySummary['_1449.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
