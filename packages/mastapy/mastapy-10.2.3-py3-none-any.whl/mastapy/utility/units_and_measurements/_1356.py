...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1349.RoundingMethods':
        ...
        return constructor.new(_1349.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1349.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1361.Unit':
        ...
        if _1361.Unit.TYPE not in self.wrapped.CurrentUnit.__class__.__mro__:
