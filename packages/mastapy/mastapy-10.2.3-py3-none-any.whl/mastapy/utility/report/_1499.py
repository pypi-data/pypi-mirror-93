...
from mastapy.utility.report import _1500, _1503
...
TItem = TypeVar('TItem', bound='_1503.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1500.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
