...
from mastapy.utility.report import (
    _1493, _1476, _1481, _1482,
    _1483, _1484, _1485, _1486,
    _1488, _1489, _1490, _1491,
    _1492, _1494, _1496, _1497,
    _1500, _1501, _1502, _1504,
...
from mastapy.utility_gui.charts import _1567, _1568
from mastapy.bearings.bearing_results import (
    _1640, _1641, _1644, _1652
)
...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4857, _4861
...
class DynamicCustomReportItem(_1501.CustomReportNameableItem):
    '''DynamicCustomReportItem
    ...
    @property
    def inner_item(self) -> '_1493.CustomReportItem':
        ...
        if _1493.CustomReportItem.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_ad_hoc_custom_table(self) -> '_1476.AdHocCustomTable':
        ...
        if _1476.AdHocCustomTable.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_chart(self) -> '_1481.CustomChart':
        ...
        if _1481.CustomChart.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_graphic(self) -> '_1482.CustomGraphic':
        ...
        if _1482.CustomGraphic.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_image(self) -> '_1483.CustomImage':
        ...
        if _1483.CustomImage.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report(self) -> '_1484.CustomReport':
        ...
        if _1484.CustomReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_cad_drawing(self) -> '_1485.CustomReportCadDrawing':
        ...
        if _1485.CustomReportCadDrawing.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_chart(self) -> '_1486.CustomReportChart':
        ...
        if _1486.CustomReportChart.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_column(self) -> '_1488.CustomReportColumn':
        ...
        if _1488.CustomReportColumn.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_columns(self) -> '_1489.CustomReportColumns':
        ...
        if _1489.CustomReportColumns.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_definition_item(self) -> '_1490.CustomReportDefinitionItem':
        ...
        if _1490.CustomReportDefinitionItem.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_horizontal_line(self) -> '_1491.CustomReportHorizontalLine':
        ...
        if _1491.CustomReportHorizontalLine.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_html_item(self) -> '_1492.CustomReportHtmlItem':
        ...
        if _1492.CustomReportHtmlItem.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_item_container(self) -> '_1494.CustomReportItemContainer':
        ...
        if _1494.CustomReportItemContainer.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_item_container_collection_base(self) -> '_1496.CustomReportItemContainerCollectionBase':
        ...
        if _1496.CustomReportItemContainerCollectionBase.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_item_container_collection_item(self) -> '_1497.CustomReportItemContainerCollectionItem':
        ...
        if _1497.CustomReportItemContainerCollectionItem.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_multi_property_item_base(self) -> '_1500.CustomReportMultiPropertyItemBase':
        ...
        if _1500.CustomReportMultiPropertyItemBase.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_nameable_item(self) -> '_1501.CustomReportNameableItem':
        ...
        if _1501.CustomReportNameableItem.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_named_item(self) -> '_1502.CustomReportNamedItem':
        ...
        if _1502.CustomReportNamedItem.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_status_item(self) -> '_1504.CustomReportStatusItem':
        ...
        if _1504.CustomReportStatusItem.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_tab(self) -> '_1505.CustomReportTab':
        ...
        if _1505.CustomReportTab.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_tabs(self) -> '_1506.CustomReportTabs':
        ...
        if _1506.CustomReportTabs.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_report_text(self) -> '_1507.CustomReportText':
        ...
        if _1507.CustomReportText.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_sub_report(self) -> '_1509.CustomSubReport':
        ...
        if _1509.CustomSubReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_table(self) -> '_1510.CustomTable':
        ...
        if _1510.CustomTable.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_line_chart(self) -> '_1567.CustomLineChart':
        ...
        if _1567.CustomLineChart.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_table_and_chart(self) -> '_1568.CustomTableAndChart':
        ...
        if _1568.CustomTableAndChart.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_loaded_ball_element_chart_reporter(self) -> '_1640.LoadedBallElementChartReporter':
        ...
        if _1640.LoadedBallElementChartReporter.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_loaded_bearing_chart_reporter(self) -> '_1641.LoadedBearingChartReporter':
        ...
        if _1641.LoadedBearingChartReporter.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_loaded_bearing_temperature_chart(self) -> '_1644.LoadedBearingTemperatureChart':
        ...
        if _1644.LoadedBearingTemperatureChart.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_loaded_roller_element_chart_reporter(self) -> '_1652.LoadedRollerElementChartReporter':
        ...
        if _1652.LoadedRollerElementChartReporter.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_shaft_system_deflection_sections_report(self) -> '_2480.ShaftSystemDeflectionSectionsReport':
        ...
        if _2480.ShaftSystemDeflectionSectionsReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_parametric_study_histogram(self) -> '_4013.ParametricStudyHistogram':
        ...
        if _4013.ParametricStudyHistogram.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_campbell_diagram_report(self) -> '_4857.CampbellDiagramReport':
        ...
        if _4857.CampbellDiagramReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_per_mode_results_report(self) -> '_4861.PerModeResultsReport':
        ...
        if _4861.PerModeResultsReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
