...
from mastapy.utility.report import _1515, _1508
...
class UserTextRow(_1508.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1515.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1515.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1515.HeadingSize'):
