'''
Модуль создания основного графического окна клиента
'''
import sys
import json
import logging
...
class ClientMainWindow(CommonApi, QMainWindow):
    '''
    Класс основного графического окна клиента
    '''
...
{item[2]}')
    ...
    def select_active_user(self):
        '''
        Метод выбора активного контакта (даблклик)
        :return:
        '''
    ...
    def set_active_user(self):
        '''
        Метод установки активного собеседника
        :return:
        '''
    ...
    def add_contact(self, new_contact):
        '''
        Метод добавления контакта в базы
        :param new_contact: контакт для добавления
        :return:
        '''
        try:
    ...
    def delete_contact(self, item):
        '''
        Метод - обработчик удаления контакта, сообщает серверу,
...
{message_text}')
    ...
    def message(self, message):
        ...
        encrypted_message = base64.b64decode(message[self.MESSAGE_TEXT])
    ...
    def sig_205(self):
        '''
        Слот обновления базы данных по команде сервера
        '''

        if self.current_chat and not self.database.check_user(
                self.current_chat):
            self.messages.warning(
                self, 'Собеседник был удалён с сервера.')
            self.set_disabled_input()
            self.current_chat = None
        self.clients_list_update()
