...
from Errors import UnprocessedEntry
from JSONRead import EasyReturn
from function.Special_Entry import Special_Entry
from function.WebVisit import WebVisit
                    ...
                    if ord(char) >= 128:
                        ...
                        if GotIndex_R == GotIndex:
                            ...
                            if Before < After:
                                ...
                                Ind = text_copy.index("|")
                                IndBefore = Ind - 10
                                if t[IndBefore:Ind] in Special_Entry.Special_Entry:
                                    GotIndex = GotIndex_R
                                    break
                                else:
