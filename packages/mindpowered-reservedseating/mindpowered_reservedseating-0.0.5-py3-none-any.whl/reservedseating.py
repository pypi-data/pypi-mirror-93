...
class reservedseating_ReservedSeating:
    __slots__ = ("maglev",)
    ...
    def registerMyMethods(self):
        ...
        def _hx_local_0(args):
            ...
            data.push(maglev_MagLevString.fromString("ReservedSeating.CreateVenue"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.CreateVenue' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.CreateVenue",maglev_MagLevFunction.fromFunction(_hx_local_0))
        def _hx_local_1(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.CreateVenueConfiguration"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.CreateVenueConfiguration' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.CreateVenueConfiguration",maglev_MagLevFunction.fromFunction(_hx_local_1))
        def _hx_local_2(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.CreateSeat"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.CreateSeat' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.CreateSeat",maglev_MagLevFunction.fromFunction(_hx_local_2))
        def _hx_local_3(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.CreateEvent"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.CreateEvent' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.CreateEvent",maglev_MagLevFunction.fromFunction(_hx_local_3))
        def _hx_local_4(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.CreateTable"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.CreateTable' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.CreateTable",maglev_MagLevFunction.fromFunction(_hx_local_4))
        def _hx_local_5(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.CreateOrder"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.CreateOrder' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.CreateOrder",maglev_MagLevFunction.fromFunction(_hx_local_5))
        def _hx_local_6(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.GetVenue"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.GetVenue' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.GetVenue",maglev_MagLevFunction.fromFunction(_hx_local_6))
        def _hx_local_7(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.GetVenueConfiguration"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.GetVenueConfiguration' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.GetVenueConfiguration",maglev_MagLevFunction.fromFunction(_hx_local_7))
        def _hx_local_8(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.GetSeat"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.GetSeat' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.GetSeat",maglev_MagLevFunction.fromFunction(_hx_local_8))
        def _hx_local_9(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.GetEvent"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.GetEvent' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.GetEvent",maglev_MagLevFunction.fromFunction(_hx_local_9))
        def _hx_local_10(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.GetTable"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.GetTable' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.GetTable",maglev_MagLevFunction.fromFunction(_hx_local_10))
        def _hx_local_11(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.UpdateVenue"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.UpdateVenue' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.UpdateVenue",maglev_MagLevFunction.fromFunction(_hx_local_11))
        def _hx_local_12(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.UpdateVenueConfiguration"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.UpdateVenueConfiguration' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.UpdateVenueConfiguration",maglev_MagLevFunction.fromFunction(_hx_local_12))
        def _hx_local_13(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.UpdateSeat"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.UpdateSeat' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.UpdateSeat",maglev_MagLevFunction.fromFunction(_hx_local_13))
        def _hx_local_14(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.UpdateEvent"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.UpdateEvent' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.UpdateEvent",maglev_MagLevFunction.fromFunction(_hx_local_14))
        def _hx_local_15(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.UpdateTable"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.UpdateTable' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.UpdateTable",maglev_MagLevFunction.fromFunction(_hx_local_15))
        def _hx_local_16(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.DeleteVenue"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.DeleteVenue' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.DeleteVenue",maglev_MagLevFunction.fromFunction(_hx_local_16))
        def _hx_local_17(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.DeleteVenueConfiguration"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.DeleteVenueConfiguration' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.DeleteVenueConfiguration",maglev_MagLevFunction.fromFunction(_hx_local_17))
        def _hx_local_18(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.DeleteSeat"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.DeleteSeat' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.DeleteSeat",maglev_MagLevFunction.fromFunction(_hx_local_18))
        def _hx_local_19(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.DeleteEvent"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.DeleteEvent' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.DeleteEvent",maglev_MagLevFunction.fromFunction(_hx_local_19))
        def _hx_local_20(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.DeleteTable"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.DeleteTable' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.DeleteTable",maglev_MagLevFunction.fromFunction(_hx_local_20))
        def _hx_local_21(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.DeleteOrder"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.DeleteOrder' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.DeleteOrder",maglev_MagLevFunction.fromFunction(_hx_local_21))
        def _hx_local_22(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.CompleteOrder"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.CompleteOrder' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.CompleteOrder",maglev_MagLevFunction.fromFunction(_hx_local_22))
        def _hx_local_23(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.AddSeatToOrder"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.AddSeatToOrder' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.AddSeatToOrder",maglev_MagLevFunction.fromFunction(_hx_local_23))
        def _hx_local_24(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.ContinueOrder"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.ContinueOrder' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.ContinueOrder",maglev_MagLevFunction.fromFunction(_hx_local_24))
        def _hx_local_25(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.AutoSelect"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.AutoSelect' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.AutoSelect",maglev_MagLevFunction.fromFunction(_hx_local_25))
        def _hx_local_26(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.CancelEvent"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.CancelEvent' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.CancelEvent",maglev_MagLevFunction.fromFunction(_hx_local_26))
        def _hx_local_27(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.CancelReservation"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.CancelReservation' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.CancelReservation",maglev_MagLevFunction.fromFunction(_hx_local_27))
        def _hx_local_28(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.GetSeatsAndTablesForEvent"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.GetSeatsAndTablesForEvent' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.GetSeatsAndTablesForEvent",maglev_MagLevFunction.fromFunction(_hx_local_28))
        def _hx_local_29(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.FindAbandonedOrders"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.FindAbandonedOrders' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.FindAbandonedOrders",maglev_MagLevFunction.fromFunction(_hx_local_29))
        def _hx_local_30(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.GetOrdersForUser"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.GetOrdersForUser' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.GetOrdersForUser",maglev_MagLevFunction.fromFunction(_hx_local_30))
        def _hx_local_31(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.GetAllEventsOnSale"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.GetAllEventsOnSale' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.GetAllEventsOnSale",maglev_MagLevFunction.fromFunction(_hx_local_31))
        def _hx_local_32(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.UpdateVenueConfigurationAvailability"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.UpdateVenueConfigurationAvailability' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.UpdateVenueConfigurationAvailability",maglev_MagLevFunction.fromFunction(_hx_local_32))
        def _hx_local_33(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.GetVenueConfigurations"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.GetVenueConfigurations' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.GetVenueConfigurations",maglev_MagLevFunction.fromFunction(_hx_local_33))
        def _hx_local_34(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.GetOrderSummary"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.GetOrderSummary' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.GetOrderSummary",maglev_MagLevFunction.fromFunction(_hx_local_34))
        def _hx_local_35(args):
            data = maglev_MagLevArray.create()
            data.push(maglev_MagLevString.fromString("_not_implemented_"))
            data.push(maglev_MagLevString.fromString("ReservedSeating.GetAllVenuesByOwner"))
            data.push(maglev_MagLevString.fromString("reservedseating"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ReservedSeating.GetAllVenuesByOwner' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ReservedSeating.GetAllVenuesByOwner",maglev_MagLevFunction.fromFunction(_hx_local_35))
