...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '3.4.0-alpha.1611947713+2ab19d2f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 3.4.0-alpha.1611947713+2ab19d2f`
                """)
            else:
                raise
