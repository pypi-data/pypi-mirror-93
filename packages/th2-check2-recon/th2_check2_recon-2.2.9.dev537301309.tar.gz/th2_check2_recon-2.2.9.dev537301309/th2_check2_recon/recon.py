...
from th2_check2_recon.reconcommon import MessageGroupType
from th2_check2_recon.rule import Rule
from th2_check2_recon.services import EventStore, Cache
...
class Recon:
    def __init__(self, event_router: EventBatchRouter, grpc_router: GrpcRouter, message_router: MessageRouter,
        ...
        self.__message_comparator = MessageComparator(grpc_router.get_service(MessageComparatorService))
        ...
        self.__shared_group = Cache.MessageGroup(id='shared_group',
                                                 capacity=self.__config.shared_group_size,
                                                 type=MessageGroupType.shared,
                                                 event_store=self.__event_store,
                                                 parent_event=self.__event_store.root_event)
        ...
        for rule_config in self.__config.rules:
            if rule_config.enabled:
                ...
                loaded_rules.append(module.Rule(event_store=event_store,
                                                ...
                                                shared_group_permission=rule_config.shared_group_permission,
                                                shared_group=self.__shared_group,
