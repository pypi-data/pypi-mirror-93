...
class RuleConfiguration:
    ...
    def __init__(self, name, enabled, has_shared_group, match_timeout, match_timeout_offset_ns, configuration) -> None:
        self.name = str(name)
        self.enabled = True if enabled.lower() == 'true' else False
        self.has_shared_group = has_shared_group
...
class ReconConfiguration:
    def __init__(self, recon_name: str, cache_size: int, shared_group_size: int, event_batch_max_size: int,
