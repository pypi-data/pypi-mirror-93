...
class QuerySet:
    def __init__(self, model, method=None, query=None, slicing=None, iter_class=None, projection=None):
        self.model = model
        self.method = method
    ...
    def _clone(self, query, method=None, iter_class=None, slicing=None, projection=None):
        ...
        queryset = self.__class__(
            self.model, method=method, query=query, iter_class=iter_class, slicing=slicing, projection=projection)
        return queryset
