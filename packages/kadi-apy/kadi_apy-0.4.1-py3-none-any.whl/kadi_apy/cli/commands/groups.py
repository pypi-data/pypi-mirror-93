...
def create(**kwargs):
    ...
    CLIGroup(**kwargs, create=True)


@groups.command()
@apy_command
@id_identifier_options(class_type=CLIGroup, helptext="to edit")
@option(
    "visibility",
    char="v",
...
@groups.command()
@apy_command
@id_identifier_options(class_type=CLIGroup)
@option(
    "description",
    char="d",
...
@groups.command()
@apy_command
@id_identifier_options(class_type=CLIGroup, helptext="to add the user")
...
@groups.command()
@apy_command
@id_identifier_options(class_type=CLIGroup, helptext="to remove the user")
...
@groups.command()
@apy_command
@id_identifier_options(class_type=CLIGroup, helptext="to delete")
...
@user_id_options(helptext="to show the user's created groups.", required=False)
@option(
    "my_user_id",
    char="i",
