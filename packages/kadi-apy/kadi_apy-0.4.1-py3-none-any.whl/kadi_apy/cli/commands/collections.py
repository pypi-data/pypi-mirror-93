...
def create(**kwargs):
    ...
    CLICollection(**kwargs, create=True)


@collections.command()
@apy_command
@id_identifier_options(class_type=CLICollection, helptext="to edit")
@option(
    "visibility",
    char="v",
...
@collections.command()
@apy_command
@id_identifier_options(class_type=CLICollection)
@option(
    "description",
    char="d",
...
@collections.command()
@apy_command
@id_identifier_options(class_type=CLICollection, helptext="to add the user")
@user_id_options()
@option(
    "permission-new",
    char="p",
...
@collections.command()
@apy_command
@id_identifier_options(class_type=CLICollection, helptext="to remove the user")
@user_id_options()
...
@id_identifier_options(
    class_type=CLICollection, helptext="to add the group with role permissions"
)
...
@collections.command()
@apy_command
@id_identifier_options(class_type=CLICollection, helptext="to remove the group")
@id_identifier_options(class_type=Group)
...
@collections.command()
@apy_command
@id_identifier_options(class_type=CLICollection, helptext="to delete")
@option(
...
@collections.command()
@apy_command
@id_identifier_options(class_type=CLICollection, helptext="to link to the record")
...
@collections.command()
@apy_command
@id_identifier_options(class_type=CLICollection, helptext="to remove the record")
...
@collections.command()
@apy_command
@id_identifier_options(class_type=CLICollection, helptext="to add a tag")
...
@collections.command()
@apy_command
@id_identifier_options(class_type=CLICollection, helptext="to remove a tag")
...
@user_id_options(helptext="to show the user's created collections.", required=False)
@option(
    "my_user_id",
    char="i",
