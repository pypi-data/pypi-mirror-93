...
def get_deleted_resources(**kwargs):
    """Show a list of deleted resources in the trash."""

    miscellaneous = CLIMiscellaneous()

    miscellaneous.get_deleted_resources(**kwargs)
...
def restore_resource(item_type, item_id):
    ...
    miscellaneous.restore(item=item, item_id=item_id)
...
def purge_resource(item_type, item_id):
    ...
    miscellaneous.purge(item=item, item_id=item_id)
...
def get_licenses(**kwargs):
    ...
    miscellaneous.get_licenses(**kwargs)
