...
def create(**kwargs):
    ...
    CLIRecord(**kwargs, create=True)


@records.command()
@apy_command
@id_identifier_options(class_type=CLIRecord, helptext="to edit")
@option(
    "visibility",
    char="v",
    description="Visibility of the record",
...
@records.command()
@apy_command
@id_identifier_options(class_type=CLIRecord)
...
@id_identifier_options(
    class_type=CLIRecord, helptext="to add the group with role permissions"
)
...
@records.command()
@apy_command
@id_identifier_options(class_type=CLIRecord, helptext="to delete")
@option(
...
@records.command()
@apy_command
@id_identifier_options(class_type=CLIRecord, helptext="to add a metadatum")
...
@records.command()
@apy_command
@id_identifier_options(class_type=CLIRecord, helptext="to delete a metadatum")
...
@records.command()
@apy_command
@id_identifier_options(class_type=CLIRecord, helptext="to delete all metadata")
@option(
    "i-am-sure",
...
@records.command()
@apy_command
@id_identifier_options(class_type=CLIRecord, helptext="to download files from")
...
def get_file(record, file_id, filepath, force):
    """Download one file or all files from a record."""

    record.get_file(filepath, force, file_id)
...
@user_id_options(helptext="to show the user's created records.", required=False)
@option(
    "my_user_id",
    char="i",
