...
from polyaxon.polyboard.events import LoggedEventSpec, V1Event, V1Events, get_asset_path
...
class Run(RunClient):
    ...
    @check_no_op
    @can_log_events
    def sync_events_summaries(self, last_check: Optional[datetime]):
        ...
        for events_kind in get_dirs_under_path(self._artifacts_path):
            _summaries, _last_values = self._sync_events_summaries(
                events_path=self._artifacts_path,
