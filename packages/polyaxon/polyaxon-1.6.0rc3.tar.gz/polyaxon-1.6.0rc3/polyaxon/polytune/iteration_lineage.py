...
def get_iteration_definition(
    ...
    try:
        ...
        client.log_failed(
            reason="PolyaxonTunerIteration",
            message="Tuner failed fetching iteration",
            traceback=exp,
        )
        logger.warning(e)
...
def handle_iteration_failure(client: RunClient, exp: Exception):
    ...
    client.log_failed(
        reason="PolyaxonTunerSuggestions",
        message="Tuner failed creating suggestions",
        traceback=exp,
    )
...
def handle_iteration(
    ...
    try:
        ...
        client.log_failed(
            reason="PolyaxonTunerIteration",
            message="Tuner failed logging iteration",
            traceback=exp,
        )
        logger.warning(e)
