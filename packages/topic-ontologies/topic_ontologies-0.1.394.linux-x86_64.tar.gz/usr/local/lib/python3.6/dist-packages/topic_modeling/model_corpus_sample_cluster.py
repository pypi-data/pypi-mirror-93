...
def project_documents(topic_ontology,model,corpus,is_testing):
    ...
    path_document_vectors= get_path_document_vectors(corpus,topic_ontology,model).replace(".csv","")
...
project_documents(ontology,model,corpus,False)
