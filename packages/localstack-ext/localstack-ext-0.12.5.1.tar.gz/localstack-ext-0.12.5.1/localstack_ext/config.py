...
# temporary flag to disable persistence of RDS DB data
DISABLE_RDS_DB_PERSISTENCE = localstack_config.is_env_true('DISABLE_RDS_DB_PERSISTENCE')
...
localstack_config.CONFIG_ENV_VARS += [
    ...
    'REQUIRE_PRO', 'AZURE', 'BIGDATA_DOCKER_FLAGS', 'DISABLE_RDS_DB_PERSISTENCE'
]
