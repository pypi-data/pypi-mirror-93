        ...
        for element in config:
            ...
            if element.get("kind") == "html":
             ...
             if element.get("kind") == "attachment":
                part = MIMEApplication(open(element.get("filename"), "rb").read(), Name=basename(element.get("filename")))
                part.add_header("Content-Disposition", element.get("kind"), filename=basename(element.get("filename")))
