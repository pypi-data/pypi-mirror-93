...
class AnsibleCollectionVersionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_href=None, artifact=None, md5=None, sha1=None, sha224=None, sha256=None, sha384=None, sha512=None, id=None, authors=None, contents=None, dependencies=None, description=None, docs_blob=None, manifest=None, files=None, documentation=None, homepage=None, issues=None, license=None, name=None, namespace=None, repository=None, tags=None, version=None, local_vars_configuration=None):  # noqa: E501
