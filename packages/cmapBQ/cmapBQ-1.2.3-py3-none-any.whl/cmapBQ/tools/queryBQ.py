...
from cmapBQ.query import run_query, _export_table, _download_from_extract_job
...
def main(argv=None):
    ...
    try:
        ...
        # run query
        query_job = run_query(bigquery_client, args.query)
        # extract table to GCS
        extract_job = _export_table(query_job, bigquery_client)
        # download from GCS
