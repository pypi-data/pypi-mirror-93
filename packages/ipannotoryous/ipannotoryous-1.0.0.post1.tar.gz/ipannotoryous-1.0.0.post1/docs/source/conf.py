...
# -*- coding: utf-8 -*-
#
# ipannotoryous documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipannotoryous', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipannotoryousdoc'
