...
class AFM:
    ...
    def nanoscope_read(
        ...
        for filename in self.filelist:
            ...
            if adjusted_tip_position is True:
                _z_position = tip_position + self.spr_const * _approach_curve
            else:
                _z_position = tip_position
    ...
    def calc_modulus(
        ...
        if soft_indenter is True:
            indenter_term = (1 - indenter_poisson_ratio ** 2) / (indenter_modulus * 1e-6)
        else:
            indenter_term = 0
