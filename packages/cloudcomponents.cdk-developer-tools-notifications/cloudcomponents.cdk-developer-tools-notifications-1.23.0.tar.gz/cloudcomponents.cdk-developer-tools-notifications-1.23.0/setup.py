    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_developer_tools_notifications._jsii": [
            "cdk-developer-tools-notifications@1.23.0.jsii.tgz"
        ],
        "cloudcomponents.cdk_developer_tools_notifications": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-codebuild>=1.88.0, <2.0.0",
        "aws-cdk.aws-codecommit>=1.88.0, <2.0.0",
        "aws-cdk.aws-codedeploy>=1.88.0, <2.0.0",
        "aws-cdk.aws-codepipeline>=1.88.0, <2.0.0",
        "aws-cdk.aws-codestarnotifications>=1.88.0, <2.0.0",
        "aws-cdk.aws-iam>=1.88.0, <2.0.0",
        "aws-cdk.aws-lambda-event-sources>=1.88.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.88.0, <2.0.0",
        "aws-cdk.aws-sns>=1.88.0, <2.0.0",
        "aws-cdk.core>=1.88.0, <2.0.0",
        "cloudcomponents.cdk-chatops>=1.23.0, <2.0.0",
