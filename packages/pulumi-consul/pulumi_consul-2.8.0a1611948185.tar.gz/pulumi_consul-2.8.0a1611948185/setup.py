...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '2.8.0-alpha.1611948185+f848e2ee'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 2.8.0-alpha.1611948185+f848e2ee`
                """)
            else:
                raise
