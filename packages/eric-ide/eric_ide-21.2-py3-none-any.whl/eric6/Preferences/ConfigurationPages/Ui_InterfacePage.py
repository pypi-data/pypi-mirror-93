...
class Ui_InterfacePage(object):
    def setupUi(self, InterfacePage):
        ...
        self.gridLayout_2.addWidget(self.browserShowCodingCheckBox, 2, 0, 1, 1)
        ...
        InterfacePage.setTabOrder(self.uiBrowsersShowHiddenCheckBox, self.browserShowCodingCheckBox)
