...
model_path = os.path.join(os.path.dirname(model_files), "cut_sentence.h5")
...
# model_loaded = load_model("cut_sent_thai/cut_sentence.h5")
model_loaded = load_model(model_path)

# with open('cut_sent_thai/stoi.pickle', 'rb') as f:
#     stoi = pickle.load(f)
# with open('cut_sent_thai/stoi_pos.pickle', 'rb') as f:
