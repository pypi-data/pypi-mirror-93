...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, repository=None, pulp_created=None, repository_version=None, content_guard=None, pulp_href=None, name=None, pulp_labels=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
