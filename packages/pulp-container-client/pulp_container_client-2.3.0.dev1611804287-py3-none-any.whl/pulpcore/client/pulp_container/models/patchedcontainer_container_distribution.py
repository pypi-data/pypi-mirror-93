...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, repository_version=None, name=None, repository=None, base_path=None, pulp_labels=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
