...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, base_path=None, repository=None, repository_version=None, content_guard=None, name=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
