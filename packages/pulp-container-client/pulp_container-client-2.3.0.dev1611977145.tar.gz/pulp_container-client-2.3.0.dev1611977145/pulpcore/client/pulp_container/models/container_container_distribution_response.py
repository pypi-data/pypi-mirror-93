...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, name=None, repository=None, content_guard=None, repository_version=None, pulp_labels=None, pulp_created=None, base_path=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
