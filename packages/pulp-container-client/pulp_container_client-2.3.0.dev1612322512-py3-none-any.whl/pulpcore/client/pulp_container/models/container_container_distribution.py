...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository=None, pulp_labels=None, name=None, base_path=None, content_guard=None, repository_version=None, local_vars_configuration=None):  # noqa: E501
