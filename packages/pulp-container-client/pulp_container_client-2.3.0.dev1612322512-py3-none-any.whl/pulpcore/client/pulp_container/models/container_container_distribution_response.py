...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository=None, pulp_labels=None, name=None, base_path=None, content_guard=None, pulp_created=None, repository_version=None, pulp_href=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
