...
class OMFITtree(SortedDict):
    ...
    def __setitem__(self, key, value):
        ...
        return super(OMFITtree, self).__setitem__(key, value )
...
def _collection_decorator(f):
    def ff(*args,**kw):
        ...
        if OMFITexpressionsReturnNone or self.selector is None:
            ...
            return getattr(super(OMFITtree, self).__getitem__(self.selector),fname)(*args[1:],**kw)
    return ff
...
class OMFITcollection(OMFITtree):
    ...
    def __getstate__(self):
        ...
        OMFITexpressionsReturnNone=True
        try:
            tmp = super(OMFITtree, self).__getstate__()
            return tmp
        finally:
            OMFITexpressionsReturnNone=tmpExp
    ...
    def GET(self, key):
        ...
        :param key: entry of the collection
        '''
        return super(OMFITtree, self).__getitem__(key)
    ...
    def CONTAINS(self, key):
        ...
        :param key: entry of the collection
        '''
        return super(OMFITtree, self).__contains__(key)
    ...
    def __getattr__(self,key):
        ...
        if OMFITexpressionsReturnNone or key in self.__dict__:
            return super(OMFITtree, self).__getattr__(key)
...
class OMFITmodule(OMFITtree):
    ...
    def __delitem__(self, key):
        super(OMFITtree, self).__delitem__(key)
