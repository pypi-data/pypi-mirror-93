...
def connectFour():
    ...
    if first == "先手":
        if level == "简单":
            ...
            end = connect_four.play_game(dict(X=human_player, O=novice_player),
                                         verbose=True)
        else:
            connect_four = ConnectFour(players=('X', 'O'), to_move='X')
            end = connect_four.play_game(dict(X=human_player, O=improved_player),
                                         verbose=True)
        ...
        if level == "简单":
            connect_four = ConnectFour(players=('X', 'O'), to_move='X')
            end = connect_four.play_game(dict(X=novice_player, O=human_player),
                                         verbose=True)
        else:
            connect_four = ConnectFour(players=('X', 'O'), to_move='X')
            end = connect_four.play_game(dict(X=improved_player, O=human_player),
                                         verbose=True)
