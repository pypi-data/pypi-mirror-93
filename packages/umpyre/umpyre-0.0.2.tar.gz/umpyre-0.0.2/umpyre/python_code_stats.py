...
Things like...
(Note that these will probably not work as doctests, since results are sensisitive to other slight system differences
...
def _code_stats_dict_for_file_and_objects(code_str, filepath, objs):
    return {
        "filepath": filepath,
