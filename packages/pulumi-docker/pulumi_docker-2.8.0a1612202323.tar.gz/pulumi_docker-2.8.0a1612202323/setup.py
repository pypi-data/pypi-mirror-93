...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.8.0-alpha.1612202323+53dd0099'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.8.0-alpha.1612202323+53dd0099`
                """)
            else:
                raise
