...
from .workflow.Footprints import getFootprints
...
class CityBuilder:
    ...
    def __init__(self, attributes=['story','occupancy','roofshape'], numBldg=10, random=True, place='',state='', save=True, fileName='', workDir='tmp',GoogleMapAPIKey='', overwrite=False, reDownloadImgs=False):
