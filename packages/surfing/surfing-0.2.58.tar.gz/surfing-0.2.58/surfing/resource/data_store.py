...
class DataStore:
    ...
    @staticmethod
    def refresh_dm(score_pre_calc=True,start_time='20050101',end_time=None,score_manager=None,print_time=False,use_weekly_monthly_indicators=False,s3_retriever_activation=None):
