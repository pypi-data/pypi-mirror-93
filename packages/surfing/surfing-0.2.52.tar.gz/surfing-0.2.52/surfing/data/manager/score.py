...
class ScoreFunc:
    ...
    SelectTimeAbility: float = 0
    SelectStockAbility: float = 0
    ...
    def get(self, data):
        return  self.alpha * data.alpha \
                ...
                + data.SelectTimeAbility.mul(other=self.SelectTimeAbility, fill_value=0) \
                + data.SelectStockAbility.mul(other=self.SelectStockAbility, fill_value=0) \
