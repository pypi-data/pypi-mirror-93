...
def train_is(metadata: pd.DataFrame, opts: dict):
    """
    ...
    logger.info(f"Listing options to be used:")
    logger.info(json.dumps(opts, indent=4))
    ...
    # model.pilot.Z = adjust_rotation(model.pilot.Z)
