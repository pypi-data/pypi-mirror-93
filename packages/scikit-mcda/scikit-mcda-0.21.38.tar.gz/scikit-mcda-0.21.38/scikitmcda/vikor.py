...
class VIKOR(MCDA):
    ...
    *Višekriterijumska Optimizacija I Kompromisno Rješenje (VIKOR)*
    ...
    def decide(self, v=0.5):  
        ...
        :param v: (default=0.5) Where v the weight for the strategy of maximum group utility and 1 - v is the weight of the individual regret. Usually v = 0.5 and when v > 0.5, the index of Qj will tend to majority agreement and clearly when v < 0.5, the index of Qj will indicate majority negative attitude.
