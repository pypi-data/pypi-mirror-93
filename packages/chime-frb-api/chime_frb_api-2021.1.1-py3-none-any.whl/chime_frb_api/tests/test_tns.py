...
def make_random_payload(payload):
    ...
    rand_str = str(chr(97 + round(np.random.random() * (122 - 97))))
    rand_str_2 = str(chr(97 + round(np.random.random() * (122 - 97))))
    rand_str_3 = str(chr(97 + round(np.random.random() * (122 - 97))))
    rand_str_4 = str(chr(97 + round(np.random.random() * (122 - 97))))
    rand_str_5 = str(chr(97 + round(np.random.random() * (122 - 97))))
    rand_str_6 = str(chr(97 + round(np.random.random() * (122 - 97))))
    ...
    payload["ra_value"] = (str(round(np.random.random() * 360.0, 2)),)
    payload["ra_error"] = (str(1 + round(np.random.random() * 60.0)),)
    payload["ra_units"] = ("arcmin",)

    payload["dec_value"] = (str(round(np.random.random() * 90.0, 2)),)
    payload["dec_error"] = (str(1 + round(np.random.random() * 60.0)),)
    ...
    dm = 1 + round(np.random.random() * 3000)
    dm_err = (dm / 100) + 1
    snr = round(np.random.random() * 100)
    payload["dm"] = str(dm)
