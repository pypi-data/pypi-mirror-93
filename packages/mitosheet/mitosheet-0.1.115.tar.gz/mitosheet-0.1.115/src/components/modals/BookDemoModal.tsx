...
const BookDemoModal = (
    ...
    const bookDemo = (e: FormEvent<HTMLFormElement>): void => {
        ...
        window.open(`https://meetings.hubspot.com/nate301/mito-early-access-demo?utm_campaign=Mito&utm_source=In-App-Email-Collection&email=${props.userEmail}`, '_blank')
