...
class VaultFile:
    ...
    Instead of creating it directory, use the
    ...
    def from_path(cls, filename: Path, key: AnyStr) -> 'VaultFile':
        """Load and return a series of files.
        ...
        :param filename: The name of the file to load.
            ...
            :meth:`earwax.VaultFile.save`.

        :param key: The key for the given file.
        """
    ...
    def add_path(
        ...
        :param p: The path to load.
            ...
            If the provided value is a directory, then every file (but not
            subdirectory) in that directory will be added to a list.
