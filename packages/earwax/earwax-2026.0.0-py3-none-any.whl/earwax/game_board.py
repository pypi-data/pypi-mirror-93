...
class GameBoard(Level, Generic[T]):
    ...
    :ivar ~earwax.GameBoard.tiles: All the tiles generated by
        :meth:`~earwax.GameBoard.populate`.

    :ivar ~earwax.GameBoard.populated_points: All the points that have been
        populated by :meth:`~earwax.GameBoard.populate`.
    """

    size: Point[int]
    tile_builder: Callable[[Point], T]

    coordinates: Point[int] = Factory(lambda: Point(0, 0, 0))
    ...
    def get_tile(self, p: Point[int]) -> T:
