...
'''
python setup_01.py sdist build
python setup_01.py sdist upload
'''
...
URL = 'https://github.com/EntaiWang99/Grid2Demand'
EMAIL = 'li.anjun@foxmail.com, xzhou74@asu.edu, entaiwang@bjtu.edu.cn'
