...
gd.ReadNetworkFiles()
# users can customize the working dictionary by setting " input_folder=' ' "
...
# users can customize trip purpose, and poi_trip_rate.csv by setting " trip_rate_folder=' ' "
...
# user can customize the latitude of the research area, and accessibility.csv by setting " accessibility_folder=' ' "
