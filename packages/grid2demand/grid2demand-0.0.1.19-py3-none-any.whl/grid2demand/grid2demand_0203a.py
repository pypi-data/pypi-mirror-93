...
def GenerateAgentBasedDemand():
    ...
    if len(agent_list) == 0:
        print('Empty agent may be caused by empty poi node. Please check node.csv!')
        logger.warning('Empty agent may be caused by empty poi node. Please check node.csv!')
