...
setuptools.setup(
    ...
    author_email='li.anjun@foxmail.com, xzhou74@asu.edu, entaiwang@bjtu.edu.cn, taehooie.kim@asu.edu',
    ...
    install_requires=['pandas >= 0.24.0', 'shapely >= 1.6', 'pyproj', 'numpy', 'locale'],
