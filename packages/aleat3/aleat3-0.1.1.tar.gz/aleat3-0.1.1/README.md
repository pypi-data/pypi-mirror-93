...
- New features:
  - Some output is colored with the [Colorama](http://pypi.org/project/colorama) library.
    - __To view this function, you must install this library at PyPi.__
  - New function: __coinToBool__. View the _aleatory.coin_ section to learn more.
