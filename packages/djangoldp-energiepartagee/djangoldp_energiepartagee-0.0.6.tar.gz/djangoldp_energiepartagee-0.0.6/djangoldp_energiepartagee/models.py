...
class Integrationstep(Model):
    actor = models.ForeignKey(Actor, on_delete=models.CASCADE, blank=True, null=True, verbose_name="Acteur")
...
class Contribution(Model):
    ...
    nonrenewed = models.BooleanField(blank=True, null=True, verbose_name="Cotisation non renouvelée", default=False)
