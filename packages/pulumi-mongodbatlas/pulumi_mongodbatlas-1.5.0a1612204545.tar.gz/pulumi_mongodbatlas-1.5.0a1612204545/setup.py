...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', '1.5.0-alpha.1612204545+ff2a74b1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas 1.5.0-alpha.1612204545+ff2a74b1`
                """)
            else:
                raise
