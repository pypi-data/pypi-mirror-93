...
from django_paperlayer.api.serializers.project import ProjectMilestonesSerializer
from django_paperlayer.api.serializers.milestone import MilestoneSerializer
from django_paperlayer.api.permission import IsMilestoneMemberOrReadOnly
