...
[boto3.ElasticBeanstalk 1.16.61](https://boto3.amazonaws.com/v1/documentation/api/1.16.61/reference/services/elasticbeanstalk.html#ElasticBeanstalk) service
compatible with
