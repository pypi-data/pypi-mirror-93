...
def convert_to_readable_date(self, hex_timestamp):
    ...
    with open(path, "rb") as lnk_file:
        ...
        while byte := lnk_file.read(1).hex():
            ...
            if 0 <= get_byte_counter() < 4:
                properties["header_value"].append(byte)
