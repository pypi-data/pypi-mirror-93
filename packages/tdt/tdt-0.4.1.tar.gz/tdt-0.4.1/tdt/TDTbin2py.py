    ...
    for var_name in header.stores.keys():
        ...
        if 'ts' in header.stores[var_name].keys():
            if current_type_str == 'streams':
                ...
                dtype = data[current_type_str][var_name].ts.dtype
                data[current_type_str][var_name].filtered_ts = [np.array([], dtype=dtype) for jj in range(num_ranges)]
            ...
            if hasattr(data[current_type_str][var_name], 'sortcode'):
                dtype = data[current_type_str][var_name].sortcode.dtype
                data[current_type_str][var_name].filtered_sort_code = [np.array([], dtype=dtype) for jj in range(num_ranges)]
            if hasattr(data[current_type_str][var_name], 'data'):
                dtype = data[current_type_str][var_name].data.dtype
                data[current_type_str][var_name].filtered_data = [np.array([], dtype=dtype) for jj in range(num_ranges)]
