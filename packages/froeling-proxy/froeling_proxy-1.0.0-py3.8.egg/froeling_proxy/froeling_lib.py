...
class Froeling:
    ...
    def __init__(self, tty, ignore_crc=True):
        """
        Initializes a Froeling object with given TTY that can either be a string with TTY device name
        ...
        WrongResponseCRCError; default is True because experiments have shown that S4 Turbo
