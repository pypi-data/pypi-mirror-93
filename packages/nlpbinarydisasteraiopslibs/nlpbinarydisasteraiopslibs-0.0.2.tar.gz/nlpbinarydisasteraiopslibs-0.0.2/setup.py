...
exec(open('nlpbinarydisasteraiopslibs/version.py').read())

with open('README.md') as f:
    long_description = f.read()

setup(
  name = 'nlpbinarydisasteraiopslibs',         # How you named your package folder
  packages = ['nlpbinarydisasteraiopslibs'],   # Chose the same as "name"
