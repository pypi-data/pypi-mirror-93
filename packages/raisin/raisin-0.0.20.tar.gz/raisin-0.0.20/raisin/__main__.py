...
def _psw_raisin():
    ...
    return security.change_psw()

def _padlock_raisin():
    import raisin.application.configuration as configuration
    return configuration.change_padlock()
...
def _client_accept(mac):
    import raisin.communication.tcp_server as tcp_server
    return tcp_server.client_accept(mac)

def _client_exile(mac):
    import raisin.communication.tcp_server as tcp_server
    return tcp_server.client_exile(mac)

def _client_delete(mac):
    import raisin.communication.tcp_server as tcp_server
    return tcp_server.client_remove(mac)
