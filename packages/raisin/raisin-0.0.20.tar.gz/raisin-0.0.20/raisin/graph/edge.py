...
class Arrow:
    ...
    * Cette arrete represente une arrette oriantee.
    ...
    >>> edge.Arrow(vs, vd, name="arc", cost=0.5)
    Arrow(Vertex(n=0), Vertex(n=1), name='arc', cost=0.5, n=1)
    >>>
    """
    ...
    def __hash__(self):
        ...
        """
        return hash((self.vs, self.vd, self.name, self.cost))
    ...
    def __and__(self, other):
        ...
        * Le taux d'intersection entre 2 sommets est une
        ...
        assert isinstance(other, Arrow), \
            "'other' has to be an instance of Arrow, not %s." \
            % type(other).__name__
