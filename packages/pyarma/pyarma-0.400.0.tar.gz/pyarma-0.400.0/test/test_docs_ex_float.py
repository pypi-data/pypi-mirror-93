...
# Operations
A = fmat(5, 10, fill_randu)
B = fmat(5, 10, fill_randu)
C = fmat(10, 5, fill_randu)
...
# broadcasting
X = fmat(6, 5, fill_ones)
v = fmat(6, 1, fill_randu)
...
# submatrix
A = fmat(5, 10, fill_zeros)

A[ 0:2, 1:3 ]             = fmat(3,3, fill_randu)
# A[ span(0,2), span(1,3) ] = fmat(3,3, fill_randu)
# A[ 0,1, size(3,3) ]       = fmat(3,3, fill_randu)

B = A[ 0:2, 1:3 ].eval()
# C = A[ span(0,2), span(1,3) ].eval()
# D = A[ 0,1, size(3,3) ].eval()

A[:,1]          = fmat(5,1,fill_randu)
# A[span_all, 1]  = fmat(5,1,fill_randu)

X = fmat(5, 5, fill_randu)
...
# swap
A = fmat(4, 5, fill_zeros)
B = fmat(6, 7, fill_ones )

A.swap(B)

# iterators
X = fmat(5, 6, fill_randu)
...
X = fmat(100, 200, fill_randu)

for val in X[40:60, 50:100]:
  print(val)

# as_col
X = fmat(4, 5, fill_randu)
v = X.as_col()
...
#is_vec
A = fmat(1, 5, fill_randu)
B = fmat(5, 1, fill_randu)
C = fmat(5, 5, fill_randu)
...
#as_scalar
r = fmat(1, 5, fill_randu)
q = fmat(5, 1, fill_randu)
...
#cross
a = fmat(3, 1, fill_randu)
b = fmat(3, 1, fill_randu)
...
#join
A = fmat(4, 5, fill_randu)
B = fmat(4, 6, fill_randu)
C = fmat(6, 5, fill_randu)
...
X = fmat(5, 6, fill_randu)
Y = fmat(5, 6, fill_randu)
Z = max(X,Y)

#nonzeros
B = fmat(100, 100, fill_eye)
b = nonzeros(B)
...
B = fmat(size(A), fill_zeros)

C = fmat()

C.randu(size(A))

D = fmat(10,20, fill_ones)
...
#sigproc
#conv
A = fmat(256, 1, fill_randu)

B = fmat(16, 1, fill_randu)
...
#conv2
A = fmat(256, 256, fill_randu)

B = fmat(16, 16, fill_randu)
...
#fft
X = fmat(100, 1, fill_randu)
   
Y = fft(X, 128)

#fft2
A = fmat(100, 100, fill_randu)
...
#hist
v = fmat(1000, 1, fill_randn) # Gaussian distribution
...
#normpdf
X = fmat(10, 1, fill_randu)
M = fmat(10, 1, fill_randu)
S = fmat(10, 1, fill_randu)
