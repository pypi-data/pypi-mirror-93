...
# A[ span(0,2), span(1,3) ] = mat(3,3, fill_randu)
...
# A[span_all, 1]  = mat(5,1,fill_randu)
...
#toeplitz
A = mat(5, 1, fill_randu)
X = toeplitz(A)
Y = circ_toeplitz(A)

print("completed generators")
...
print("starting extremum indices")
...
# possible output:
# 
# <pyarma.pyarma.mat object at 0x123456>
# [matrix size: 123x456]
