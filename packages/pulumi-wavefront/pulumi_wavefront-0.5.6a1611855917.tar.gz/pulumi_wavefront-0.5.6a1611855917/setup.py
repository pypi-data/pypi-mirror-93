...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'wavefront', '0.5.6-alpha.1611855917+b8ad02a4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource wavefront 0.5.6-alpha.1611855917+b8ad02a4`
                """)
            else:
                raise
