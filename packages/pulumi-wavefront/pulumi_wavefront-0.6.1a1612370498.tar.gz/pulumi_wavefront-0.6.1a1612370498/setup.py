...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'wavefront', '0.6.1-alpha.1612370498+5744c2e7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource wavefront 0.6.1-alpha.1612370498+5744c2e7`
                """)
            else:
                raise
