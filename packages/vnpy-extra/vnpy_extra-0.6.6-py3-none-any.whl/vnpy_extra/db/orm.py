...
class StrategyBacktestStats(Model):
    ...
    def update_stats(
        ...
        try:
            ...
            stg_info, _ = StrategyInfo.get_or_create(module_name=module_name, strategy_class_name=strategy_class_name)
    ...
    @staticmethod
    def get_available_status_group_by_strategy() -> typing.Dict[typing.Tuple[str, str], list]:
