...
class CaptureFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureIpv4, CaptureCustom, CaptureFilter, CaptureVlan, CaptureEthernet]
        return self._getitem(key)
...
class DeviceList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[DeviceContainerIpv4, DeviceBgpv4, DeviceIpv6, DeviceEthernet, Device]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowPfcPause, FlowGre, FlowVxlan, FlowUdp, FlowHeader, FlowIpv6, FlowCustom, FlowEthernet, FlowEthernetPause, FlowGtpv1, FlowGtpv2, FlowIpv4, FlowTcp, FlowVlan]
        return self._getitem(key)
