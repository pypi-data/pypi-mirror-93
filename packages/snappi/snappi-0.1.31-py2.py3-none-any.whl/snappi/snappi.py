...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowIpv6, FlowCustom, FlowEthernet, FlowGtpv2, FlowHeader, FlowPfcPause, FlowIpv4, FlowTcp, FlowVxlan, FlowGtpv1, FlowGre, FlowEthernetPause, FlowVlan, FlowArp, FlowUdp]
        return self._getitem(key)
