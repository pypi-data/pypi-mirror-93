...
class CaptureFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureIpv4, CaptureEthernet, CaptureCustom, CaptureFilter, CaptureVlan]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowVxlan, FlowIpv4, FlowUdp, FlowGre, FlowGtpv1, FlowHeader, FlowArp, FlowPfcPause, FlowEthernetPause, FlowTcp, FlowGtpv2, FlowEthernet, FlowCustom, FlowVlan, FlowIpv6]
        return self._getitem(key)
