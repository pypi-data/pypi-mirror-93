...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowUdp, FlowTcp, FlowEthernetPause, FlowPfcPause, FlowGre, FlowArp, FlowGtpv2, FlowEthernet, FlowIpv4, FlowIpv6, FlowGtpv1, FlowCustom, FlowVxlan, FlowVlan, FlowHeader]
        return self._getitem(key)
