...
class CaptureFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureCustom, CaptureIpv4, CaptureEthernet, CaptureFilter, CaptureVlan]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowPfcPause, FlowVxlan, FlowGtpv1, FlowHeader, FlowGre, FlowGtpv2, FlowUdp, FlowArp, FlowIpv6, FlowEthernetPause, FlowIpv4, FlowVlan, FlowTcp, FlowCustom, FlowEthernet]
        return self._getitem(key)
