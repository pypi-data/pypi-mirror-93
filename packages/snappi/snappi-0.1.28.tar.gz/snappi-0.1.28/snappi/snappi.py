...
class CaptureFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureCustom, CaptureEthernet, CaptureFilter, CaptureIpv4, CaptureVlan]
        return self._getitem(key)
...
class Device(SnappiObject):
    ...
    def ethernet(self):
        # type: () -> DeviceEthernet
        """Factory property that returns an instance of the DeviceEthernet class

        Emulated ethernet protocol. A top level in the emulated device stack.
        """
        return self._get_property('ethernet', DeviceEthernet(self, 'ethernet'))

    @property
    def ipv4(self):
        # type: () -> DeviceContainerIpv4
        """Factory property that returns an instance of the DeviceContainerIpv4 class

        Emulated ipv4 protocol
        """
        return self._get_property('ipv4', DeviceContainerIpv4(self, 'ipv4'))

    @property
    def ipv6(self):
        # type: () -> DeviceIpv6
        """Factory property that returns an instance of the DeviceIpv6 class

        Emulated ipv6 protocol
        """
        return self._get_property('ipv6', DeviceIpv6(self, 'ipv6'))

    @property
    def bgpv4(self):
        # type: () -> DeviceBgpv4
        """Factory property that returns an instance of the DeviceBgpv4 class

        Emulated BGPv4 router and routes
        """
        return self._get_property('bgpv4', DeviceBgpv4(self, 'bgpv4'))
    ...
    @property
    def choice(self):
        # type: () -> Union[ethernet, ipv4, ipv6, bgpv4, choice, choice, choice]
        """choice getter

        The type of emulated protocol interface or device.

        Returns: Union[ethernet, ipv4, ipv6, bgpv4, choice, choice, choice]
        """
        return self._get_property('choice')
    ...
    def choice(self, value):
        ...
        value: Union[ethernet, ipv4, ipv6, bgpv4, choice, choice, choice]
        """
        self._set_property('choice', value)
...
class DeviceBgpv4(SnappiObject):
    ...
    def ipv4(self):
        ...
        """
        return self._get_property('ipv4', DeviceContainerIpv4)
...
class DeviceBgpv4RouteRange(SnappiObject):
    ...
    def __init__(self, parent=None, choice=None, route_count_per_device=None, name=None):
    ...
    def route_count_per_device(self):
        ...
        Returns: int
        """
        return self._get_property('route_count_per_device')
    ...
    def route_count_per_device(self, value):
        ...
        value: int
        """
        self._set_property('route_count_per_device', value)
    ...
    def as_path(self):
        ...
        Returns: obj(snappi.DevicePattern)
        """
        return self._get_property('as_path', DevicePattern)
    ...
    def community(self):
        ...
        Returns: obj(snappi.DevicePattern)
        """
        return self._get_property('community', DevicePattern)
...
class DeviceBgpv4RouteRangeList(SnappiList):
    ...
    def bgpv4routerange(self, route_count_per_device=1, name=None):
        ...
        """
        item = DeviceBgpv4RouteRange(route_count_per_device=route_count_per_device, name=name)
        self._add(item)
        return self
...
class DeviceBgpv6RouteRangeList(SnappiList):
    ...
    def bgpv6routerange(self, route_count_per_device=1, name=None):
        ...
        """
        item = DeviceBgpv6RouteRange(route_count_per_device=route_count_per_device, name=name)
        self._add(item)
        return self
...
class DeviceList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[DeviceIpv6, Device, DeviceEthernet, DeviceBgpv4, DeviceContainerIpv4]
        return self._getitem(key)
...
class FlowBitPatternList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowBitList, FlowBitPattern, FlowBitCounter]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowPfcPause, FlowEthernetPause, FlowIpv4, FlowTcp, FlowVxlan, FlowHeader, FlowIpv6, FlowGre, FlowCustom, FlowGtpv2, FlowUdp, FlowGtpv1, FlowVlan, FlowArp, FlowEthernet]
        return self._getitem(key)
...
class Bgpv4Metrics(SnappiObject):
    ...
    def ports(self):
        ...
        """
        return self._get_property('ports', Bgpv4MetricList)
...
class Api(object):
    ...
    def get_port_metrics(self, payload):
        """POST /results/port
        ...
        Return: port_metrics
        """
        raise NotImplementedError("get_port_metrics")
    ...
    def get_flow_metrics(self, payload):
        """POST /results/flow
        ...
        Return: flow_metrics
        """
        raise NotImplementedError("get_flow_metrics")

    def get_bgpv4_metrics(self, payload):
        """POST /results/bgpv4

        TBD

        Return: bgpv4_metrics
        """
        raise NotImplementedError("get_bgpv4_metrics")
    ...
    def port_metrics_request(self):
        """Factory method that creates an instance of PortMetricsRequest
    ...
    def port_metrics(self):
        """Factory method that creates an instance of PortMetricList
    ...
    def flow_metrics_request(self):
        """Factory method that creates an instance of FlowMetricsRequest
    ...
    def flow_metrics(self):
        """Factory method that creates an instance of FlowMetricList
    ...
    def bgpv4_metrics_request(self):
        """Factory method that creates an instance of Bgpv4MetricsRequest
    ...
    def bgpv4_metrics(self):
        """Factory method that creates an instance of Bgpv4Metrics
...
class HttpApi(Api):
    ...
    def get_port_metrics(self, payload):
        ...
        return self._transport.send_recv(
            ...
            "/results/port",
            payload=payload,
            return_object=self.port_metrics(),
        )
    ...
    def get_flow_metrics(self, payload):
        ...
        return self._transport.send_recv(
            ...
            "/results/flow",
            payload=payload,
            return_object=self.flow_metrics(),
        )
    ...
    def get_bgpv4_metrics(self, payload):
        ...
        return self._transport.send_recv(
            ...
            "/results/bgpv4",
            payload=payload,
            return_object=self.bgpv4_metrics(),
        )
