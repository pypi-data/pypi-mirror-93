...
class CaptureFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureFilter, CaptureEthernet, CaptureVlan, CaptureCustom, CaptureIpv4]
        return self._getitem(key)
...
class DeviceList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[DeviceContainerIpv4, DeviceBgpv4, Device, DeviceIpv6, DeviceEthernet]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowArp, FlowPfcPause, FlowGtpv1, FlowVxlan, FlowEthernet, FlowCustom, FlowHeader, FlowUdp, FlowTcp, FlowIpv6, FlowGtpv2, FlowVlan, FlowGre, FlowIpv4, FlowEthernetPause]
        return self._getitem(key)
