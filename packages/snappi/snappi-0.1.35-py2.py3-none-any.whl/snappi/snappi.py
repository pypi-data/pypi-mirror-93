...
class CaptureFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureCustom, CaptureVlan, CaptureFilter, CaptureIpv4, CaptureEthernet]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowPfcPause, FlowEthernet, FlowTcp, FlowGre, FlowEthernetPause, FlowCustom, FlowVxlan, FlowUdp, FlowArp, FlowGtpv2, FlowIpv4, FlowGtpv1, FlowVlan, FlowHeader, FlowIpv6]
        return self._getitem(key)
