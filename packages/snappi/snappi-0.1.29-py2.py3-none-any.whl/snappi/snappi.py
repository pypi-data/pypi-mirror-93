...
class CaptureFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureEthernet, CaptureCustom, CaptureFilter, CaptureVlan, CaptureIpv4]
        return self._getitem(key)
...
class FlowBitPatternList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowBitPattern, FlowBitList, FlowBitCounter]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowPfcPause, FlowEthernet, FlowGtpv1, FlowCustom, FlowHeader, FlowIpv6, FlowUdp, FlowVxlan, FlowEthernetPause, FlowGre, FlowIpv4, FlowArp, FlowTcp, FlowGtpv2, FlowVlan]
        return self._getitem(key)
