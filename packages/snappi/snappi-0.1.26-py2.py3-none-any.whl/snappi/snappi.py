...
class CaptureFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureFilter, CaptureIpv4, CaptureVlan, CaptureCustom, CaptureEthernet]
        return self._getitem(key)
...
class DeviceList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[DeviceBgpv4, DeviceContainerIpv4, DeviceEthernet, DeviceIpv6, Device]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowVlan, FlowVxlan, FlowGre, FlowTcp, FlowCustom, FlowUdp, FlowGtpv2, FlowArp, FlowHeader, FlowEthernet, FlowIpv4, FlowEthernetPause, FlowGtpv1, FlowIpv6, FlowPfcPause]
        return self._getitem(key)
