...
class CaptureFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureCustom, CaptureEthernet, CaptureFilter, CaptureVlan, CaptureIpv4]
        return self._getitem(key)
...
class DeviceList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[DeviceContainerIpv4, DeviceBgpv4, DeviceIpv6, Device, DeviceEthernet]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowGre, FlowVlan, FlowIpv6, FlowGtpv2, FlowHeader, FlowEthernetPause, FlowCustom, FlowGtpv1, FlowTcp, FlowUdp, FlowEthernet, FlowPfcPause, FlowVxlan, FlowIpv4]
        return self._getitem(key)
