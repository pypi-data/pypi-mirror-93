...
class CaptureFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureVlan, CaptureIpv4, CaptureEthernet, CaptureFilter, CaptureCustom]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowVlan, FlowArp, FlowEthernetPause, FlowGtpv1, FlowGtpv2, FlowPfcPause, FlowIpv6, FlowEthernet, FlowTcp, FlowVxlan, FlowCustom, FlowHeader, FlowGre, FlowIpv4, FlowUdp]
        return self._getitem(key)
