...
class CaptureFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureVlan, CaptureIpv4, CaptureCustom, CaptureEthernet, CaptureFilter]
        return self._getitem(key)
...
class DeviceList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[DeviceBgpv4, Device, DeviceContainerIpv4, DeviceEthernet, DeviceIpv6]
        return self._getitem(key)
...
class FlowBitPatternList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowBitCounter, FlowBitPattern, FlowBitList]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowEthernet, FlowIpv4, FlowGtpv2, FlowHeader, FlowPfcPause, FlowCustom, FlowTcp, FlowVxlan, FlowArp, FlowUdp, FlowGre, FlowVlan, FlowEthernetPause, FlowGtpv1, FlowIpv6]
        return self._getitem(key)
