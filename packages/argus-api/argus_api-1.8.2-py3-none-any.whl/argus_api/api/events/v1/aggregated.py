...
def find_aggregated_event_stats(
    ...
    :param list excludeFlags: Exclude objects with these flags set :param json:
...
def update_events(
    ...
    :param dict update: 
    :param list eventIdentifiers: Update events specified by full ID (type/timestamp/customerID/eventID) :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
