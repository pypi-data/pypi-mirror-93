...
def disable_method_for_user(
    ...
    :param str method: Authentication method to enable:param json:
...
def download_public_key(
    ...
    :param int userID: User ID:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def evict_signature_session(
    ...
    :param int keyID: Key to clear session for. If not specified, the session will be cleared for all keys:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_user_methods(
    ...
    :param int userId: User to fetch methods for:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def list(
    ...
    :param int userID: ID of user:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def retrieve_s_m_s_token(
    ...
    :param int userID: User ID
    :param str tokenSuffix: Token suffix:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def revoke(
    ...
    :param int userID: ID of user
    :param str prefix: Key Prefix:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def setup(
    ...
    :param int userID: User ID
    :param str userName: LDAP username to set for user :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def setup_1(
    ...
    :param int userID: User ID
    :param str userName: RADIUS username to set for user :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
