...
def add_asset_group(
    ...
    :param dict criticality: :param json:
...
def attach_assets(
    ...
    :param list assets: Specify set of assets to be attached to the asset group, it accepts asset's ID or short name. :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def attach_children_groups(
    ...
    :param list childrenGroups: Specify set of asset groups to be attached as children groups, it accepts asset group ID or short name. Child group should not cause circular relationship among asset groups. :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def delete_asset_group(
    ...
    :param str idOrShortName: AssetGroup ID or short name
    :param str customer: Customer ID or short name (default is user's customer), only used when group short name was provided
    :param bool forceIndex: Whether to force an Elasticsearch index refresh such that the AssetGroup is immediately no longer searchable.:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def detach_assets(
    ...
    :param str customer: Customer ID or short name (default is user's customer), only used when group short name was provided:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def list_asset_groups(
    ...
    :param bool includeDeleted: Include deleted:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def search_asset_groups(
    ...
    :param bool includeDeleted: Whether to include deleted Asset groups (default false):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_asset_group(
    ...
    :param bool forceIndex: Whether to force an Elasticsearch index refresh such that changes to the AssetGroup are immediately searchable.:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
