...
def add_host_application(
    ...
    :param list sockets: Specify socket strings of the application. :param json:
...
def get_host_application(
    ...
    :param str id: HostApplication ID:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_host_application(
    ...
    :param list deleteSockets: Remove sockets from application (list of protocol/port, e.g. tcp/80). :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
