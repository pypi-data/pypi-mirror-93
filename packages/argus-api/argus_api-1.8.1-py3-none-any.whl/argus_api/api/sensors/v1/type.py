...
def add_sensor_type(
    ...
    :param bool monitorCollectionOnly: Flag to determine whether sensors of this type are monitored by analysis or only by collection (default false):param json:
...
def delete_sensor_type(
    ...
    :param str newType: Sensor type delete request:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_sensor_type(
    ...
    :param str idOrShortName: Sensor type ID or short name:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_sensor_type(
    ...
    :param bool monitorCollectionOnly: Flag to determine whether sensors of this type are monitored by analysis or only by collection :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
