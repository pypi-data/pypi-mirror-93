...
def authenticate_3(
    ...
    :param str cookie: When responding with SMS code, set the SMS session cookie returned by challenge :param json:
...
def sms_user_authorization(
    ...
    :param str cookie: The cookie returned from the send-sms request :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
