...
class MLPProcessor:
    ...
    def __init__(self, mlp, use_celery=False, app=None, worker_name="worker.taskman.mlp"):
        self.mlp = mlp
    ...
    def _apply_mlp_celery(self, document: dict, field: str, analyzers: list):
        try:
            result = self.app.send_task(self.worker_name, args=[[document], [field], analyzers])
