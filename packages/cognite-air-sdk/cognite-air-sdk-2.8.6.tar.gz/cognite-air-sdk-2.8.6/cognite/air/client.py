...
class AIRClient:
    ...
    @schedule_front_end_name.setter
    def schedule_front_end_name(self, name):
    ...
    @schedule_front_end_description.setter
    def schedule_front_end_description(self, description):
