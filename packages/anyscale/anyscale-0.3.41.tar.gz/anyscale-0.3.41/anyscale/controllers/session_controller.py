...
class SessionController:
    ...
    def up_internal(
        ...
        cluster_config = None
        if build_id is None and compute_template_id is None:
        ...
        wait_for_head_node_start(project_id, session_name, session_id, self.api_client)

        # Push will sync project directory to working directory.
        self.push(
            session_name, source=None, target=None, config=None, all_nodes=False,
        )
