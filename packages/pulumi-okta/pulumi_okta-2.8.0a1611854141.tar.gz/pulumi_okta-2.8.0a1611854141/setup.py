...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.8.0-alpha.1611854141+e5e7a9a3'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.8.0-alpha.1611854141+e5e7a9a3`
                """)
            else:
                raise
