...
_py_interop_table.LaneColumn_swigconstant(_py_interop_table)
LaneColumn = _py_interop_table.LaneColumn

_py_interop_table.TileColumn_swigconstant(_py_interop_table)
TileColumn = _py_interop_table.TileColumn

_py_interop_table.CycleColumn_swigconstant(_py_interop_table)
CycleColumn = _py_interop_table.CycleColumn

_py_interop_table.ReadColumn_swigconstant(_py_interop_table)
ReadColumn = _py_interop_table.ReadColumn

_py_interop_table.CycleWithinReadColumn_swigconstant(_py_interop_table)
CycleWithinReadColumn = _py_interop_table.CycleWithinReadColumn

_py_interop_table.DensityKPermm2Column_swigconstant(_py_interop_table)
DensityKPermm2Column = _py_interop_table.DensityKPermm2Column

_py_interop_table.DensityPfKPermm2Column_swigconstant(_py_interop_table)
DensityPfKPermm2Column = _py_interop_table.DensityPfKPermm2Column

_py_interop_table.ClusterCountKColumn_swigconstant(_py_interop_table)
ClusterCountKColumn = _py_interop_table.ClusterCountKColumn

_py_interop_table.ClusterCountPfKColumn_swigconstant(_py_interop_table)
ClusterCountPfKColumn = _py_interop_table.ClusterCountPfKColumn

_py_interop_table.PercentPassFilterColumn_swigconstant(_py_interop_table)
PercentPassFilterColumn = _py_interop_table.PercentPassFilterColumn

_py_interop_table.PercentAlignedColumn_swigconstant(_py_interop_table)
PercentAlignedColumn = _py_interop_table.PercentAlignedColumn

_py_interop_table.LegacyPhasingRateColumn_swigconstant(_py_interop_table)
LegacyPhasingRateColumn = _py_interop_table.LegacyPhasingRateColumn

_py_interop_table.LegacyPrephasingRateColumn_swigconstant(_py_interop_table)
LegacyPrephasingRateColumn = _py_interop_table.LegacyPrephasingRateColumn

_py_interop_table.ErrorRateColumn_swigconstant(_py_interop_table)
ErrorRateColumn = _py_interop_table.ErrorRateColumn

_py_interop_table.PercentGreaterThanQ20Column_swigconstant(_py_interop_table)
PercentGreaterThanQ20Column = _py_interop_table.PercentGreaterThanQ20Column

_py_interop_table.PercentGreaterThanQ30Column_swigconstant(_py_interop_table)
PercentGreaterThanQ30Column = _py_interop_table.PercentGreaterThanQ30Column

_py_interop_table.P90Column_swigconstant(_py_interop_table)
P90Column = _py_interop_table.P90Column

_py_interop_table.PercentNoCallsColumn_swigconstant(_py_interop_table)
PercentNoCallsColumn = _py_interop_table.PercentNoCallsColumn

_py_interop_table.PercentBaseColumn_swigconstant(_py_interop_table)
PercentBaseColumn = _py_interop_table.PercentBaseColumn

_py_interop_table.FwhmColumn_swigconstant(_py_interop_table)
FwhmColumn = _py_interop_table.FwhmColumn

_py_interop_table.CorrectedColumn_swigconstant(_py_interop_table)
CorrectedColumn = _py_interop_table.CorrectedColumn

_py_interop_table.CalledColumn_swigconstant(_py_interop_table)
CalledColumn = _py_interop_table.CalledColumn

_py_interop_table.SignalToNoiseColumn_swigconstant(_py_interop_table)
SignalToNoiseColumn = _py_interop_table.SignalToNoiseColumn

_py_interop_table.PhasingWeightColumn_swigconstant(_py_interop_table)
PhasingWeightColumn = _py_interop_table.PhasingWeightColumn

_py_interop_table.PrephasingWeightColumn_swigconstant(_py_interop_table)
PrephasingWeightColumn = _py_interop_table.PrephasingWeightColumn

_py_interop_table.PhasingSlopeColumn_swigconstant(_py_interop_table)
PhasingSlopeColumn = _py_interop_table.PhasingSlopeColumn

_py_interop_table.PhasingOffsetColumn_swigconstant(_py_interop_table)
PhasingOffsetColumn = _py_interop_table.PhasingOffsetColumn

_py_interop_table.PrephasingSlopeColumn_swigconstant(_py_interop_table)
PrephasingSlopeColumn = _py_interop_table.PrephasingSlopeColumn

_py_interop_table.PrephasingOffsetColumn_swigconstant(_py_interop_table)
PrephasingOffsetColumn = _py_interop_table.PrephasingOffsetColumn

_py_interop_table.MinimumContrastColumn_swigconstant(_py_interop_table)
MinimumContrastColumn = _py_interop_table.MinimumContrastColumn

_py_interop_table.MaximumContrastColumn_swigconstant(_py_interop_table)
MaximumContrastColumn = _py_interop_table.MaximumContrastColumn

_py_interop_table.SurfaceColumn_swigconstant(_py_interop_table)
SurfaceColumn = _py_interop_table.SurfaceColumn

_py_interop_table.SwathColumn_swigconstant(_py_interop_table)
SwathColumn = _py_interop_table.SwathColumn

_py_interop_table.SectionColumn_swigconstant(_py_interop_table)
SectionColumn = _py_interop_table.SectionColumn

_py_interop_table.TileNumberColumn_swigconstant(_py_interop_table)
TileNumberColumn = _py_interop_table.TileNumberColumn

_py_interop_table.ClusterCountOccupiedKColumn_swigconstant(_py_interop_table)
ClusterCountOccupiedKColumn = _py_interop_table.ClusterCountOccupiedKColumn

_py_interop_table.PercentOccupiedColumn_swigconstant(_py_interop_table)
PercentOccupiedColumn = _py_interop_table.PercentOccupiedColumn

_py_interop_table.ImagingColumnCount_swigconstant(_py_interop_table)
ImagingColumnCount = _py_interop_table.ImagingColumnCount

_py_interop_table.UnknownColumnId_swigconstant(_py_interop_table)
...
class imaging_column(_object):
    ...
    __swig_getmethods__["to_header"] = lambda x: _py_interop_table.imaging_column_to_header
    if _newclass:
        to_header = staticmethod(_py_interop_table.imaging_column_to_header)
    __swig_getmethods__["to_name"] = lambda x: _py_interop_table.imaging_column_to_name
    if _newclass:
