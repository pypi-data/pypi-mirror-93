...
class empty_metric(_object):
    ...
    if _newclass:
        ...
        suffix = _py_interop_metrics.empty_metric_suffix
    ...
    if _newclass:
        ...
        create_id = _py_interop_metrics.empty_metric_create_id
...
class summary_run_metric(empty_metric):
    ...
    if _newclass:
        ...
        prefix = _py_interop_metrics.summary_run_metric_prefix
    if _newclass:
        missing = staticmethod(_py_interop_metrics.summary_run_metric_missing)
    else:
        missing = _py_interop_metrics.summary_run_metric_missing
...
class base_summary_run_metrics(base_metric_header):
    ...
    if _newclass:
        ...
        prefix = _py_interop_metrics.base_summary_run_metrics_prefix
    if _newclass:
        suffix = staticmethod(_py_interop_metrics.base_summary_run_metrics_suffix)
    else:
        suffix = _py_interop_metrics.base_summary_run_metrics_suffix
