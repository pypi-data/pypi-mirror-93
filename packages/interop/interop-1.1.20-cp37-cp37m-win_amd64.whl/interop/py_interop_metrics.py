...
class empty_metric(_object):
    ...
    __swig_getmethods__["suffix"] = lambda x: _py_interop_metrics.empty_metric_suffix
    if _newclass:
        suffix = staticmethod(_py_interop_metrics.empty_metric_suffix)

    def __lt__(self, arg2):
        return _py_interop_metrics.empty_metric___lt__(self, arg2)
    __swig_getmethods__["create_id"] = lambda x: _py_interop_metrics.empty_metric_create_id
    if _newclass:
        create_id = staticmethod(_py_interop_metrics.empty_metric_create_id)
...
empty_metric_suffix = _py_interop_metrics.empty_metric_suffix

def empty_metric_create_id(arg1, arg2, arg3=0):
    return _py_interop_metrics.empty_metric_create_id(arg1, arg2, arg3)
empty_metric_create_id = _py_interop_metrics.empty_metric_create_id
...
class summary_run_metric(empty_metric):
    ...
    for _s in [empty_metric]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, summary_run_metric, name, value)
    __swig_getmethods__ = {}
    for _s in [empty_metric]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, summary_run_metric, name)
    __repr__ = _swig_repr
    TYPE = _py_interop_metrics.summary_run_metric_TYPE
    LATEST_VERSION = _py_interop_metrics.summary_run_metric_LATEST_VERSION

    def __init__(self, *args):
        this = _py_interop_metrics.new_summary_run_metric(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    __swig_getmethods__["prefix"] = lambda x: _py_interop_metrics.summary_run_metric_prefix
    if _newclass:
        prefix = staticmethod(_py_interop_metrics.summary_run_metric_prefix)
    __swig_getmethods__["missing"] = lambda x: _py_interop_metrics.summary_run_metric_missing
    if _newclass:
        missing = staticmethod(_py_interop_metrics.summary_run_metric_missing)
    __swig_destroy__ = _py_interop_metrics.delete_summary_run_metric
    __del__ = lambda self: None
summary_run_metric_swigregister = _py_interop_metrics.summary_run_metric_swigregister
summary_run_metric_swigregister(summary_run_metric)

def summary_run_metric_prefix():
    return _py_interop_metrics.summary_run_metric_prefix()
summary_run_metric_prefix = _py_interop_metrics.summary_run_metric_prefix

def summary_run_metric_missing():
    return _py_interop_metrics.summary_run_metric_missing()
summary_run_metric_missing = _py_interop_metrics.summary_run_metric_missing
...
class base_summary_run_metrics(base_metric_header):
    ...
    for _s in [base_metric_header]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, base_summary_run_metrics, name, value)
    __swig_getmethods__ = {}
    for _s in [base_metric_header]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, base_summary_run_metrics, name)
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        this = _py_interop_metrics.new_base_summary_run_metrics(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    __swig_getmethods__["prefix"] = lambda x: _py_interop_metrics.base_summary_run_metrics_prefix
    if _newclass:
        prefix = staticmethod(_py_interop_metrics.base_summary_run_metrics_prefix)
    __swig_getmethods__["suffix"] = lambda x: _py_interop_metrics.base_summary_run_metrics_suffix
    if _newclass:
        suffix = staticmethod(_py_interop_metrics.base_summary_run_metrics_suffix)
    ...
    __del__ = lambda self: None
base_summary_run_metrics_swigregister = _py_interop_metrics.base_summary_run_metrics_swigregister
base_summary_run_metrics_swigregister(base_summary_run_metrics)

def base_summary_run_metrics_prefix():
    return _py_interop_metrics.base_summary_run_metrics_prefix()
base_summary_run_metrics_prefix = _py_interop_metrics.base_summary_run_metrics_prefix

def base_summary_run_metrics_suffix():
    return _py_interop_metrics.base_summary_run_metrics_suffix()
base_summary_run_metrics_suffix = _py_interop_metrics.base_summary_run_metrics_suffix

class vector_summary_run_metrics(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, vector_summary_run_metrics, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, vector_summary_run_metrics, name)
    __repr__ = _swig_repr
    def __iter__(self):
        return self.iterator()
    ...
    def __init__(self, *args):
        this = _py_interop_metrics.new_vector_summary_run_metrics(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    __del__ = lambda self: None
vector_summary_run_metrics_swigregister = _py_interop_metrics.vector_summary_run_metrics_swigregister
vector_summary_run_metrics_swigregister(vector_summary_run_metrics)
