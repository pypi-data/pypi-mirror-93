...
requirements = ["SQLAlchemy==1.3.22", "PyQt5-sip==12.8.1", "chardet==3.0.4", ]
...
setuptools.setup(
	...
	url="https://github.com/isthatjoke/messenger/tree/main/part_2/lesson_7",
