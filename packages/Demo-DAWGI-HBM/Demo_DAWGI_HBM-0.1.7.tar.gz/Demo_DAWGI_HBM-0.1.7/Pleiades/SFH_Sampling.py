...
try:
    ...
    url = 'https://github.com/sundarjhu/DAWGI_Lectures_2021/blob/main/Demo_DAWGI_HBM/Pleiades/'
    name = url + 'Pleiades_ruwe_cexcess_SelDist.txt'
    list_iso = url + 'List_Iso21_PARSEC_GaiaEDR3.txt'
    it_title = url + 'Pleiades'
...
for k in filelist:
    nn+=1
    isos0.append(np.loadtxt(path+k.astype('str'), unpack=True))
