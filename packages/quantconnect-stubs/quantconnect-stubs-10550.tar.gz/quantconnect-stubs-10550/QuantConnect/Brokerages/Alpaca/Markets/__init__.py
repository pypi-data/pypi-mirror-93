...
del sys.modules["QuantConnect.Brokerages.Alpaca.Markets"]
from clr import AddReference
AddReference("QuantConnect.Brokerages.Alpaca.Markets")
from QuantConnect.Brokerages.Alpaca.Markets import *
