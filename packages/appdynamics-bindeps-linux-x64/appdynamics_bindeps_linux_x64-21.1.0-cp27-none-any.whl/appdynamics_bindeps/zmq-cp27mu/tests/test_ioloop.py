...
from appdynamics_bindeps.zmq.eventloop.minitornado.ioloop import _Timeout
try:
    from tornado.ioloop import PollIOLoop, IOLoop as BaseIOLoop
except ImportError:
    from appdynamics_bindeps.zmq.eventloop.minitornado.ioloop import IOLoop as BaseIOLoop
