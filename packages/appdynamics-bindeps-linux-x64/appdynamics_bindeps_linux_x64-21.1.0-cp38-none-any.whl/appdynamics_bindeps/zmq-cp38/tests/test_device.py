...
from appdynamics_bindeps.zmq.tests import BaseZMQTestCase, SkipTest, have_gevent, GreenTest, PYPY
...
if have_gevent:
    ...
    class TestDeviceGreen(GreenTest, BaseZMQTestCase):
        ...
        def test_green_device(self):
            ...
            g = gevent.spawn(appdynamics_bindeps.zmq.green.device, zmq.QUEUE, rep, rep)
            req.connect('tcp://127.0.0.1:%i' % port)
            req.send(b'hi')
