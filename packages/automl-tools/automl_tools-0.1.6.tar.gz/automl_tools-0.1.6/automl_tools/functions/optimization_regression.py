...
def search_space(model):
    ...
    if model == 'LR':
        ...
        space = dict(criterion=hp.choice('criterion', ['mse', 'mae']),
                     max_depth=6,
        ...
        space = dict(alpha=hp.uniform('alpha', 1, 10),
                     ...
                     loss=hp.choice('loss', ['squared_loss', 'huber', 'epsilon_insensitive']),
        ...
        space = dict(alpha=hp.uniform('alpha', 1, 10),
                     max_iter=hp.choice('max_iter', range(100, 1000)),
                     loss=hp.choice('loss', ['log', 'modified_huber', 'squared_loss',
        ...
        space = dict(loss=hp.choice('loss', ['ls', "huber", "quantile"]),
        ...
        space = dict(loss=hp.choice('loss', ['linear', "square", "exponential"]),
