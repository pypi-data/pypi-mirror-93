...
:LastEditTime: 2021-01-22 15:45:53
...
class TaskBaseHandler(TopBaseHandler):
    ...
    def send_lottery_value(self, log_title, user_info, update_sql, send_num, act_dict, source_type, change_type, log_info="", log_desc=""):
        """
