...
setup(
    ...
    packages=['cytolysis','cytolysis.examples'],
    package_dir={'cytolysis': 'src', 'cytolysis.examples': 'examples'},
    package_data={'cytolysis.examples': ['*.txt', 'examples/*.cym','../examples/*.cym']},
 )
