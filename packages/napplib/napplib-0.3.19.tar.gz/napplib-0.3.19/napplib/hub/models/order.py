...
class OrderAddress:
    def __init__(self, billingName = '',
        ...
        self.deliveryReference = Utils.create_values(deliveryReference, 'String') if deliveryReference else ''
...
class OrderPayment:
    def __init__(self, orderId='',
        ...
        self.planId = planId if planId else 1
...
class Order:
    def __init__(self,  id='',
        ...
        self.contactTelephoneNumber = contactTelephoneNumber if contactTelephoneNumber else None
        self.orderForeignId = Utils.create_values(orderForeignId, 'String')
