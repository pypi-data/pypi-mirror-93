define([
    ...
    MatplotPackage.prototype.subplotBoxClickHandler = function(that, event) {
        ...
        $(that.wrapSelector('span[data-caption-id="pageTitle"]'))[1].innerText = '서브플롯 [' + position + '] 환경설정';
        $(that.wrapSelector('span[data-caption-id="pageTitle"]'))[2].innerText = '서브플롯 [' + position + '] 차트 추가';
    }
