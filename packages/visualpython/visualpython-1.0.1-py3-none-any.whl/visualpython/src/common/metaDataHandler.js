define([
    ...
    var MdHandler = function (funcID) {
        ...
        this.prefixSelector = '#' + vpConst.API_OPTION_PREFIX_CODE_ID; //'#vp_prefixBox textarea';
        this.postfixSelector = '#' + vpConst.API_OPTION_POSTFIX_CODE_ID; //'#vp_postfixBox textarea';
    };
