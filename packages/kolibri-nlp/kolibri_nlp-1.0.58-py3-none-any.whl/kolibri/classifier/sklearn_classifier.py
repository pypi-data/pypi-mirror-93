...
from kolibri.tools.samplers import AutoSampler
...
class SkLearnClassifier(Classifier):
    ...
    def train(self, training_data, cfg, **kwargs):
        ...
        if len(set(labels)) < 2:
            ...
            if self.component_config["balance_data"]:
                sampler=AutoSampler(min_freq=self.component_config["balance_data_min_freq"], max_freq=self.component_config["balance_data_max_freq"], random_state=4)
