...
# -*- coding: utf-8 -*-
#
# material_slider documentation build configuration file
#
...
_version_py = os.path.join(repo, 'material_slider', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'material_sliderdoc'
...
latex_documents = [
    (master_doc, 'material_slider.tex', 'material_slider Documentation',
     'Dou Du', 'manual'),
]
