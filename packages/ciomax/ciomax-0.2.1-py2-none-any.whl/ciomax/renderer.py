...
class ArnoldRenderer(Renderer):
    def __init__(self, _shield, name):
        ...
        self.templates = [
            {
                "name": "default" , 
                "command": u'kick -nostdin -i "<posix project>/ass/<timestamp>/<scenenamex>.<pad start 4>.ass" -dw -dp -v 5 -ds 4 -ss 4 -as 6 -of exr -o "<posix project>/renderoutput/<timestamp>/<scenenamex>.<pad start 4>.exr"',
